...
$('#submit').on('click', function(e) {
    ...
    if(val){
        ...
        if ($('#rujukan_manual')[0].checked) {
            var tgl_rujukan = $('#tanggal_rujukan_manual').val().split("-").reverse().join("-");
            formData.append('bpjs_no_rujukan', $('#no_rujukan_manual').val());
            formData.append('bpjs_tgl_rujukan', tgl_rujukan);
            formData.append('bpjs_ppk_rujukan', $('#ppk_perujuk_manual').val());
        }else if(data_rujukan == -1 && jenisPelayanan != 1){
