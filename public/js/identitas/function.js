...
var AutoCompleteIdentitas = function() {
    ...
    var initAutoComplete = function(){
        ...
        jQuery('.asuransi-autocomplete').autoComplete({
            minChars: 3,
            source: function(term, suggest){
                ...
                var icdList;
                $.get('/'+dir+'/public/asuransi/search/'+term, function(data) {

                    var i;
                    for (i = 0; i < data.length; i++) {
                        AsuransiKV [data[i].name] = data[i].id;
            ...
            onSelect: function(event, term, item) {
                $("#id-asuransi").val(AsuransiKV [term]);
                console.log($("#id-asuransi").val());
            }
        });
    };
