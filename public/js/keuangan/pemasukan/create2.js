...
function initEditable(){
	...
	$('.layanan').on('select2:select', function (e) {
		...
		backboneAddTransaksiDetail(id,data2.id,data2.deskripsi,1,0,'',subtotal_number,user,data2.departemen_id);
...
function backboneAddTransaksiDetail(id,layanan_id,layanan_string,jumlah,harga,diskon,subtotal,created_by,departemen_id)
{
