...
function initTransaksi(){
	...
	for(i=1;i<=countdetail;i++){
		...
		backboneAddTransaksiDetail(i,detail_id,layanan_id,nama,jumlah,harga,diskon,keterangan,subtotal_number,tipe,kelas,created_at,departemen_id);
	}
}
...
function initEditable(){
	...
	$('.layanan').on('select2:select', function (e) {
		...
		backboneAddTransaksiDetail(id,null,data2.id,data2.deskripsi,1,'','','',subtotal_number,0,'',null,data2.departemen_id);
...
function backboneAddTransaksiDetail(id,detail_id,layanan_id,layanan_string,jumlah,harga,diskon,keterangan,subtotal,tipe,kelas,created_at,departemen_id)
{
