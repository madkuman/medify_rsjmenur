...
function initTransaksi(){
    ...
    for(i=1;i<=countdetail;i++){
        ...
        backboneAddTransaksiDetail(i,detail_id,deskripsi,jumlah,harga,diskon,keterangan,subtotal_number);
    }
}
...
function initEditable(){
	...
	$('.layanan').editable({
		...
		success: function(response, newValue) {
			...
			backboneAddTransaksiDetail(id,null,newValue,1,0,'','',subtotal_number);
		}
	});
...
function backboneAddTransaksiDetail(id,detail_id,layanan_string,jumlah,harga,diskon,keterangan,subtotal)
{
...
$('#buttonSubmit').click(function() {
	...
	if(tanggal == '')
		...
		callSwal('warning','Transaksi Gagal','Penerima Tidak Boleh Kosong',0);
	else if(pembayar == '')
		callSwal('warning','Transaksi Gagal','Pembayar Tidak Boleh Kosong',0);
	else if(akun_id == '')
