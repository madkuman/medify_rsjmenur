...
class PostController extends Controller
{
    ...
    public function create(Request $request){
        ...
        try{         
            $executeData = app('App\Http\Controllers\Remunerasi\ResikoKerja\CreateController')->create($request);
    ...
    public function update(Request $request){
        ...
        DB::connection('remunerasi')->beginTransaction();
        try{    
            app('App\Http\Controllers\Remunerasi\ResikoKerja\EditController')->update($request);
                DB::connection('remunerasi')->commit();    
