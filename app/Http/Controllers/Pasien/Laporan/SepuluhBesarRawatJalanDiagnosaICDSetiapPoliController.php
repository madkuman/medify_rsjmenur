...
class SepuluhBesarRawatJalanDiagnosaICDSetiapPoliController extends Controller
{
    	public function get($start,$end)
	{
		...
		{
			$transaksi = Transaksi::where('poliklinik_id',$poli->id)->whereBetween('waktu_masuk',[$start,$end])->whereNotNull('waktu_pemeriksaan')->whereNotNull('kasus_id')->get();
