...
namespace App\Http\Controllers\Pasien\LaporanV2\Page\RL311KesehatanJiwa;
...
class APIController extends Controller
{
    ...
    {
		$total = MasterSIRSKegiatanKesehatanJiwa::count('id');
		return json_encode([
			'status' => 200,
			'data' => $total
		]);
    ...
    public function getData(Request $request)
    {
		...
		$all_jenis_kegiatan = MasterSIRSKegiatanKesehatanJiwa::skip($data_fetched)->take($limit)->orderBy('nomor')->get();
