...
namespace App\Http\Controllers\Pasien\LaporanV2\Page\DataRincianRajal;
...
class APIController extends Controller
{
    ...
    public function getData(Request $request)
    {
		...
		$data = Kasus::where('tipe_rj',1)->whereBetween('created_at',[$start,$end])->with('pasien', 'pasien.alamat_kota.provinsi','pasien.alamat_kecamatan','pasien.alamat_kelurahan','pasien.agama', 'pasien.pendidikan','pasien.pernikahan', 'pasien.tni_keanggotaan', 'pasien.tni_kotama', 'pasien.tni_satker', 'pasien.tni_pangkat', 'pasien.wali',
			...
			'diagnosisUtama.icd10','diagnosisTambahan.icd10','tindakan_icd9.icd9','admin.user','rawat_jalan_transaksi_first.poliklinik')
		...
		foreach($data as $index => $item)
		{
			...
			$new_item->lokasi = $item->rawat_jalan_transaksi_first->poliklinik->name ?? '';
