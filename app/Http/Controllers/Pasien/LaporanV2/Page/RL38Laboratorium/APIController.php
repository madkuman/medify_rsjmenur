...
namespace App\Http\Controllers\Pasien\LaporanV2\Page\RL38Laboratorium;
...
class APIController extends Controller
{
    ...
    {
		$total = MasterSIRSKegiatanLab::count('id');
		return json_encode([
			'status' => 200,
			'data' => $total
		]);
    ...
    public function getData(Request $request)
    {
		...
		$all_jenis_kegiatan = MasterSIRSKegiatanLab::skip($data_fetched)->take($limit)->orderBy('nomor')->get();
