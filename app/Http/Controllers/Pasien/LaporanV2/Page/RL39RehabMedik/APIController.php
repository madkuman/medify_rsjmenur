...
namespace App\Http\Controllers\Pasien\LaporanV2\Page\RL39RehabMedik;
...
class APIController extends Controller
{
    ...
    {
		$total = MasterSIRSKegiatanRehabMedik::count('id');
		return json_encode([
			'status' => 200,
			'data' => $total
		]);
    ...
    public function getData(Request $request)
    {
		...
		$all_jenis_kegiatan = MasterSIRSKegiatanRehabMedik::skip($data_fetched)->take($limit)->orderBy('nomor')->get();
