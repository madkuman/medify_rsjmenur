...
namespace App\Http\Controllers\Pasien\LaporanV2\Page\RL521KunjunganRawatInap;
...
class APIController extends Controller
{
    ...
    public function getData(Request $request)
    {
		...
		$transaksi = Transaksi::select('ruangan.sirs_kunjungan_kegiatan','pasien.gender')
					->leftJoin('tempat_tidur','tempat_tidur.id','=','transaksi.tempat_tidur_id')
