...
namespace App\Http\Controllers\Pasien\LaporanV2\Page\DKK23LaporanBulananSTPRawatInap;
...
class APIController extends Controller
{
	...
	public function getData(Request $request)
	{
		...
		$kasus = Kasus::with([])
			->selectRaw('kasus.*, pasien.date_of_birth, pasien.gender, if(kasus.krs_status = 3,1,0) as is_mati')
			->join($_ . '_rawat_inap.transaksi', function ($query) {
		...
		$item[] = $kasus->count();
		$item[] = $kasus->where('is_mati',1)->count();
