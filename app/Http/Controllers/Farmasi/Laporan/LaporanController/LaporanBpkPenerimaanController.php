...
class LaporanBpkPenerimaanController extends Controller
{
    ...
    private function stokLog($farmasi_ids,$start_date,$end_date,$item_template_ids)
    {
        ...
        while($current_date <= $end_date)
        {
            ...
            $query_select2 .="
                IFNULL(laporan_$format_month.jumlah_plus,0) AS $format_month,
            ";
            $query_format .= "
                    LEFT JOIN
                    (
                        ...
                        (
                            ...
                            AND d.tanggal >= '$current_start'
                            AND d.tanggal <= '$current_end'
