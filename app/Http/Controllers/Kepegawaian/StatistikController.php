...
class StatistikController extends Controller{
    ...
    public function index(){
        ...
        $htmlheader_title = 'Kepegawaian | Statistik';
        $contentheader_title = 'Statistik';

        $total_pegawai = self::totalPegawai();
        $total_status  = self::totalStatusPegawai();
        $total_jenis   = self::totalJenisPegawai();
        //PIE
        $jenis = self::jenisPegawai();
        $status = self::statusPegawai();
        $gender = self::genderPegawai();
        $umur = self::usiaPegawai();
        $aktif =self::pegawaiAktif();
        $keluar =self::pegawaiKeluar();
        // dd($pegawai);

        return view('kepegawaian.statistik.index', compact(
            'htmlheader_title',
            'contentheader_title',
            'total_pegawai',
            'total_status',
