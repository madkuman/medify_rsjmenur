...
class PenempatanPersonelController extends Controller
{
	...
	{	
		...
		$pdf = MPDF::loadView('kepegawaian.laporan.hasil.penempatan-personel.index',$data, [], [
			'format' => 'legal'
		]);
		$filename = 'Laporan-Penempatan-Personel.pdf';
