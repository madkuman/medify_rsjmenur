...
class CreateController extends Controller
{
    ...
    public function createUrine($data)
    {
        $urine = new Urine;
        ...
        $urine->created_by = Auth::user()->id;
        $urine->save();
        //dd($urine);
        return $urine;
    }
    
    public function createImun($data)
    {   
        //dd($data);
        $imun = new Immunologi;
        ...
        $imun->created_by = Auth::user()->id;
        $imun->save();
        //dd($urine);
        return $imun;
    }
    
    public function createSmear($data)
    {   
        //dd($data);
        $smear = new PapSmear;
        $smear->pap_smear = $data['pap_smear'];
        $smear->kasus_id = $data['kasus_id'];
        $smear->created_by = Auth::user()->id;
        $smear->save();
        //dd($urine);
        return $smear;
    }
    
    public function createFeces($data)
    {   
        //dd($data);
        $feces = new Feces;
