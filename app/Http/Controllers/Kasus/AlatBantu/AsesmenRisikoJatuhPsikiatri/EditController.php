...
class EditController extends Controller
{
    public function edit(Request $req){
    	$asesmen_risiko_jatuh_psikiatri = AsesmenRisikoJatuhPsikiatri::find($req->id);
    	
        $asesmen_risiko_jatuh_psikiatri->usia = $req->usia;
        $asesmen_risiko_jatuh_psikiatri->usia_skor = $req->usia_skor;
        $asesmen_risiko_jatuh_psikiatri->status_mental = $req->status_mental;
        $asesmen_risiko_jatuh_psikiatri->status_mental_skor = $req->status_mental_skor;
        $asesmen_risiko_jatuh_psikiatri->eliminasi = $req->eliminasi;
        $asesmen_risiko_jatuh_psikiatri->eliminasi_skor = $req->eliminasi_skor;
        $asesmen_risiko_jatuh_psikiatri->ambulasi = $req->ambulasi;
        $asesmen_risiko_jatuh_psikiatri->ambulasi_skor = $req->ambulasi_skor;
        $asesmen_risiko_jatuh_psikiatri->nutrisi = $req->nutrisi;
        $asesmen_risiko_jatuh_psikiatri->nutrisi_skor = $req->nutrisi_skor;
        $asesmen_risiko_jatuh_psikiatri->gangguan_pola_tidur = $req->gangguan_pola_tidur;
        $asesmen_risiko_jatuh_psikiatri->gangguan_pola_tidur_skor = $req->gangguan_pola_tidur_skor;
        $asesmen_risiko_jatuh_psikiatri->riwayat_jatuh = $req->riwayat_jatuh;
        $asesmen_risiko_jatuh_psikiatri->riwayat_jatuh_skor = $req->riwayat_jatuh_skor;

        $asesmen_risiko_jatuh_psikiatri->pengobatan_tanpa = $req->pengobatan_tanpa;
        $asesmen_risiko_jatuh_psikiatri->pengobatan_jantung = $req->pengobatan_jantung;
        $asesmen_risiko_jatuh_psikiatri->pengobatan_psikotoprik = $req->pengobatan_psikotoprik;
        $asesmen_risiko_jatuh_psikiatri->pengobatan_tambahan = $req->pengobatan_tambahan;
        $asesmen_risiko_jatuh_psikiatri->diagnosa_bipolar = $req->diagnosa_bipolar;
        $asesmen_risiko_jatuh_psikiatri->diagnosa_obat = $req->diagnosa_obat;
        $asesmen_risiko_jatuh_psikiatri->diagnosa_gangguan = $req->diagnosa_gangguan;
        $asesmen_risiko_jatuh_psikiatri->diagnosa_demensia = $req->diagnosa_demensia;

        $asesmen_risiko_jatuh_psikiatri->pengobatan_tanpa_skor = $req->pengobatan_tanpa_skor;
        $asesmen_risiko_jatuh_psikiatri->pengobatan_jantung_skor = $req->pengobatan_jantung_skor;
        $asesmen_risiko_jatuh_psikiatri->pengobatan_psikotoprik_skor = $req->pengobatan_psikotoprik_skor;
        $asesmen_risiko_jatuh_psikiatri->pengobatan_tambahan_skor = $req->pengobatan_tambahan_skor;
        $asesmen_risiko_jatuh_psikiatri->diagnosa_bipolar_skor = $req->diagnosa_bipolar_skor;
        $asesmen_risiko_jatuh_psikiatri->diagnosa_obat_skor = $req->diagnosa_obat_skor;
        $asesmen_risiko_jatuh_psikiatri->diagnosa_gangguan_skor = $req->diagnosa_gangguan_skor;
        $asesmen_risiko_jatuh_psikiatri->diagnosa_demensia_skor = $req->diagnosa_demensia_skor;        
        ...
        $asesmen_risiko_jatuh_psikiatri->updated_by = Auth::user()->id;
