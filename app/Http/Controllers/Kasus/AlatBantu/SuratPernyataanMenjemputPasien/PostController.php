...
namespace App\Http\Controllers\Kasus\AlatBantu\SuratPernyataanMenjemputPasien;
...
class PostController extends Controller
{
    public function submit(Request $request)
    {
        ...
        try {
            ...
            $new_alat_bantu->type = 'surat-pernyataan-menjemput-pasien';
            ...
            $status = 1;
            $message = 'Surat Pernyataan Menjemput Pasien berhasil dibuat';
            $title = 'Berhasil!';
        } catch (\Exception $e) {
            $conn->rollBack();
            ...
            $status = 0;
            $message = 'Surat Pernyataan Menjemput Pasien gagal dibuat';
            $title = 'Gagal!';
        }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $status = 1;
            $message = 'Surat Pernyataan Menjemput Pasien berhasil diperbarui';
            $title = 'Berhasil!';
        } catch (\Exception $e) {
            $conn->rollBack();
            app('App\Http\Controllers\Error\Handler')->bugsnag($e);
            ...
            $status = 0;
            $message = 'Surat Pernyataan Menjemput Pasien gagal diperbarui';
            $title = 'Gagal!';
        }
    ...
    public function delete(Request $request)
    {
        try {
            ...
            $status = 1;
            $message = 'Surat Pernyataan Menjemput Pasien berhasil dihapus';
            $title = 'Berhasil!';
        } catch (\Exception $e) {
            app('App\Http\Controllers\Error\Handler')->bugsnag($e);
            $status = 0;
            $message = 'Surat Pernyataan Menjemput Pasien gagal dihapus';
            $title = 'Gagal!';
        }
    ...
    private function formValuesToJson($request, $alatbantu_id = null)
    {
        ...
        $obj->tanggal_lahir = $request->post('tanggal_lahir');
        $obj->alamat = $request->post('alamat');
        $obj->no_telepon = $request->post('no_telepon');
        $obj->hubungan = $request->post('hubungan');
