...
class ViewController extends Controller
{
    public function index($nomor_kasus)
    {
        ...
        $data['alat_bantu'] = AlatBantu::query()
            ...
            ->where('type', 'surat-pernyataan-menjemput-pasien')
            ->get();
        ...
        return view('kasus.alatbantu.surat-pernyataan-menjemput-pasien.index', $data);
    }
    ...
    public function print($nomor_kasus, $alatbantu_id)
    {
        ...
        $pdf = DOMPDF::loadView("kasus.alatbantu.surat-pernyataan-menjemput-pasien.print", $data);
        $pdf->setPaper('a4');
