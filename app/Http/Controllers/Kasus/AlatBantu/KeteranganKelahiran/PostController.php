...
{	
	public function create($nomor_kasus,Request $request) // 1=cowok, 2=cewek
    {
        ...
        try {
            ...
            $ket->pangkat = $request->pangkat;
            $ket->kesatuan = $request->kesatuan;
            $ket->no_pastur = $request->no_pastur;
            $ket->tanggal_pastur = Carbon::parse($request->tanggal_pastur);
            $ket->save();
            $status = 1;
