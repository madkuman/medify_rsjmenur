...
class ViewController extends Controller
{
    public function index($nomor_kasus)
    {
        ...
        $data['alat_bantu'] = AlatBantu::query()
            ...
            ->where('type', 'surat-keterangan-hiv')
            ->get();
        ...
        return view('kasus.alatbantu.surat-keterangan-hiv.index', $data);
    }
    ...
    public function print($nomor_kasus, $alatbantu_id)
    {
        ...
        $pdf = DOMPDF::loadView("kasus.alatbantu.surat-keterangan-hiv.print", $data);
        $pdf->setPaper('a4');
