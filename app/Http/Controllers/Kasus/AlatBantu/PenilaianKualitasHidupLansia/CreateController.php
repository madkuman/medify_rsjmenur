...
class CreateController extends Controller
{
    public function create($req, $kasus_id){
    	$penilaian_kualitas_hidup_lansia = new PenilaianKualitasHidupLansia;
    	...
    	$penilaian_kualitas_hidup_lansia->created_by = Auth::user()->id;
    	$penilaian_kualitas_hidup_lansia->kasus_id = $kasus_id;
