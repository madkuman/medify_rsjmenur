...
class ViewController extends Controller
{
    public function index($nomor_kasus)
    {
        ...
        $data['alat_bantu'] = AlatBantu::query()
            ...
            ->where('type', 'form-transfer-antar-ruangan')
            ->get();
        ...
        return view('kasus.alatbantu.form-transfer-antar-ruangan.index', $data);
    }
    ...
    public function print($nomor_kasus, $alatbantu_id)
    {
        ...
        $pdf = DOMPDF::loadView("kasus.alatbantu.form-transfer-antar-ruangan.print", $data);
        $pdf->setPaper('a4');
