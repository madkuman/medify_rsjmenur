...
class ViewController extends Controller
{
    public function index($nomor_kasus)
    {
        ...
        $data['alat_bantu'] = AlatBantu::query()
            ...
            ->where('type', 'hasil-pengujian-kesehatan')
            ->get();
        ...
        return view('kasus.alatbantu.hasil-pengujian-kesehatan.index', $data);
    }
    ...
    public function print($nomor_kasus, $alatbantu_id)
    {
        ...
        $pdf = DOMPDF::loadView("kasus.alatbantu.hasil-pengujian-kesehatan.print", $data);
        $pdf->setPaper('a4');
