...
namespace App\Http\Controllers\Kasus\AlatBantu\HasilPengujianKesehatan;
...
class PostController extends Controller
{
    public function submit(Request $request)
    {
        ...
        try {
            ...
            $new_alat_bantu->type = 'hasil-pengujian-kesehatan';
            ...
            $status = 1;
            $message = 'Hasil Pengujian Kesehatan berhasil dibuat';
            $title = 'Berhasil!';
        } catch (\Exception $e) {
            $conn->rollBack();
            ...
            $status = 0;
            $message = 'Hasil Pengujian Kesehatan gagal dibuat';
            $title = 'Gagal!';
        }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $status = 1;
            $message = 'Hasil Pengujian Kesehatan berhasil diperbarui';
            $title = 'Berhasil!';
        } catch (\Exception $e) {
            $conn->rollBack();
            app('App\Http\Controllers\Error\Handler')->bugsnag($e);
            ...
            $status = 0;
            $message = 'Hasil Pengujian Kesehatan gagal diperbarui';
            $title = 'Gagal!';
        }
    ...
    public function delete(Request $request)
    {
        try {
            ...
            $status = 1;
            $message = 'Hasil Pengujian Kesehatan berhasil dihapus';
            $title = 'Berhasil!';
        } catch (\Exception $e) {
            app('App\Http\Controllers\Error\Handler')->bugsnag($e);
            $status = 0;
            $message = 'Hasil Pengujian Kesehatan gagal dihapus';
            $title = 'Gagal!';
        }
