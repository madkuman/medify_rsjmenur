...
class PostController extends Controller
{
    public function submit(Request $request)
    {
        ...
        try {
            ...
            $new_alat_bantu->type = 'surat-keterangan-jiwa';
            ...
            $status = 1;
            $message = 'Surat Keterangan Jiwa berhasil dibuat';
            $title = 'Berhasil!';
        } catch (\Exception $e) {
            $conn->rollBack();
            ...
            $status = 0;
            $message = 'Surat Keterangan Jiwa gagal dibuat';
            $title = 'Gagal!';
        }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $status = 1;
            $message = 'Surat Keterangan Jiwa berhasil diperbarui';
            $title = 'Berhasil!';
        } catch (\Exception $e) {
            $conn->rollBack();
            app('App\Http\Controllers\Error\Handler')->bugsnag($e);
            ...
            $status = 0;
            $message = 'Surat Keterangan Jiwa gagal diperbarui';
            $title = 'Gagal!';
        }
    ...
    public function delete(Request $request)
    {
        try {
            ...
            $status = 1;
            $message = 'Surat Keterangan Jiwa berhasil dihapus';
            $title = 'Berhasil!';
        } catch (\Exception $e) {
            app('App\Http\Controllers\Error\Handler')->bugsnag($e);
            $status = 0;
            $message = 'Surat Keterangan Jiwa gagal dihapus';
            $title = 'Gagal!';
        }
