...
class CreateController extends Controller
{
    public function create($req, $kasus_id){
    	$asesmen_napza_rawat_jalan_non_ipwl = new AsesmenNapzaRawatJalanNonIPWL;
    	...
    	$asesmen_napza_rawat_jalan_non_ipwl->created_by = Auth::user()->id;
    	$asesmen_napza_rawat_jalan_non_ipwl->kasus_id = $kasus_id;
