...
class PostController extends Controller
{
    ...
    private function formValuesToJson($request, $alatbantu_id = null)
    {
        ...
        // Buat array dengan key 'parameter' yang berisi semua nilai yang dicentang
        $result = [
        ...
        // $obj->metamphethamine = $request->post('metamphethamine');
        // $obj->amphetamine = $request->post('amphetamine');
        // $obj->morphine_heroin = $request->post('morphine_heroin');
        // $obj->mariyuana_thc = $request->post('mariyuana_thc');
