...
class CreateController extends Controller
{
    public function create($req, $kasus_id){
    	$laporan_psikogram_pemeriksaan_psikologi = new LaporanPsikogramPemeriksaanPsikologi;
    	...
    	$laporan_psikogram_pemeriksaan_psikologi->created_by = Auth::user()->id;
    	$laporan_psikogram_pemeriksaan_psikologi->kasus_id = $kasus_id;
