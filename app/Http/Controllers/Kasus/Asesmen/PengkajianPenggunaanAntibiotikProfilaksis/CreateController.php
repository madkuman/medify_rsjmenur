...
class CreateController extends Controller
{
    public function create($req, $kasus_id){
    	$pengkajian_penggunaan_antibiotik_profilaksis = new PengkajianPenggunaanAntibiotikProfilaksis;
    	...
    	$pengkajian_penggunaan_antibiotik_profilaksis->created_by = Auth::user()->id;
    	$pengkajian_penggunaan_antibiotik_profilaksis->kasus_id = $kasus_id;
