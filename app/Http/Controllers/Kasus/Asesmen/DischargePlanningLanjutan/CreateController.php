...
class CreateController extends Controller
{
    public function create($req, $kasus_id){
    	$discharge_planning_lanjutan = new DischargePlanningLanjutan;
    	...
    	$discharge_planning_lanjutan->created_by = Auth::user()->id;
    	$discharge_planning_lanjutan->kasus_id = $kasus_id;
