...
namespace App\Http\Controllers\Kasus\Asesmen\FormulirPermintaanEct;
...
class PostController extends Controller
{
    ...
    {
        $this->asesmen_title = 'Formulir Permintaan Electro Convulsive Therapy (ECT)';
        $this->asesmen_namespace = 'App\Http\Controllers\Kasus\Asesmen\FormulirPermintaanEct';
        $this->asesmen_slug = 'formulir-permintaan-ect';
    }
    ...
    public function addTTD(Request $request)
    {
        ...
        try {
            ...
            if ($success) {
                ...
                if ($request->type == 'ttd_yang_menyatakan_persetujuan') {
                    $newVal->yang_menyatakan_persetujuan = $request->yang_menyatakan;
                    $newVal->ttd_yang_menyatakan_persetujuan = $img_dir['file_original'];
                } elseif ($request->type == 'ttd_yang_menyatakan_penolakan') {
                    $newVal->yang_menyatakan_penolakan = $request->yang_menyatakan;
                    $newVal->ttd_yang_menyatakan_penolakan = $img_dir['file_original'];
                }
