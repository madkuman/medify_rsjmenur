    ...
    public function edit($nomor_kasus = null, Request $request)
    {
        ...
        try {
            ...
            $log = app('App\Http\Controllers\Kasus\Log\CreateController')
                ->create($kasus->id ?? $data->pasien_id, 'edit', 'general-consent-for-treatment', $alatBantu->id);

            $status = 1;
            $message = 'General Consent For Treatment berhasil diperbaharui';
            $title = 'Berhasil!';
            ...
            $data['type'] = 'error';
            $data['title'] = 'Gagal';
            $data['text'] = 'General Consent For Treatment gagal diperbaharui : Kesalahan Server, silahkan hubungi admin';
            $data['url'] = 0;
