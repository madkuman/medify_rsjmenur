...
class EditController extends Controller
{
    public function edit(Request $req){
    	$form_transfer_internal_rumah_sakit = FormTransferInternalRumahSakit::find($req->id);
    	if(!isset($req->flag_terima)) {
            ...
            $form_transfer_internal_rumah_sakit->updated_by = Auth::user()->id;
        }
        if(isset($req->flag_terima)) {
        ...
        if(isset($req->terima_by) && !empty($req->terima_by)){
            $form_transfer_internal_rumah_sakit->terima_by = Auth::user()->id;
            $form_transfer_internal_rumah_sakit->terima_at = Carbon::now();
        }
