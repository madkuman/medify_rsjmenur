...
class CreateController extends Controller
{
    public function create($req, $kasus_id){
    	$evaluasi_perencanaan_pemulangan_pasien = new EvaluasiPerencanaanPemulanganPasien;
    	...
    	$evaluasi_perencanaan_pemulangan_pasien->created_by = Auth::user()->id;
    	$evaluasi_perencanaan_pemulangan_pasien->kasus_id = $kasus_id;
