...
class ViewController extends Controller
{
    ...
    {
        $kasus_with = [];
        $kasus = app('App\Http\Controllers\Kasus\Asesmen\GeneralConsent\ReadController')->getKasusSingle($nomor_kasus, $kasus_with);

        $general_consent = app('App\Http\Controllers\Kasus\Asesmen\GeneralConsent\ReadController')->getAlatBantu($kasus->id, 'general-consent');
    ...
    public function single($nomor_kasus = null, Request $request)
    {
        ...
        $general_consent = app('App\Http\Controllers\Kasus\Asesmen\GeneralConsent\ReadController')->getAlatBantuSingle($id);
        ...
        return view('kasus.asesmen.general-consent.form', $data);
    }
    ...
    public function print($nomor_kasus = null, Request $request)
    {
        ...
        $pdf = MPDF::loadView('kasus.asesmen.general-consent.print', $data, [], [
            'mode' => 'utf-8',
            // 'format' => [115, 20]
        ]);
