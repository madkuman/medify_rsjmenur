...
class EditController extends Controller
{
    public function edit(Request $req){
    	$laporan_deskripsi_pemeriksaan_psikologi = LaporanDeskripsiPemeriksaanPsikologi::find($req->id);
        ...
        $laporan_deskripsi_pemeriksaan_psikologi->updated_by = Auth::user()->id;
