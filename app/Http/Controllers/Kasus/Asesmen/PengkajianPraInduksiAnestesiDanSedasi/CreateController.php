...
class CreateController extends Controller
{
    public function create($req, $kasus_id){
    	$pengkajian_pra_induksi_anestesi_dan_sedasi = new PengkajianPraInduksiAnestesiDanSedasi;
    	...
    	$pengkajian_pra_induksi_anestesi_dan_sedasi->created_by = Auth::user()->id;
    	$pengkajian_pra_induksi_anestesi_dan_sedasi->kasus_id = $kasus_id;
