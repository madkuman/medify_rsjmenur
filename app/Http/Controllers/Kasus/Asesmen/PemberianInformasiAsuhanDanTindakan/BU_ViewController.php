...
class ViewController extends Controller
{
    ...
    {
        $this->asesmen_title = 'Pemberian Informasi Asuhan Medis dan Tindakan Kepada Pasien dan Keluarga';
        $this->asesmen_namespace = 'App\Http\Controllers\Kasus\PemberianInformasiAsuhanDanTindakan;';
