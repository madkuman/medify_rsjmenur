...
namespace App\Http\Controllers\Kasus\Asesmen\AbbreviatedMentalTest;;
...
class PostController extends Controller
{
    ...
    {
        $this->asesmen_title = 'The Abbreviated Mental Test (AMT) Score';
        $this->asesmen_namespace = 'App\Http\Controllers\Kasus\Asesmen\AbbreviatedMentalTest;';
        $this->asesmen_slug = 'abbreviated-mental-test';
    }
    ...
    public function submitForm($nomor_kasus, Request $request)
    {
        ...
        try {
            ...
            foreach ($input as $key => $val) {
                ...
                if ($key == 'id')    continue;
                if ($key == 'berada_dimana') $hasil[$key] = $val;
                if ($key == 'tahun_berapa') $hasil[$key] = $val;
                if ($key == 'umur_berapa') $hasil[$key] = $val;
                if ($key == 'tahun_lahir') $hasil[$key] = $val;
                if ($key == 'jam_berapa') $hasil[$key] = $val;
                if ($key == 'alamat_rumah') $hasil[$key] = $val;
                if ($key == 'kenal_nakes') $hasil[$key] = $val;
                if ($key == 'tahun_merdeka') $hasil[$key] = $val;
                if ($key == 'siapa_presiden') $hasil[$key] = $val;
                if ($key == 'hitung_mundur') $hasil[$key] = $val;
    ...
    public function addTTD($nomor_kasus = null, Request $request)
    {
        ...
        try {
            ...
            if (!is_null($nomor_kasus)) {
                $url = 'kasus/' . $nomor_kasus . '/asesmen/abbreviated-mental-test';
            } else {
