...
class CreateController extends Controller
{
    public function create($req, $kasus_id){
    	$skoring_derajat_gejala_psikotik = new SkoringDerajatGejalaPsikotik;
        ...
        $skoring_derajat_gejala_psikotik->created_by = Auth::user()->id;
        $skoring_derajat_gejala_psikotik->kasus_id = $kasus_id;
