...
class ViewController extends Controller
{
    ...
    {
        $this->view_path = 'kasus.asesmen.implementasi-manajer-pelayanan-pasien';
        $this->read = app(\App\Http\Controllers\Kasus\Asesmen\ImplementasiManajerPelayananPasien\ReadController::class);
    }
