...
namespace App\Http\Controllers\Kasus\Asesmen\ChecklistKeselamatanPasienDipoliGigiDanMulut;;
...
class ViewController extends Controller
{
    ...
    {
        $this->asesmen_title = 'Checklist Keselamatan Pasien di Poli Gigi dan Mulut';
        $this->asesmen_namespace = 'App\Http\Controllers\Kasus\Asesmen\ChecklistKeselamatanPasienDipoliGigiDanMulut;';
        $this->asesmen_slug = 'checklist-keselamatan-pasien-dipoli-gigi-dan-mulut';
    }
