...
namespace App\Http\Controllers\Kasus\Asesmen\ChecklistOrientasiPasienBaru;;
...
class PostController extends Controller
{
    ...
    {
        $this->asesmen_title = 'Checklist Orientasi Pasien Baru';
        $this->asesmen_namespace = 'App\Http\Controllers\Kasus\Asesmen\ChecklistOrientasiPasienBaru;';
        $this->asesmen_slug = 'checklist-orientasi-pasien-baru';
    }
    ...
    public function addTTD($nomor_kasus = null, Request $request)
	 {
		...
		try {
			...
			if (!is_null($nomor_kasus)) {
				$url = 'kasus/' . $nomor_kasus . '/asesmen/checklist-orientasi-pasien-baru';
			}else{
