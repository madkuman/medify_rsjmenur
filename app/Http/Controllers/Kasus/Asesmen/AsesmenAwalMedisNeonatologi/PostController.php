...
namespace App\Http\Controllers\Kasus\Asesmen\AsesmenAwalMedisNeonatologi;
...
class PostController extends Controller
{
	public function __construct()
	{
		...
		$this->asesmen_namespace = 'App\Http\Controllers\Kasus\Asesmen\AsesmenAwalMedisNeonatologi';
		$this->asesmen_slug = 'asesmen-awal-medis-neonatologi';
	}
	...
	public function submitForm($nomor_kasus, Request $request)
	{
		...
		try {
			...
			$alatBantu->type = 'asesmen-awal-medis-neonatologi';
