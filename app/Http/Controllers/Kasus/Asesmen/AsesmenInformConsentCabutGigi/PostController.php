...
namespace App\Http\Controllers\Kasus\Asesmen\AsesmenInformConsentCabutGigi;
...
class PostController extends Controller
{
	...
	{
		$this->asesmen_title = 'Asesmen Awal Keperawatan Medis Neonatologi';
		$this->asesmen_namespace = 'App\Http\Controllers\Kasus\Asesmen\AsesmenInformConsentCabutGigi';
		$this->asesmen_slug = 'asesmen-inform-consent-cabut-gigi';
	}
	...
	public function submitForm($nomor_kasus, Request $request)
	{
		...
		try {
			...
			$alatBantu->type = 'asesmen-inform-consent-cabut-gigi';
