...
class CreateController extends Controller
{
    public function create($req, $kasus_id){
    	$laporan_psikologi_rekruitmen = new LaporanHasilPemeriksaanPsikologiRekruitmen;
    	...
    	$laporan_psikologi_rekruitmen->created_by = Auth::user()->id;
    	$laporan_psikologi_rekruitmen->kasus_id = $kasus_id;
