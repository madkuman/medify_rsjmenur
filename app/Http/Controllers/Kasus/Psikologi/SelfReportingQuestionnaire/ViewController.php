...
class ViewController extends Controller
{
    ...
    public function index($nomor_kasus)
    {
        ...
        return view('kasus.psikologi.' . $this->asesmen_slug . '.index', $data);
    }
    ...
    public function single($nomor_kasus, $hasil_id)
    {
        ...
        return view('kasus.psikologi.' . $this->asesmen_slug . '.view', $data);
    }
    ...
    public function create($nomor_kasus)
    {
        ...
        return view('kasus.psikologi.' . $this->asesmen_slug . '.form', $data);
    }
    ...
    public function print($nomor_kasus, $hasil_id)
    {
        ...
        $pdf = MPDF::loadView('kasus.psikologi.' . $this->asesmen_slug . '.print', $data);
