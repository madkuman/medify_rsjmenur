...
use DataTables;
use Datetime;
use App\Exports\LabPA\InvoiceHistori;
...
class ReadController extends Controller
{
    ...
    public function getPatientService($slug) {
        return Transaction::where('slug',$slug)->with('kelas', 'pasien', 'pembayaran.perusahaan.tipe', 'asal', 'kasus')->first();
    }
    ...
    public function getFormResult($transaction_id){
        try {
            $result = Result::where('transaction_id', $transaction_id)->first();
            return $result;
        } catch (Exception $e) {
            return FALSE;
        }
