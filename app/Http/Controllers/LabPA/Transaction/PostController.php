...
class PostController extends Controller
{
    ...
    static protected $slug = "lab-pa";
    static protected $slug_kasir = 'kasir-lab-pa';
    ...
    public function kirimKasir($transaction, $detail_data)
    {
        ...
        $judul = 'Lab Patologi Anatomi '.$nama_layanan.' - '.$transaction->pasien->name;
        $kasir_id = $kasir_id;
    ...
    public function kirimTagihan($slug)
    {
        try {
            ...
            foreach($transaksi->detail as $d){
                $temp = app('App\Http\Controllers\LabPA\Transaction\CreateController')->saveTagihanData($transaksi, $d);
       ...
       return redirect('labpa/transaksi/permintaan/'.$slug)->with($status, $message); 
    }
}