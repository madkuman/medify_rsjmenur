...
class LabPKController extends Controller
{
    public function index()
    {
        ...
        return view('highlevel.labpk', $data);
    }

    public function getPasienHarian($date)
    {
        $startDate = $date->startOfWeek();
        $transactions = Transaksi::where('created_at', '>=', $startDate)
                    ->groupBy('date')
                    ->orderBy('date', 'ASC')
                    ->get(array(
    ...
    {
        $transactionDetails = TransaksiDetail::groupBy('tarif_id')
    ...
    {
        $transactions = Transaksi::pluck('kasus_id');
