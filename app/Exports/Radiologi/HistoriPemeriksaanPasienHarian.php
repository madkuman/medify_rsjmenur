...
class HistoriPemeriksaanPasienHarian implements FromView, WithEvents
{
    ...
    public function __construct($data)
    {
        $this->data = $data;
        $this->last_column = 'J';
        $this->last_row = count($data['transaksi']) + 7;
    }

    public function view(): View
    {
        return view('radiolog.laporan.view.histori-pemeriksaan-pasien-harian', $this->data);
    }
