...
class LaporanBulananPelayananGeriatri implements FromView, WithEvents
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('pasien.laporanv2.pages.dkk-18-laporan-bulanan-pelayanan-geriatri.excel', $data);
    }
