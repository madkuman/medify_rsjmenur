...
class DataPelayananPasienRawatInap implements FromView, WithEvents
{
	use Exportable;
    /**
    ...
    */
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getColumnDimension('X')->setWidth(12);
                $event->sheet->getColumnDimension('Y')->setWidth(15);
                $event->sheet->getColumnDimension('Z')->setWidth(12);
                $event->sheet->getColumnDimension('AA')->setWidth(12);
                ...
                $event->sheet->getColumnDimension('AH')->setWidth(30);
                ...
                $event->sheet->getColumnDimension('AT')->setWidth(15);
                ...
                $event->sheet->getColumnDimension('AX')->setWidth(12);
                $event->sheet->getColumnDimension('AY')->setWidth(15);
                $event->sheet->getColumnDimension('AZ')->setWidth(12);
                $event->sheet->getColumnDimension('BA')->setWidth(12);
                $event->sheet->getColumnDimension('BB')->setWidth(12);
                $event->sheet->getColumnDimension('BC')->setWidth(12);
    ...
    {
        $data = $this->data;
        return view('pasien.laporan.data-pasien-rawat-inap',$data);
    }
}
