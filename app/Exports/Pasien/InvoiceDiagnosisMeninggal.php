...
class InvoiceDiagnosisMeninggal implements FromView, WithEvents
{
    use Exportable;
    /**
    ...
    */
    ...
    public function view(): View
    {
        $start = $this->date1;
        $end = $this->date2;
        $data = app('App\Http\Controllers\Pasien\Laporan\DiagnosisMeninggal')->diagnosis($start,$end);
        dd($data);
        return view('pasien.laporan.diagnosisjalan',$data);
    }
}
