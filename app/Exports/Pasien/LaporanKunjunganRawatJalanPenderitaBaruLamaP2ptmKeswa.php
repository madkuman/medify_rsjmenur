...
class LaporanKunjunganRawatJalanPenderitaBaruLamaP2ptmKeswa implements FromView, WithEvents
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('pasien.laporanv2.pages.dkk-5-laporan-bulanan-kunjungan-rawat-jalan-penderita-baru-lama-p2ptm-keswa.excel', $data);
    }
