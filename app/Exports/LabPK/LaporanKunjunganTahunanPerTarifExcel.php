...
class LaporanKunjunganTahunanPerTarifExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->styleCells(
                    'A'.$this->last_row.':'.$this->last_column.$this->last_row,
                    [
                        'font' => [
                            'bold' => true
                        ],
    ...
    {
        return view('labpk.laporan.view.laporan-kunjungan-tahunan-per-tarif', $this->data);
    }
