...
class LaporanSuratPemesananMakananTambahan implements FromView, WithEvents
{
    use Exportable;
    ...
    {
        return view('gizi.laporan.view.laporan-surat-pemesanan-makanan-tambahan ', $this->data);
    }
}
