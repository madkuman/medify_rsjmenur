...
class LaporanKesesuaianDokterFornasHarianExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    public function __construct($data)
    {
        ...
        $this->last_row = count($data['data']) + 5;
    ...
    {
        return view('farmasi.laporan.view.laporan-kesesuaian-dokter-fornas-harian', $this->data);
    }
