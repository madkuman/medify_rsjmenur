...
class LaporanPersediaanFarmasiExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    {
        $this->data = $data;
        $this->last_column = excel_column(9);
    ...
    {
        return view('farmasi.laporan.view.laporan-persediaan-farmasi', $this->data);
    }
