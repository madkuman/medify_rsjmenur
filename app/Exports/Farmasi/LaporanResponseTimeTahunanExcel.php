...
class LaporanResponseTimeTahunanExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    {
        return view('farmasi.laporan.view.laporan-response-time-tahunan', $this->data);
    }
