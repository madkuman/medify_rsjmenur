...
class LaporanBarangMendekatiExpiredExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    {
        return view('farmasi.laporan.view.laporan-barang-mendekati-expired', $this->data);
    }
