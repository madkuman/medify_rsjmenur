...
class LaporanPerbekalanFarmasiExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    {
        return view('farmasi.laporan.view.laporan-perbekalan-farmasi', $this->data);
    }
