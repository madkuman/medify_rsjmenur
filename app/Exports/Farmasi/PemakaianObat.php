...
class PemakaianObat implements FromView, WithEvents
{
	use Exportable;
    /**
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('farmasi.laporan.pemakaian-obat-xls', [
            'farm' => $data['farm'],
            'farmer' => $data['farmer'],
            'items' => $data['items'],
