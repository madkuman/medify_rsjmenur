...
class LaporanBarangTelahExpiredExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    {
        return view('farmasi.laporan.view.laporan-barang-telah-expired', $this->data);
    }
