...
class LaporanWaktuPelayananExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    {
        return view('farmasi.laporan.view.laporan-waktu-pelayanan', $this->data);
    }
