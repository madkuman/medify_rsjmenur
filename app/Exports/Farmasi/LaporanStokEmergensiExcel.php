...
class LaporanStokEmergensiExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    public function __construct($data)
    {
        ...
        {
           $count_column = count($item) + $count_column;
           break;
        }
    ...
    {
        return view('farmasi.laporan.view.laporan-stok-emergensi', $this->data);
    }
