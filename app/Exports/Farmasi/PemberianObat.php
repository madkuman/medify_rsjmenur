...
class PemberianObat implements FromView, WithEvents
{
	use Exportable;
    /**
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('farmasi.laporan.pemberian-obat-xls', [
            'farm' => $data['farm'],
            'farmer' => $data['farmer'],
            'items' => $data['items'],
            'pasien' => $data['pasien'],
