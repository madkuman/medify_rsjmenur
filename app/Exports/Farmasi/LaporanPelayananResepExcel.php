...
class LaporanPelayananResepExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    {
        return view('farmasi.laporan.view.laporan-pelayanan-resep', $this->data);
    }
