...
class LaporanKesesuaianDokterFornasBulananExcel implements FromView, WithEvents, WithColumnFormatting
{
    ...
    {
        $this->data = $data;
        $this->last_column = excel_column(14);
        $this->last_row = count($data['data'])*2 + 8;
    ...
    {
        return view('farmasi.laporan.view.laporan-kesesuaian-dokter-fornas-bulanan', $this->data);
    }
