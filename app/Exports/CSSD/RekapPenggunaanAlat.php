...
class RekapPenggunaanAlat implements FromView, WithEvents
{
	use Exportable;
	...
	public function registerEvents(): array
	{
		return [
			AfterSheet::class    => function(AfterSheet $event) {
				...
				$event->sheet->styleCells(
					'A1:'.$this->last_column.$this->row_count,
					[
						'alignment' => [
							'vertical'     => \PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER,
							'horizontal'   => \PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER,
	...
	{
		$this->row_count = (count($this->data['alkes'])) + 3;
		$this->last_column = $this->getLastColumn(count($this->data['tanggal']) + 2);

		return view('cssd.laporan.rekap-penggunaan-alat',$this->data);
	}
