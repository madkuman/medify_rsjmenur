...
class DiagnosisTerbanyak implements FromView, WithEvents
{
	use Exportable;
	...
	{
		$this->row_count = (count($this->data['diagnosis'])) + 2 ;
		$this->last_column = $this->getLastColumn(count($this->data['tanggal']) +3);

		return view('kamaroperasi.laporan.diagnosis-terbanyak',$this->data);
	}
