...
class BukuPiutang implements FromView, WithEvents, ShouldAutoSize
{
	use Exportable;
	...
	public function view(): View
	{
		...
		$this->rowNumber = count($this->piutang['perusahaan']);
		return view('keuangan.laporan.piutang.buku-piutang-print',$this->piutang);
	}
}