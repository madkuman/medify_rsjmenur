...
use Carbon\Carbon;
use App\Exports\LabPK\RekapJumlahPasienBulanan;
use File;
...
class RekapJumlahPasienBulananGenerate extends Command
{
     ...
     * @var string
     */
    protected $signature = 'labpk:laporan-rekap-jumlah-pasien-bulanan {date=0}';
     ...
     * @var string
     */
    protected $description = 'Generate Laporan Lab PK Diagnosa Bulanan Format : YYYY-MM (2020-04)';
    ...
    public function handle()
    {
        ...
        $base_path = '/downloads/laporan/labpk/rekap-jumlah-pasien-bulanan';
        $path = public_path().$base_path;
        $path_download = url('/').$base_path;
       
        $data = app('App\Http\Controllers\LabPK\Laporan\ReadRekapJumlahPasienBulananController')->get($start,$end);
        ...
        $laporan_data = [];
        $laporan_data['slug'] = 'lab-pk-rekap-jumlah-pasien-bulanan';
