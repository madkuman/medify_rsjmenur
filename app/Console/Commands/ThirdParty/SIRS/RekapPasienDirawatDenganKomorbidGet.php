...
class RekapPasienDirawatDenganKomorbidGet extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'third-party-sirs:rekap-pasien-dirawat-dengan-komorbid {tanggal=0}';
     ...
     * @var string
     */
    protected $description = 'Informasi jumlah pasien Covid-19 yang masih dirawat inap (dengan komorbid) di rumah sakit per hari';
    ...
    public function handle()
    {
        ...
        $data = $content->RekapPasienDirawatKomorbid;
        ...
        foreach ($data as $d) {
            if ($d->tanggal == $tanggal) {
                ...
                echo "icu_tekanan_negatif_dengan_ventilator_confirm_l :".$d->icu_tekanan_negatif_dengan_ventilator_confirm_l."\n";
                echo "icu_tekanan_negatif_dengan_ventilator_confirm_p :".$d->icu_tekanan_negatif_dengan_ventilator_confirm_p."\n";
                ...
                echo "icu_tekanan_negatif_tanpa_ventilator_confirm_l :".$d->icu_tekanan_negatif_tanpa_ventilator_confirm_l."\n";
                echo "icu_tekanan_negatif_tanpa_ventilator_confirm_p :".$d->icu_tekanan_negatif_tanpa_ventilator_confirm_p."\n";
