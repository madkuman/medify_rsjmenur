...
class RekapPasienDirawatTanpaKomorbidUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'third-party-sirs:rekap-pasien-dirawat-tanpa-komorbid-update';
     ...
     * @var string
     */
    protected $description = 'Update jumlah pasien Covid-19 yang masih dirawat inap (tanpa komorbid) di rumah sakit per hari';
