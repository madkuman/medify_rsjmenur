...
class RekapPasienDirawatDenganKomorbidDelete extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'third-party-sirs:rekap-pasien-dirawat-dengan-komorbid-delete {tanggal=0}';
     ...
     * @var string
     */
    protected $description = 'Delete jumlah pasien Covid-19 yang masih dirawat inap (dengan komorbid) di rumah sakit per hari, format: YYYY-MM-DD';
