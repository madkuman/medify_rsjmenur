...
use App\Models\RawatJalan\LaporanTransaksi;
use App\Models\RawatJalan\LaporanTransaksiDiagnosis;
use App\Models\Kasus\Diagnosis;
use DB;
use Carbon\Carbon;

class LaporanImportRawatJalan extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'rawatjalan:importlaporan';
     ...
     * @var string
     */
    protected $description = 'Import Laporan Transaksi Rawat Jalan dari Transaksi';
    ...
    public function handle()
    {
        ...
        $first_transaksi_today = Transaksi::where('ordered_at','>=',$today)->first();
        ...
        while($current_count < $max_count){
            ...
            foreach($transaksis as $transaksi)
            {
                ...
                $laporan->poliklinik_id = $transaksi->poliklinik_id;
                ...
                $laporan->status = $transaksi->status;
                $laporan->ordered_at = $transaksi->ordered_at;
                $laporan->waktu_pemeriksaan = $transaksi->waktu_pemeriksaan;
