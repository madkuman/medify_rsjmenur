<script type="text/javascript">
    ...
    <div class="block-header block-header-default">
        <p class="h5 my-0 mb-10 judul-form"></p>
    ...
    <div class="block-content">
        ...
        <div class="form-group row">
            <div class="col-12">
                <textarea class="form-control kesimpulan tinymce" rows="4" cols="50" placeholder="Tambahkan Kesimpulan Di Sini" name="kesimpulan"></textarea>
            </div>
        </div>
    </div>
</div>`;
const formBasic = `<div class="block block-mode-hidden">
    <div class="block-header block-header-default">
        <p class="h5 my-0 mb-10 judul-form"></p>
        <div class="block-options">
            <button type="button" class="btn-block-option" data-toggle="block-option" data-action="content_toggle"><i class="si si-arrow-down"></i></button>
    ...
    <div class="block-content">
        ...
        <div class="form-group row">
            <div class="col-12">
                <textarea class="form-control makroskopis tinymce" rows="4" cols="50" placeholder="Tambahkan Hasil Pemeriksaan Makroskopis Di Sini" name="makroskopis"></textarea>
            </div>
        </div>
    </div>
    <div class="block-content">
        ...
        <div class="form-group row">
            <div class="col-12">
                <textarea class="form-control mikroskopis tinymce" rows="4" cols="50" placeholder="Tambahkan Hasil Pemeriksaan Mikroskopis Di Sini" name="mikroskopis"></textarea>
            </div>
        </div>
    </div>
    <div class="block-content">
