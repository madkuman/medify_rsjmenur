...
<div class="modal" id="modal-laporan-surat-pemesanan-makanan" role="dialog" aria-labelledby="modal-normal"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
...
<div class="modal" id="modal-laporan-surat-pemesanan-makanan-tambahan" role="dialog" aria-labelledby="modal-normal"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="GET" action="{{ url('gizi/laporan/laporan-surat-pemesanan-makanan-tambahan') }}"
                target="_blank">
                <div class="block block-themed block-transparent mb-0">
                    <div class="block-header">
                        <h3 class="block-title">Laporan Surat Pemesanan Makanan Tambahan</h3>
                    </div>
                    <div class="block-content">
                        @include('gizi.laporan.modal.components.form-date-single')
                        @include('gizi.laporan.modal.components.form-select-waktu-makan')
...
<div class="modal" id="modal-laporan-diet-pasien-bulanan" role="dialog" aria-labelledby="modal-normal"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
...
<div class="modal" id="modal-laporan-penyerapan-porsi-makanan" role="dialog" aria-labelledby="modal-normal"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="GET" action="{{ url('gizi/laporan/laporan-penyerapan-porsi-makanan') }}" target="_blank">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-alt-secondary btn-square"
...
<div class="modal" id="modal-laporan-rekap-diet-pelayanan-makanan-pasien" role="dialog"
    aria-labelledby="modal-normal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="GET" action="{{ url('gizi/laporan/laporan-rekap-diet-pelayanan-makanan-pasien') }}"
                target="_blank">
                <div class="block block-themed block-transparent mb-0">
                    <div class="block-header">
                    ...
                    <div class="block-content">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-select2" name="utama" placeholder="Pilih Jenis"
