            ...
            <div class="row row-deck">
                <div class="col-md-6 col-xl-3">
                    <div class="block block-bordered text-center">
                        ...
                        <div class="block-content block-content-full">
                            <button class="btn btn-hero btn-sm btn-noborder btn-secondary" data-toggle="modal"
                                data-target="#modal-laporan-permintaan-makanan">
                                Buat Laporan
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="block block-bordered text-center">
                        ...
                        <div class="block-content block-content-full">
                            <button class="btn btn-hero btn-sm btn-noborder btn-secondary" data-toggle="modal"
                                data-target="#modal-laporan-surat-pemesanan-makanan">
                                Buat Laporan
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="block block-bordered text-center">
                        ...
                        <div class="block-content block-content-full">
                            <button class="btn btn-hero btn-sm btn-noborder btn-secondary" data-toggle="modal"
                                data-target="#modal-laporan-diet-pasien-bulanan">
                                Buat Laporan
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="block block-bordered text-center">
                        ...
                        <div class="block-content block-content-full">
                            <button class="btn btn-hero btn-sm btn-noborder btn-secondary" data-toggle="modal"
                                data-target="#modal-laporan-penyerapan-porsi-makanan">
                                Buat Laporan
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="block block-bordered text-center">
                        ...
                        <div class="block-content block-content-full">
                            <button class="btn btn-hero btn-sm btn-noborder btn-secondary" data-toggle="modal"
                                data-target="#modal-laporan-rekap-diet-pelayanan-makanan-pasien">
                                Buat Laporan
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="block block-bordered text-center">
                        ...
                        <div class="block-content">
                            <p>Surat Pemesanan Makanan Tambahan</p>
                        </div>
                        <div class="block-content block-content-full">
                            <button class="btn btn-hero btn-sm btn-noborder btn-secondary" data-toggle="modal"
                                data-target="#modal-laporan-surat-pemesanan-makanan-tambahan">
                                Buat Laporan
                            </button>
                        </div>
                    </div>
