<div class="modal fade" id="modal-edit" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fromright modal-dialog-centered modal" role="document">
        <div class="modal-content">
            <form class="" method="POST" action="" id="form-edit-jenis-makanan">
                {{ csrf_field() }}
                <div class="block rounded block-transparent mb-0">
                    <div class="block-header">
                        <h4 class="font-w400 mb-0">Ubah Data Jenis Makanan</h4>
                    ...
                    <div class="block-content" id="block-edit-content">
                        ...
                        <div class="row d-none" id="edit-content">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Jenis</label>
                                    <select name="utama" id="edit_utama" class="js-select2 form-control" style="width: 100%;" onchange="changeJenis('#edit_utama','.edit-diet','#edit_diet')" required>
                                        <option value="1">Makanan Utama</option>
                                        <option value="0">Makanan Tambahan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 edit-diet d-none">
                                <div class="form-group">
                                    <label>Diet</label>
                                    <select name="diet" id="edit_diet" class="js-select2 form-control" disabled="disabled" style="width: 100%;" required>
