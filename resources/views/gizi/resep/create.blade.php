		...
		<div class="block-content">
			...
			<form action="{{url('gizi/resep/simpan')}}" method="POST">
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Nama Resep" name="nama_resep">
						</div>
						<div class="form-group">
							<label>Jumlah Porsi</label>
							<input type="text" class="form-control" placeholder="Jumlah Porsi" name="jumlah_porsi">
						</div>
						<div class="form-group">
							<label>Waktu Masak</label>
							<input type="text" class="form-control" placeholder="Waktu Masak" name="waktu_masak">
						</div>
						<div class="form-group">
							<label>Ukuran Tiap Porsi</label>
							<input type="text" class="form-control" placeholder="Ukuran Tiap Porsi" name="ukuran">
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label>Nilai Gizi E</label>
							<input type="text" class="form-control" placeholder="Nilai Gizi E" name="nilai_E">
						</div>
						<div class="form-group">
							<label>Nilai Gizi P</label>
							<input type="text" class="form-control" placeholder="Nilai Gizi P" name="nilai_P">
						</div>
						<div class="form-group">
							<label>Nilai Gizi L</label>
							<input type="text" class="form-control" placeholder="Nilai Gizi L" name="nilai_L">
						</div>
						<div class="form-group">
							<label>Nilai Gizi K</label>
							<input type="text" class="form-control" placeholder="Nilai Gizi K" name="nilai_K">
						</div>
					</div>
				</div>
				<hr>
							...
							<div class="row justify-content-center">
								<div class="col-3 ">
									<select name="bahan[]" class="form-control js-select2" style="width: 100%;" data-size="5">
										...
										@endif
										<option value="{{$bahan[$x]->id}}" {{$selected}}>{{$bahan[$x]->nama}}</option>
										@endfor
									</select>
								</div>
								<div class="col-2">
									<input type="text" class="form-control" placeholder="Jumlah BB" name="jumlah_BB[]">
								</div>
								<div class="col-2">
									<input type="text" class="form-control" placeholder="Jumlah BK" name="jumlah_BK[]">
								</div>
								<div class="col-1">
				...
				<div class="custom-control custom-checkbox mt-5">
						<input class="custom-control-input" type="checkbox" name="makanan_pokok" id="filter-vip" value="1">
						<label class="custom-control-label" for="filter-vip">Resep Makanan Pokok</label>
				</div>
				<hr>
				<div class="form-group row">
					<div class="col-12">
						...
						<textarea class="js-simplemde" id="simplemde" name="simplemde"></textarea>
					</div>
				</div>
				<div class="row">
					<div class="col-12">
