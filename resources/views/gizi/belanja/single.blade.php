	...
	<div class="block p-10">
		<div class="block-header">
			<h3 class="block-title">
				<a href="{{url('gizi/belanja/finalisasi/')}}/{{$data['belanja']->id}}" class="btn btn-primary pull-right">Konfirmasi Belanja</a>
				<a href="{{url('gizi/belanja/edit/')}}/{{$data['belanja']->id}}" class="btn btn-warning pull-right  mr-5"><i class="fa fa-edit"></i> Edit</a>
				<a href="{{url('gizi/belanja/delete/')}}/{{$data['belanja']->id}}">
				<button  class="btn btn-danger pull-right mr-5"><i class="fa fa-trash"></i> Delete</button></a>
