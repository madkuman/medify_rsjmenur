	...
	<div class="block p-10">
		...
		<form action="{{url('gizi/belanja/konfirmasi')}}" method="POST">
			...
			<div class="form-group">
				<div class="row">
					<div class="col-8">
						...
						<input type="text" value="{{$data['belanja']->deskripsi}}" class="form-control" 
				...
				<div class="row">
					<div class="col-4">
						<select name="bahan[]" class="form-control js-select2" style="width: 100%;" data-size="5" required>   
							<option value="{{$detail->bahan_makanan_id}}" selected>
							{{$detail->detail_bahan->nama}}({{$detail->detail_bahan->satuan}})</option>
					...
					<div class="col-3">
						<input type="text" name="jumlah_barang[]" class="form-control" autocomplete="off" 
						value="{{$detail->jumlah_estimasi}}"
						placeholder="Jumlah Bahan Makanan">
					</div>
					<div class="col-1">
			...
			<div class="row">
				<div class="col-4">
					<div class="form-group">
						<textarea class="form-control" placeholder="Keterangan" name="keterangan" 
						>{{$data['belanja']->keterangan}}</textarea>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	$('#buttonAdd').click(function(){
		...
		content +=				'<input type="text" name="jumlah_barang[]" class="form-control" autocomplete="off" placeholder="Jumlah Bahan Makanan">'
		content +=			'</div>'
