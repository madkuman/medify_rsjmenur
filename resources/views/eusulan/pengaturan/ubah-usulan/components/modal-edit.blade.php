                    ...
                    <div class="block-content" style="padding-left: 25px; padding-right: 25px;">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="js-datepicker form-control" id="edit-tanggal-awal" onkeydown="return false" required data-today-highlight="true"
                                       value="{{date('m/d/Y')}}" name="tanggal_awal" placeholder="Masukkan Tanggal Awal"
                                       autocomplete="off">
                            </div>
                            <div class="col-12">
                                <label>Tanggal Akhir</label>
                                <input type="text" class="js-datepicker form-control" id="edit-tanggal-akhir" onkeydown="return false" required data-today-highlight="true"
