<table>
    ...
    <tr>
        <td></td>
        <td>@if($jabatan_1_toogle){{$jabatan_1}}@endif</td>
        <td></td>
        <td colspan="2">@if($jabatan_2_toogle){{$jabatan_2}}@endif</td>
        <td></td>
        <td>@if($jabatan_3_toogle){{$jabatan_3}}@endif</td>
    </tr>
    <tr>
        <td></td>
    </tr>
    ...
    <tr>
        <td></td>
        <td>@if($jabatan_1_toogle){{$jabatan_1_nama}}@endif</td>
        <td></td>
        <td colspan="2">@if($jabatan_2_toogle){{$jabatan_2_nama}}@endif</td>
        <td></td>
        <td>@if($jabatan_3_toogle){{$jabatan_3_nama}}@endif</td>
    </tr>
</table>