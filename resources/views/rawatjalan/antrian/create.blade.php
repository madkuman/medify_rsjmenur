...
@section('title')
Pendaftaran Pasien ke Poliklinik - Medify
@endsection
    ...
    <div class="container">
        <div class="block main-content transaction-index"  ng-controller="PasienController">
            <div class="block-content text-center">
                <h3 class="mb-5">Pendaftaran Pasien ke Poliklinik</h3>
...
<script id="template-pasienlist" type="x-tmpl-mustache">
    @{{#data}}
    <tr class="clickable-row" onclick='goToHref("{{url('rawatjalan/poliklinik/antrian/baru')}}/@{{id}}")'> 
        <td>@{{id}}</td>
        <td>
            <div class="pull-left">
