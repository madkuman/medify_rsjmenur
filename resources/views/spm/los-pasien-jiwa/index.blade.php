...
<script>
	...
	function loadData()
		...
		$('#loading-top').show();
    		...
    		$.ajax({
    			url: API_URL + '/spm/los-pasien-jiwa?year='+tahun,
    			type: 'GET',
    			dataType: 'json',
    			tryCount : 0,
    			retryLimit : 3,
    			...
    			success: function(data) {
    				chartData = data.data;
    				loadChart();
    				$('#chartKeterangan').html('Rata Rata total : '+data.total_rata_rata + 'hari dari data '+ data.total_bulan + ' bulan')
    			},
    			error:function(data){
    				this.tryCount++;
