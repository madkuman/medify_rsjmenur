...
@section('title')
Pasien Jiwa Readmisi dalam 1 bulan
@endsection
...
<script>
	...
	function loadData()
		...
		$('#loading-top').show();
    		...
    		$.ajax({
    			url: API_URL + '/spm/pasien-jiwa-readmisi?year='+tahun,
    			type: 'GET',
    			dataType: 'json',
    			tryCount : 0,
    			retryLimit : 3,
    			...
    			success: function(data) {
    				chartData = data.data;
    				loadChart();
    				$('#chartKeterangan').html('Rata Rata total : '+data.total_rata_rata + ' persen dari data '+ data.total_bulan + ' bulan')
    			},
    			error:function(data){
    				this.tryCount++;
	...
	function loadChart(){
		...
		valueAxis.title = "Lama Perawatan";
