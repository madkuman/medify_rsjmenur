			...
			<div class="col-9">
				<div class="block">
					<div class="block-header">
						...
						<a href="{{url('cssd/pengembalian/baru')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Pengembalian Baru</a>
					</div>
					<div class="block-content block-content-full">
	...
	function draw(){
		table = $('#transaksiTable').DataTable({
			...
			ajax: {
				...
				url: API_URL + '/cssd/pengembalian/index',
			},
			language: {
