					...
					<div class="col-6">
						...
						<form method="POST" action="{{url()->current()}}" id="formSubmit">
							...
							<div class="form-group">
								...
								<input type="text" required class="js-datepicker form-control" autocomplete="off" id="tanggal_ok" name="tanggal_ok" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy">
							</div>
