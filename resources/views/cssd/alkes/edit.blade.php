					...
					<div class="row">
						<div class="col">
							<div class="form-group">
								...
								<input class="form-control" name="nama" required="" value="{{$alkes->nama}}">
							</div>
							<div class="form-group">
								<label>Batas Penggunaan Efektif</label>
								<input class="form-control" name="batas_efektif" required="" value="{{$alkes->max_pemakaian}}">
							</div>
							<div class="form-group">
								<label>Keterangan</label>
								<textarea class="form-control" name="keterangan">{{$alkes->keterangan}}</textarea> 
							</div>
						</div>
						<div class="col">
							<div class="form-group">
								<label>Prosedur Sterilisasi</label>
								<textarea class="js-simplemde" id="simplemde" name="prosedur_sterilisasi">{{$alkes->prosedur_sterilisasi}}</textarea>
							</div>
						</div>
					</div>
