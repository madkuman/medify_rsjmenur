...
@section('title')
Admin - Input Jenis Pembayaran Baru
@endsection
	...
	<div class="block p-10">
		<div class="block-header">
			<h3 class="block-title">
				@if(empty($data))
				Input Jenis Pembayaran Baru
				@else
				Edit Nama Jenis Pembayaran
				@endif
			</h3>
		</div>
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Nama Pembayaran" name="nama" 
							@if(!empty($data))
							value="{{$data->nama}}"
