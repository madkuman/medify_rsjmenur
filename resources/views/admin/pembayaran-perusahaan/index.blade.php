...
@section('title')
Admin - Daftar Pembayaran Perusahaan
@endsection
    ...
    <div class="block p-10">
        <div class="block-header">
            <h3 class="block-title">
                <small><a href="{{url('admin/pembayaran-perusahaan/baru')}}" class="pull-right">
                <i class="fa fa-plus-circle"></i> Input Pembayaran Perusahaan Baru</a></small> 
                Daftar Pembayaran Perusahaan
            </h3>
        </div>
...
<script type="text/javascript">
    $('.js-dataTable-full').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{url('/admin/pembayaran-perusahaan/data')}}",
        columns: [
            {
                data: 'no',
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return `
                        <a href="{{url('/admin/pembayaran-perusahaan/edit/')}}/${row.id}" class="btn btn-sm btn-circle btn-outline-info mr-5 mb-5">
    ...
    $(document).on("click",".btn-outline-danger", function () {
        ...
        console.log(id,nama);
        $("#del-btn").attr('href','{{url('admin/pembayaran-perusahaan/delete')}}' + '/' + id)
        $("#show-name").html('Anda yakin ingin menghapus data pembayaran perusahaan ' + nama + '?')
