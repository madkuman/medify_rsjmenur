        ...
        <div class="modal-content ">
            <div class="modal-body">
                <form method="post" action="{{url()->current()}}/simpan">
                    {{ csrf_field() }}
                    <div name="modal-title" class="font-size-lg font-w600">Tambah/Edit Tarif Kategori INACBG</div>
                    ...
                    <div class="form-group row">
                        <label class="col-12">Slug</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" autocomplete="off" name="slug" id="slug-jenis-pemasukan" required>
                        </div>
                    </div>
