                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-9">
                                <label>Nama</label>
                                <input type="text" id="name" name="name" class="form-control" style="width: 100%;" placeholder="Deskripsi Dokter" required="">
                            </div>
                            <div class="col-12 col-md-3">
                                <label>Kode Dokter</label>
                                <input type="text" id="kode_dokter" name="kode_dokter" class="js-maxlength form-control" style="width: 100%;" placeholder="Maksimal 3 Digit" maxlength="3" required="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-12 col-md-6">
                                <label>Kuota Pasien Offline Harian</label>
                                <input type="number" name="kuota_offline" class="form-control kuota" placeholder="Batas Pasien Harian" required="">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <select class="js-select2 form-control" id="selectSpesialisBpjs" name="bpjs_spesialis" data-placeholder="Pilih Spesialisasi">
                                    <option value=""></option>
                                </select>
