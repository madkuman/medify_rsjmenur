	...
	<div class="block p-10">
		<div class="block-header">
			<h3 class="block-title">
				<small><a href="{{url('admin/identitas/baru')}}" class="pull-right">
				<i class="fa fa-plus-circle"></i> Input Jenis Identitas Baru</a></small> 
			...
			<table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
				...
				@foreach($data as $isi)
					<tr>
						...
						<td class="">
							<a href="{{url('/admin/identitas/edit/')}}/{{$isi->id}}" class="btn btn-sm btn-circle btn-outline-info mr-5 mb-5">
...
<script type="text/javascript">
    ...
    $(document).on("click",".btn-outline-danger", function () {
        ...
        console.log(id,nama);
        $("#del-btn").attr('href','{{url('admin/identitas/delete')}}' + '/' + id)
        $("#show-name").html('Anda yakin ingin menghapus data Identitas ' + nama + '?')
