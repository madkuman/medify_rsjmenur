...
@section('title')
Admin - Daftar SIRS Kegiatan Gigi Mulut
@endsection
	...
	<div class="block p-10">
		<div class="block-header">
			<h3 class="block-title">
				<small><a href="{{url('admin/sirs-kegiatan-gigi-mulut/baru')}}" class="pull-right">
				<i class="fa fa-plus-circle"></i> Input SIRS - Kegiatan Gigi Mulut Baru</a></small> 
				Daftar SIRS - Kegiatan Gigi Mulut
			</h3>
		</div>
			...
			<table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
				...
				@foreach($data as $isi)
					<tr>
						...
						<td class="">
							<a href="{{url('/admin/sirs-kegiatan-gigi-mulut/edit/')}}/{{$isi->id}}" class="btn btn-sm btn-circle btn-outline-info mr-5 mb-5">
...
<script type="text/javascript">
    ...
    $(document).on("click",".btn-outline-danger", function () {
        ...
        console.log(id,nama);
        $("#del-btn").attr('href','{{url('admin/sirs-kegiatan-gigi-mulut/delete')}}' + '/' + id)
