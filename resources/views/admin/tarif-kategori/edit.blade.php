                ...
                <div class="row justify-content-start">
                    <div class="col-8 align-self-start">
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" id="nama" name="nama" class="form-control" style="width: 100%;" placeholder="Deskripsi Tarif Kategori" required="" value="{{$kategori->nama}}">
                        </div>
                        <div class="form-group">
                            <label>Parent</label>
                            <select class="js-select2 form-control" name="parent_id">
                                ...
                                <option value="{{$item->id}}" @if($kategori->parent_id == $item->id) selected @endif >{{$item->nama}}</option>  
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" name="slug">
                                ...
                                <option value="{{$item->slug}}" @if($item->slug == $kategori->slug) selected @endif>{{$item->nama}}</option>  
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" name="jenis_kegiatan_radiologi">
                                <option value="">Tanpa Jenis</option>  
                                @foreach($all_jenis_kegiatan_radiologi as $item)
                                <option value="{{$item->id}}" @if($item->id == $kategori->jenis_kegiatan_radiologi) selected @endif>{{$item->nomor}}) {{$item->nama}}</option>  
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" name="jenis_kegiatan_lab">
                                <option value="">Tanpa Jenis</option>  
                                @foreach($all_jenis_kegiatan_lab as $item)
                                <option value="{{$item->id}}" @if($item->id == $kategori->jenis_kegiatan_lab) selected @endif>{{$item->nomor}}) {{$item->nama}}</option>  
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" name="jenis_kegiatan_perinatologi">
                                <option value="">Tanpa Jenis</option>  
                                @foreach($all_jenis_kegiatan_perinatologi as $item)
                                <option value="{{$item->id}}" @if($item->id == $kategori->jenis_kegiatan_perinatologi) selected @endif>{{$item->nomor}}) {{$item->nama}}</option>  
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" name="jenis_kegiatan_gigi_mulut">
                                <option value="">Tanpa Jenis</option>  
                                @foreach($all_jenis_kegiatan_gigi_mulut as $item)
                                <option value="{{$item->id}}" @if($item->id == $kategori->jenis_kegiatan_gigi_mulut) selected @endif>{{$item->nomor}}) {{$item->nama}}</option>  
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" name="jenis_kegiatan_rehab_medik">
                                <option value="">Tanpa Jenis</option>  
                                @foreach($all_jenis_kegiatan_rehab_medik as $item)
                                <option value="{{$item->id}}" @if($item->id == $kategori->jenis_kegiatan_rehab_medik) selected @endif>{{$item->nomor}}) {{$item->nama}}</option>  
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" name="jenis_kegiatan_pelayanan_khusus">
                                <option value="">Tanpa Jenis</option>  
                                @foreach($all_jenis_kegiatan_pelayanan_khusus as $item)
                                <option value="{{$item->id}}" @if($item->id == $kategori->jenis_kegiatan_pelayanan_khusus) selected @endif>{{$item->nomor}}) {{$item->nama}}</option>  
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" name="jenis_kegiatan_kesehatan_jiwa">
                                <option value="">Tanpa Jenis</option>  
                                @foreach($all_jenis_kegiatan_kesehatan_jiwa as $item)
                                <option value="{{$item->id}}" @if($item->id == $kategori->jenis_kegiatan_kesehatan_jiwa) selected @endif>{{$item->nomor}}) {{$item->nama}}</option>  
                                @endforeach
                            </select>
