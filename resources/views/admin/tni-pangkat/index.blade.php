    ...
    <div class="block p-10">
        <div class="block-header">
            <h3 class="block-title">
                <small><a href="{{url('admin/tni-pangkat/baru')}}" class="pull-right">
                <i class="fa fa-plus-circle"></i> Input Pangkat TNI Baru</a></small> 
                Daftar Pangkat TNI
            </h3>
        </div>
...
<script type="text/javascript">
    $('.js-dataTable-full').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{url('/admin/tni-pangkat/data')}}",
        columns: [
            {
                data: 'no',
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return `
                        <a href="{{url('/admin/tni-pangkat/edit/')}}/${row.id}" class="btn btn-sm btn-circle btn-outline-info mr-5 mb-5">
    ...
    $(document).on("click",".btn-outline-danger", function () {
        ...
        console.log(id,nama);
        $("#del-btn").attr('href','{{url('admin/tni-pangkat/delete')}}' + '/' + id)
        $("#show-name").html('Anda yakin ingin menghapus data pangkat TNI ' + nama + '?')
