	...
	<div class="block p-10">
		<div class="block-header">
			<h3 class="block-title">
				<small><a href="{{url('admin/pernikahan/baru')}}" class="pull-right">
				<i class="fa fa-plus-circle"></i> Input Jenis Pernikahan Baru</a></small> 
				Daftar Jenis Pernikahan
			</h3>
		</div>
			...
			<table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
				...
				@foreach($data as $isi)
					<tr>
						...
						<td class="">
							<a href="{{url('/admin/pernikahan/edit/')}}/{{$isi->id}}" class="btn btn-sm btn-circle btn-outline-info mr-5 mb-5">
...
<script type="text/javascript">
    ...
    $(document).on("click",".btn-outline-danger", function () {
        ...
        console.log(id,nama);
        $("#del-btn").attr('href','{{url('admin/pernikahan/delete')}}' + '/' + id)
        $("#show-name").html('Anda yakin ingin menghapus data pernikahan ' + nama + '?')
