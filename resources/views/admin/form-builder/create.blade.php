                                   ...
                                   <div class="row">
                                        <div class="col-6">
                                             ...
                                             <div class="form-group mb-5">
                                                  ...
                                                  <input type="checkbox" value="1" class="css-control-input" name="force_db">
                                                  <span class="css-control-indicator"></span> Drop DB if exist
                                           </label>
                                       </div>
                                        </div>

                                        <div class="form-group">
                                             <label>Path Folder Model </label>
                                             <input type="text" name="folder_model" class="form-control form-control-lg" id="folder_model">
                                        </div>

                                        <div class="form-group">
                                             <label>Path Folder View </label>
                                             <input type="text" name="folder_view" class="form-control form-control-lg" id="folder_view">
                                        </div>
                                        
                                        <div class="form-group">
                                             <label>Path Folder Controller</label>
                                             <input type="text" name="folder_controller" class="form-control form-control-lg" id="folder_controller">
                                        </div>

                                        <div class="form-group">
                                             <label>Base Route </label>
                                             <input type="text" name="base_route" class="form-control form-control-lg" id="base_route">
                                        </div>

                                        <div class="form-group">
                                             <label>Route File </label>
                                             <input type="text" name="route_file" class="form-control form-control-lg" id="route_file">
                                        </div>
                                   </div>
                              </div>
                         </div>
...
<script type="text/javascript">
     ...
     $('.buttonSubmit').click(function(){
          ...
          updateInputOrder()
          updateDataSelectSkor()
          dataform.connection = $('#connection').val();
          dataform.folder_model = $('#folder_model').val();
          dataform.folder_view = $('#folder_view').val();
          dataform.folder_controller = $('#folder_controller').val();
          dataform.base_route = $('#base_route').val();
          dataform.route_file = $('#route_file').val();
          dataform.drop_if_exist = $('#drop_if_exist').is(':checked');
          $.ajax({
               type: "POST",
               url: "{{url()->current()}}",
               dataType: "json",
...
<script>
     ...
     var data_template = {
          'asesmen': {
               'connection':'kasus',
               'folder_model': 'Kasus',
               'folder_view': 'kasus/alatbantu',
               'base_route': 'alat-bantu',
               'folder_controller': 'Kasus/AlatBantu',
               'route_file': 'kasus-alatbantu',
          }
     }

     $('#template').on('change', function(){
          var template = data_template[$(this).val()];
          
          $('#connection').val(template['connection']);
          $('#folder_model').val(template['folder_model']);
          $('#folder_view').val(template['folder_view']);
          $('#folder_controller').val(template['folder_controller']);
          $('#base_route').val(template['base_route']);
          $('#route_file').val(template['route_file']);
     });

     $("#how-to").on('click', function(){
          if($('#how-to-target').is(':visible'))
               $('#how-to-target').hide();
          else
               $('#how-to-target').show();
     });
