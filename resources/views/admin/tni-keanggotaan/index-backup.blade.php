    ...
    <div class="block p-10">
        <div class="block-header">
            <h3 class="block-title">
                ...
                <i class="fa fa-plus-circle"></i> Input Keanggotaan TNI Baru</a></small> 
                Daftar Keanggotaan TNI
            </h3>
        </div>
...
<script type="text/javascript">
    $('.js-dataTable-full').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{url('/admin/tni-keanggotaan/data')}}",
        columns: [
            {
                data: 'no',
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return `
                        <a href="{{url('/admin/tni-keanggotaan/edit/')}}/${row.id}" class="btn btn-sm btn-circle btn-outline-info mr-5 mb-5">
