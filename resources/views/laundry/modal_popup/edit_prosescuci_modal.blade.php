                ...
                <div class="table-full-width">
                    <div class="block-content">
                            <table class="table table-vcenter table-stripped">
                                ...
                                <tbody>
                                    <form id="modalEditProsesCuci">
                                        @foreach ($permintaan as $pa)
                                        <tr>
                                            <td>{{$pa->nomor}}</td>
                                            <td>{{$pa->nama_barang}}</td>
                                            <td>{{$pa->diterima}}</td>
                                            <td>{{$pa->keterangan_terima}}</td>
                            ...
                            <div class="block-content">
                                <div class="col-md-12 text-right">
                                        ...
                                        <button class="btn btn-primary ml-2" style="padding:0px 40px;" type="button" id="buttonEditProsesCuciModal">Simpan</button>
                                        <button class="btn btn-alt-primary ml-2" style="display: none; padding:0px 40px;" type="button"  id="buttonEditProsesCuciLoading">
