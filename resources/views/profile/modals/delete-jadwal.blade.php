<div class="modal fade" id="delete-jadwal{{$jadwal->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-popout" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="block block-transparent mb-0">
                <div class="block-content" style="background-color: #fafafa">
                    <form class="js-validation-be-contact" action="{{route('delete.jadwal')}}" method="POST">
                        {{ csrf_field() }}
