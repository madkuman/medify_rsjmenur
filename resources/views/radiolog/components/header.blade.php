                ...
                <div class="content-header px-0" >
                    ...
                    <div class="content-header-section">
                        ...
                        <ul class="nav-main-header">
                            <li>
                                <a @if($header == "transaksi") class="active" @endif href="{{url('radiologi')}}">
                                    <i class="si si-home d-none d-xl-inline-block"></i> Transaksi
                                </a>
                            </li>
                            <li>
                                <a @if($header == "verifikasi") class="active" @endif href="{{url('radiologi/transaksi/verifikasi')}}">
                                    <i class="si si-eye d-none d-xl-inline-block"></i> Verifikasi Transaksi
                                </a>
                            </li>
                            <li>
                                <a  @if($header == "histori") class="active" @endif href="{{url('radiologi/histori')}}">
                                    <i class="si si-flag d-none d-xl-inline-block"></i> Histori Transaksi
                                </a>
                            </li>
                            <li>
                                <a @if($header == "laporan") class="active" @endif href="{{url('radiologi/laporan')}}">
                                    <i class="fa fa-bar-chart"></i> Laporan Statistik
                                </a>
                            </li>
                            <li>
                                <a @if($header == "pengaturan") class="active" @endif href="{{url('radiologi/pengaturan')}}">
