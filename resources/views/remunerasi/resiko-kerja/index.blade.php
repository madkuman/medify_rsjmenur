    ...
    <div class="col-md-12">
        <div class="block block-rounded">
            <div class="block-header py-20">
                <span><h4 class="mb-0">Resiko Kerja Pegawai</h4><hr>
                <h5></h5></span>
                ...
                <div class="block-options">
                    <button type="button" class="btn btn-sm btn-primary btn-hero" id="btn-modal-create">
                        <i class="fa fa-plus"></i> Resiko Kerja Pegawai Baru
                    </button>
                </div>
            </div>
...
@include('remunerasi.resiko-kerja.components.js-create')
@include('remunerasi.resiko-kerja.components.js-index')
@include('remunerasi.resiko-kerja.components.modal-create')
@include('remunerasi.resiko-kerja.components.modal-update')
