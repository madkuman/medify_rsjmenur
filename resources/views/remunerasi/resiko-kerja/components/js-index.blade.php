...
<script type="text/javascript">
    ...
    function dataTable(tgl){
        $('#example').dataTable( {
            ...
            "ajax": {
                "url": BASE_URL+"remunerasi/api/data-resiko-kerja",
                "dataType": "json",
                "type": "POST",
                "data": {
                    "_token": "{{ csrf_token() }}",
