	...
	<div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" >
			<div class="block block-themed block-transparent mb-0">
                ...
                <form id="form-cetak" method="get" action="{{url()->current()}}/pegawai" target="_blank" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-info btn-simple btn-submit-print" type="submit" id="buttonSubmitPrint"><i class="fa fa-check"></i> Cetak</button>
                        <button class="btn btn-alt-primary btn-simple" style="display: none" type="button"  id="buttonLoadingDana">
