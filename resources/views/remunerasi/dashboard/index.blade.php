    ...
    <div class="bg-primary-dark-op">
        <div class="content content-top text-center overflow-hidden pt-50">
            <div class="pt-0 pb-20">
                ...
                <h2 class="h4 font-w400 text-white-op invisible" data-toggle="appear" data-class="animated fadeInUp">Selamat datang di Remunerasi</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-6 col-xl-6">
            <a class="block block-link-pop text-right bg-primary" href="javascript:void(0)">
                <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                    ...
                    <div class="font-size-h4 font-w600 text-white"> {{$pegawai}}</span></div>
                    <div class="font-size-sm font-w600 text-uppercase text-white-op">Jumlah Pegawai</div>
                </div>
            </a>
        </div>
        <div class="col-6 col-xl-6">
            <a class="block block-link-pop text-right bg-earth" href="javascript:void(0)">
                <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                    ...
                    <div class="font-size-h4 font-w600 text-white"> {{$pajak}} %</span></div>
                    <div class="font-size-sm font-w600 text-uppercase text-white-op">Pajak berlaku saat ini</div>
                </div>
            </a>
        </div>
        {{-- <div class="col-6 col-xl-3">
            <a class="block block-link-pop text-right bg-elegance" href="javascript:void(0)">
                <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                    ...
                    <div class="font-size-h4 font-w600 text-white">Rp </span></div>
