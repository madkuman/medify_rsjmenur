    ...
    <div class="block">
        <div class="block-header bordered">
            ...
            <div class="block-options">
                ...
                <a href="{{ url('farmasi/' . session('farmasi')->slug . '/gudang/pengadaan/' . $pengadaan->slug . '/print') }}"
                    class="btn btn-alt-warning btn-square" target="_blank">
        ...
        <div class="block-content">
            <div class="block block-transparent">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{-- url('gudang/supplier/'.$pengadaan->supplier_detail->slug) --}}">
                    ...
                    <div class="col">
                        ...
                        <h5>{{ $pengadaan->tanggal_faktur ? date('d F Y', strtotime($pengadaan->tanggal_faktur)) : '-' }}
                        </h5>
                        <label>TANGGAL SURAT JALAN</label>
                        <h5>{{ $pengadaan->tanggal_surat_jalan ? date('d F Y', strtotime($pengadaan->tanggal_surat_jalan)) : '-' }}
                        </h5>
                        @if ($pengadaan->bukti_nota)
                            <label>BUKTI NOTA</label>
                            <h5>
                                <a href="{{ asset($pengadaan->bukti_nota) }}" class="link-effect" target="_blank">Lihat
                                    Bukti Nota</a>
                            </h5>
                        @endif
                    </div>
            ...
            <div class="mt-50">
                ...
                <h5 class="text-primary">{{ $pengadaan->created_by_detail->name }} -
                    {{ date('d F Y, H:i', strtotime($pengadaan->created_at)) }}</h5>
            </div>
        </div>
    </div>
    ...
    <div class="modal" id="modal-large" role="dialog" aria-labelledby="modal-large" aria-hidden="true">
        <div class="modal-dialog modal-full" role="document">
            <form method="POST" enctype="multipart/form-data"
                action="{{ url('farmasi/' . session('farmasi')->slug . '/gudang/pengadaan') }}/edit" id="form-pengadaan">
                {{ csrf_field() }}
                <input type="hidden" name="id" value="{{ $pengadaan->id }}">
                    ...
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select class="js-select2 form-control" id="peyedia-select2" name="peyedia"
                                                style="width: 100%;" data-placeholder="Pilih Penyedia">
                                                <option></option>
                                                @foreach ($supplier as $supp)
                                                    <option value="{{ $supp->id }}"
                                                        @if ($supp->id == $pengadaan->supplier_id) selected @endif>
                                                        {{ $supp->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="penyedia" name="nomor_referensi"
                                            value="{{ $pengadaan->nomor_referensi }}" placeholder="Isi Nomor Faktur">
                                    </div>
                                    <div class="form-group">
                                        <label for="penyedia">Nomor Surat Jalan</label>
                                        <input type="text" class="form-control" id="penyedia" name="nomor_surat"
                                            value="{{ $pengadaan->nomor_surat_jalan }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="js-datepicker form-control tanggal-datepicker"
                                                name="tanggal_transaksi" placeholder="Masukkan Tanggal Penerimaan"
                                                value="{{ $pengadaan->tanggal ? date('d/m/Y', strtotime($pengadaan->tanggal)) : '' }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="js-datepicker form-control tanggal-datepicker"
                                                name="tanggal_faktur" placeholder="Masukkan Tanggal Faktur"
                                                value="{{ $pengadaan->tanggal_faktur ? date('d/m/Y', strtotime($pengadaan->tanggal_faktur)) : '' }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="js-datepicker form-control tanggal-datepicker"
                                                name="tanggal_surat_jalan" placeholder="Masukkan Tanggal Surat Jalan"
                                                value="{{ $pengadaan->tanggal_surat_jalan ? date('d/m/Y', strtotime($pengadaan->tanggal_surat_jalan)) : '' }}">
                                        </div>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="keterangan"
                                            value="{{ $pengadaan->keterangan }}" placeholder="Berikan Informasi Lebih">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="newItem">
                                ...
                                @foreach ($pengadaan->log as $row)
                                    ...
                                    <div class="row item-wrapper gutters-tiny">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <h1 id="harga-hid-{{ $j }}" hidden class="counter">
                                                    {{ $j }}</h1>
                                                <div>
                                                    <select class="form-control" id="-barang-select2-{{ $j }}"
                                                        name="barang[]" style="width: 100%;" readonly="">
                                                        <option value="{{ $row->detail_item->item_template_id }}"
                                                            selected>{{ $row->detail_item->detail_item->nama }}
                                                            ({{ $row->detail_item->detail_item->satuan }})</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        id="jumlah-{{ $j }}"
                                                        onchange="changeSubtotal({{ $j }})" name="jumlah[]"
                                                        placeholder="Jumlah" value="{{ $row->jumlah }}"
                                                        @if (isset($po_selected)) data-max="{{ $po_selected->detail[$j - 1]->jumlah - $po_selected->detail[$j - 1]->jumlah_processed + $row->jumlah }}" @endif>
                                                    @if (isset($po_selected))
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                Max:
                                                                {{ $po_selected->detail[$j - 1]->jumlah - $po_selected->detail[$j - 1]->jumlah_processed + $row->jumlah }}</span>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div>
                                                    <input type="number" class="form-control"
                                                        id="diskon-{{ $j }}"
                                                        onchange="changeSubtotal({{ $j }})" name="diskon[]"
                                                        placeholder="Diskon" value="{{ $row->diskon }}" step=".001"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1 d-none">
                                            <div class="form-group">
                                                <div>
                                                    <input type="number" class="form-control"
                                                        id="ppn-{{ $j }}"
                                                        onchange="changeSubtotal({{ $j }})" name="ppn[]"
                                                        placeholder="PPN" value="{{ $row->ppn }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="text" class="form-control money"
                                                    id="subtotal-{{ $j }}"
                                                    onchange="changeSubtotal({{ $j }})" name="subtotal[]"
                                                    placeholder="Subtotal" value="{{ $row->subtotal }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="harga_satuan[]"
                                                    id="harga-{{ $j }}"
                                                    onchange="changeSubtotal({{ $j }})"
                                                    placeholder="Harga Satuan" readonly
                                                    value="{{ $row->harga_saat_itu }}">
                                                <p id="harga-lama-{{ $j }}"></p>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div>
                                                    <input type="text" class="js-datepicker form-control datepicker"
                                                        name="expired[]" placeholder="Tanggal Expired" autocomplete="off"
                                                        value="{{ !is_null($row->detail_item->kadaluarsa) ? date('d/m/Y', strtotime($row->detail_item->kadaluarsa)) : '' }}">
                                            ...
                                            <div class="form-group">
                                                <div>
                                                    <input type="text" class="form-control" name="batch[]"
                                                        placeholder="Batch" value="{{ $row->batch }}"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="mt-3 mb-3 pb-2" id="loader" style="display: none;">
                                <center>
                                    <button type="button" class="btn btn-lg btn-circle btn-outline-primary"
                                        id="btnAddItems">
                                        <i class="fa fa-plus"></i>
                                    </button>
                                    <center class="d-none" id="spinner"><i
                                            class="fa fa-2x fa-asterisk fa-spin text-info"></i></center>
                                </center>
                            </div>
                        </div>
                    </div>
        ...
        $('#btnAddItems').on('click', function() {
            ...
            str = `<div class="row item-wrapper item-row gutters-tiny">
                ...
                <div class="col-md-1">
                    <div class="form-group">
                        <div>
                            <input type="number" class="form-control" id="jumlah-` + counter +
                `" onchange="changeSubtotal(` + counter + `)" name="jumlah[]" placeholder="Jumlah">
                        </div>
                    </div>
                </div>
                <div class="col-md-1">
                    <div class="form-group">
                        <div>
                            <input type="number" class="form-control" id="diskon-` + counter +
                `" onchange="changeSubtotal(` + counter + `)" name="diskon[]" placeholder="Diskon" value="0" step=".001" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-md-1 d-none">
                    <div class="form-group">
                        <div>
                            <input type="number" class="form-control" id="ppn-` + counter +
                `" onchange="changeSubtotal(` + counter + `)" name="ppn[]" placeholder="PPN" value="10">
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" class="form-control money" id="subtotal-` + counter +
                `" name="subtotal[]" onchange="changeSubtotal(` + counter + `)" placeholder="Subtotal" readonly>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
        ...
        function readImage(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    var boxZone = $(input).parent().find('.preview-zone').find('.box').find('.box-body').find(
                        '.preview-img');
                        ...
                        var str_po = `<div class="row item-wrapper gutters-tiny item-row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="jumlah-` + counter +
                            `" onchange="changeSubtotal(` + counter + `)" name="jumlah[]" placeholder="Jumlah" value="${jumlah}" data-max="${detail.jumlah-processed}">
                                        <div class="input-group-append">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="number" class="form-control" id="diskon-` + counter +
                            `" onchange="changeSubtotal(` + counter + `)" name="diskon[]" placeholder="Diskon" value="${detail.diskon}" step=".001" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1 d-none">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="number" class="form-control" id="ppn-` + counter +
                            `" onchange="changeSubtotal(` + counter + `)" name="ppn[]" placeholder="PPN" value="0">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control money" id="subtotal-` + counter +
                            `" onchange="changeSubtotal(` + counter + `)" name="subtotal[]" placeholder="Subtotal" value="${detail.subtotal}" readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ${counter == 1 ? '<label>Harga Satuan</label>' : ''}
                                    <input type="text" class="form-control" name="harga_satuan[]" id="harga-` +
                            counter + `" onchange="changeSubtotal(` + counter + `)" placeholder="Harga Satuan" readonly value="${detail.harga}">
                                    <p id="harga-lama-` + counter + `"></p>
                                </div>
                            </div>
                            <div class="col-md-2">
