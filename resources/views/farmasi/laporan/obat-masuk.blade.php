...
<html>
<head>
	<title>Laporan Distribusi Obat Masuk</title>
	<style type="text/css">
	body{
...
<body>
	<table>
		<tr>
			<td class="centered big">Laporan Distribusi Obat Masuk</td>
		</tr>
		<tr>
	...
	<table class="bordered">
		<thead>
			<tr>
				...
				<th class="centered" width="14%">Asal</th>
		...
		<tbody>
			...
			<tr>
				...
				<td>{{$item->template_nama}}</td>
				@if($item->jenis_type == "LogPengadaan")
				<td>Retur Pelayanan</td>
