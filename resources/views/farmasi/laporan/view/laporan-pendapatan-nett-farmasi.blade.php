...
@section('page-title')
Laporan Pendapatan Farmasi (Nett)
@endsection
...
<div class="block">
    <div class="block-content">
        <div class="alert alert-primary">Mengambil data transaksi yang telah di konfirmasi. Menghitung subtotal - hpp</div>
        <h6>FILTER</h6>
        <div class="row">
            <div class="col-2">
...
<script type="text/javascript">
    ...
    function downloadExcel() {
        ...
        $.ajax({
            url: "{{url()->current()}}/download-excel",
            dataType: 'json',
            tryCount: 0,
            retryLimit: 3,
            data: {
