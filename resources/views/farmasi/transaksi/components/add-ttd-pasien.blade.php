<div class="row">
    ...
    <div class="col-md-4">
        ...
        <button class="btn btn-sm btn-primary mr-5 mb-5 pull-right ttdBtn" data-id="{{$transaksi->id}}" data-toggle="modal" title="Tanda Tangani Transaksi Ini" data-target="#addTTDPasien">Input TTD Pasien/Keluarga
        </button>
        @endif
    </div>
</div>
				...
				<div class="block-content row">
					...
					<form class="col-md-12" onsubmit="return ajaxSubmit();" autocomplete="on" target="the_iframe">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama-pasien" name="nama_pasien" value="{{$transaksi->pasien_detail->name ?? ''}}">
                        </div>
