...
@section('content')
    <div class="block">
        <div class="block-header bordered">
            <h3 class="block-title">Copy Transaksi #{{$transaksi->slug}}</h3>
        </div>
        <div class="block-content">
            ...
            <hr class="my-5 mb-20">
            <form method="POST" action="{{url('farmasi/'.session('farmasi')->slug.'/transaksi')}}/copy">
                {{csrf_field()}}
                ...
                <div class="row" id="resepForm">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 px-1">
                                    ...
                                    <input type="number" class="form-control" id="jumlahSisa" placeholder="Jumlah Sisa" readonly="">
                                    <p class="text-warning"></p>
                                </div>
                                <div class="col-md-6 px-1">
                                    <label>Jumlah Diambil</label>
                                    <input type="number" class="form-control" id="jumlahDiambil" placeholder="Jumlah Diambil">
                                    <p class="text-warning"></p>
                                </div>
                            </div>
                            @else
                            <div class="form-group row">
                                <div class="col-md-4 px-1">
                                    ...
                                    <input type="number" class="form-control" id="jumlahObat" placeholder="Jumlah Obat" readonly="">
                                    <p class="text-warning"></p>
                                </div>
                                <div class="col-md-4 px-1">
                                    <label>Jumlah Sisa</label>
                            ...
                            <div class="form-group row">
                                <label>Jumlah Yang Telah Diberikan</label>
                                <input type="text" class="form-control" id="ketObat" placeholder="Jumlah Obat Yang Telah Diberikan">
                                <p class="text-warning"></p>
                            </div>
                            @endif
                            <div class="form-group row">
                            ...
                            <div class="text-center pb-10 d-none" id="tambahResepBtn">
                    ...
                    <div class="col-md-6">
                        <div class="row" id="resep-wrapper">
                            @foreach($transaksi->final_detail->resep_detail as $index => $detail)
@php
    $detail_asal = $detail->detail_asal ?? $detail;
    $jumlah_awal = $detail_asal->jumlah ?? $detail->jumlah;
    $jumlah_sisa = $detail_asal->jumlah_sisa  ?? $jumlah_awal;
@endphp
                                    ...
                                    <a class="block block-link-shadow" href="javascript:void(0)">
                                        <div class="block-content block-content-full clearfix">
                                            ...
                                            <div class="float-left mt-10">
                                                ...
                                                @php
                                                    $input = array(
                                                        'detail_asal_id' => $detail_asal->id,
                                                        'jenis' => 'racikan',
                                                        'satuan' => $detail->satuan,
                                                        'racikan' => $detail->nama_obat,
                                                        'obat' => $obat_racikan,
                                                        'jumlah_awal' => $detail_asal->jumlah_awal ?? $detail->jumlah,
                                                        'jumlah_sisa' => $detail_asal->jumlah ?? $detail->jumlah ?? 0,
                                                ...
                                                <div class="font-size-sm text-muted">
                                                    ...
                                                    - Jumlah Diambil: {{$detail->jumlah}}
                                                </div>
                                                <div class="font-size-sm text-muted">
                                                     Aturan : {{$detail->aturan}} {{$detail->satuan_penggunaan}}
                                                </div>
                                                <div class="font-w600 mt-5 d-none">Harga : Rp {{number_format($detail->subtotal)}}</div>
...
@include('farmasi.transaksi.copy-resep.js')
