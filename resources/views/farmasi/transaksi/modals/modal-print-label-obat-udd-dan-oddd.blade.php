<div class="modal" id="modal-print-label-obat-udd-oddd" role="dialog" aria-labelledby="modal-normal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form id="form-cetak-label-rawat-inap" method="GET"
            action="{{ url('farmasi/' . session('farmasi')->slug . '/label-obat/print-udd-oddd-rawat-inap/' . $transaksi->slug) }}"
            target="_blank">
            <!-- FORM NYA GK KE PAKAI -->
            <input id="id-label-udd-oddd" type="hidden" name="id" value="{{ $transaksi->id }}">
            <input id="farmasi-slug-label-udd-oddd" type="hidden" name="farmasi"
                value="{{ session('farmasi')->slug }}">
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">
                                            @if (!empty($transaksi->final_detail->resep_detail))
                                                {{ count($transaksi->final_detail->resep_detail) }}
                                            @else
                                                -
                                            @endif
                                        </td>
                                    ...
                                    <thead>
                                        <tr class="border-table">
                                            ...
                                            <th style="border: 1px solid black; border-collapse: collapse;"
                                                colspan="10">ATURAN PAKAI</th>
                                        </tr>
                                        <tr class="border-table">
                                            <th style="border: 1px solid black; border-collapse: collapse;"></th>
                                            <th style="border: 1px solid black; border-collapse: collapse;">Resep</th>
                                            <th style="border: 1px solid black; border-collapse: collapse;">1
                                                <br>(07.00)
                                            </th>
                                            <th style="border: 1px solid black; border-collapse: collapse;"></th>
                                            <th style="border: 1px solid black; border-collapse: collapse;">2
                                                <br>(13.00)
                                            </th>
                                            <th style="border: 1px solid black; border-collapse: collapse;"></th>
                                            <th style="border: 1px solid black; border-collapse: collapse;">3
                                                <br>(19.00)
                                            </th>
                                            <th style="border: 1px solid black; border-collapse: collapse;"></th>
                                            <th style="border: 1px solid black; border-collapse: collapse;">4
                                                <br>(24.00)
                                            </th>
                                            <th style="border: 1px solid black; border-collapse: collapse;"></th>
                                            <th style="border: 1px solid black; border-collapse: collapse;">5
                                                <br>(22.00)
                                            </th>
                                            <th style="border: 1px solid black; border-collapse: collapse;"></th>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="border: 1px solid black; border-collapse: collapse;">
                                                <div class="form-check">
                                                    <input id="aturan-per-jam-1" class="form-check-input"
                                            ...
                                            <td style="border: 1px solid black; border-collapse: collapse;">
                                                <div class="form-check">
                                                    <input id="aturan-per-jam-2" class="form-check-input"
                                                        type="checkbox" value="" hidden>
                                                    <label class="form-check-label"></label>
                                                </div>
                                            </td>
                                            ...
                                            <td style="border: 1px solid black; border-collapse: collapse;">
                                                <div class="form-check">
                                                    <input id="aturan-per-jam-3" class="form-check-input"
                                                        type="checkbox" value="" hidden>
                                                    <label class="form-check-label"></label>
                                                </div>
                                            </td>
                                            ...
                                            <td style="border: 1px solid black; border-collapse: collapse;">
                                                <div class="form-check">
                                                    <input id="aturan-per-jam-4" class="form-check-input"
                                                        type="checkbox" value="" hidden>
                                                    <label class="form-check-label"></label>
                                                </div>
                                            </td>
                                            ...
                                            <td style="border: 1px solid black; border-collapse: collapse;">
                                                <div class="form-check">
                                                    <input id="aturan-per-jam-5" class="form-check-input"
                                                        type="checkbox" value="" hidden>
                                                    <label class="form-check-label"></label>
                                                </div>
                                            </td>
                                    ...
                                    <tbody>
                                        @foreach ($transaksi->final_detail->resep_detail as $i => $detail)
                                            <tr class="tr-resep-detail">
                                                ...
                                                @endphp
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    @if (!empty($detail->aturan_per_jam_1))
                                                        07.00 @php $visible = true; @endphp
                                                    @else
                                                        @php $visible = false; @endphp
                                                    @endif
                                                </td>
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    <div class="form-check"
                                                        style="@if ($visible == false) display: none; @endif">
                                                        ...
                                                        @if ($visible)
                                                            <input class="form-check-input aturan-per-jam-1"
                                                                data-obat-resep-detail-id="{{ $detail->id }}"
                                                                type="checkbox" value="07.00">
                                                        @endif
                                                        <label class="form-check-label"></label>
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    @if (!empty($detail->aturan_per_jam_2))
                                                        13.00 @php $visible = true; @endphp
                                                    @else
                                                        @php $visible = false; @endphp
                                                    @endif
                                                </td>
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    <div class="form-check"
                                                        ...
                                                        @if ($visible)
                                                            <input class="form-check-input aturan-per-jam-2"
                                                                data-obat-resep-detail-id="{{ $detail->id }}"
                                                ...
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    @if (!empty($detail->aturan_per_jam_3))
                                                        19.00 @php $visible = true; @endphp
                                                    @else
                                                        @php $visible = false; @endphp
                                                    @endif
                                                </td>
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    <div class="form-check"
                                                        ...
                                                        @if ($visible)
                                                            <input class="form-check-input aturan-per-jam-3"
                                                                data-obat-resep-detail-id="{{ $detail->id }}"
                                                ...
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    @if (!empty($detail->aturan_per_jam_4))
                                                        24.00 @php $visible = true; @endphp
                                                    @else
                                                        @php $visible = false; @endphp
                                                    @endif
                                                </td>
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    <div class="form-check"
                                                        ...
                                                        @if ($visible)
                                                            <input class="form-check-input aturan-per-jam-4"
                                                                data-obat-resep-detail-id="{{ $detail->id }}"
                                                                type="checkbox" value="24.00">
                                                        @endif
                                                        <label class="form-check-label"></label>
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    @if (!empty($detail->aturan_per_jam_5))
                                                        22.00 @php $visible = true; @endphp
                                                    @else
                                                        @php $visible = false; @endphp
                                                    @endif
                                                </td>
                                                <td style="border: 1px solid black; border-collapse: collapse;">
                                                    <div class="form-check"
                                                        ...
                                                        @if ($visible)
                                                            <input class="form-check-input aturan-per-jam-5"
                                                                data-obat-resep-detail-id="{{ $detail->id }}"
                                                                type="checkbox" value="22.00">
                                                        @endif
                                                        <label class="form-check-label"></label>
                                                    </div>
                                                </td>
