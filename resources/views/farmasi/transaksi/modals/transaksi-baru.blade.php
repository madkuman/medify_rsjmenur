    <div class="modal" id="modal-large" role="dialog" aria-labelledby="modal-large" aria-hidden="true">
        <div class="modal-dialog modal-full" role="document">
            <form action="{{url('farmasi/'.session('farmasi')->slug.'/transaksi/new')}}" method="POST" id="form-transaksi">
                {{csrf_field()}}
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="js-datepicker form-control datepicker" name="tanggal_transaksi" placeholder="Pilih Tanggal" id="tanggal_transaksi" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{date('d-m-Y', time())}}" data-date-format="dd-mm-yyyy" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Nomor Resep <small>(tidak wajib diisi)</small></label>
                                        <input type="text" class="form-control" id="nomor-resep" name="no_resep" placeholder="Nomor Resep">
                                    </div>
                                </div>
                            </div>
                            <hr class="my-5">
                            <div class="row">
                                <div class="col-8 pt-10">
                                    ...
                                    <div class="form-group mt-10 pasien-div" id="nama-pasien-input">
                                        ...
                                        <input type="text" class="form-control" id="text-pasien" name="nama_pasien" placeholder="Nama Pasien">
                                        <div id="pasien-rsal-select2">
                                            <select class="js-select2 form-control pasien-select2" id="pasien-form" name="pasien" style="width: 100%;" data-placeholder="Cari Pasien">
                                                <option></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="pasien-div">
                                        <div class="form-group">
                                            ...
                                            <select class="js-select2 form-control" id="kasus-select2" name="kasus" style="width: 100%;" data-placeholder="Pilih Kasus">
                                                <option></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pasien-div">
                                        ...
                                        <input type="text" class="form-control" id="nomor-antrian" name="no_antrian" placeholder="Nomor Antrian">
                                    </div>
                                </div>
                                <div class="col-4">
                            ...
                            <div class="row" id="resepForm">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Paket Obat</label> <i class="fa fa-spin fa-spinner text-info" id="loading-paket"></i>
                                        <br>
                                        <select class="form-control js-select2" id="selectPaket" data-width="100%" style="width: 100%" data-placeholder="Pilih Paket Obat">
                                            <option></option>
                                        </select>
                                        <hr>
                                    </div>
                                    ...
                                    <div class="block-content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="form-control" id="aturan-select2" name="aturan[]" style="width: 100%;" data-placeholder="Pilih Aturan Penggunaan">
                                                <option></option>
                                            </select>
                                            <p class="text-warning"></p>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <label class="css-control css-control-primary css-checkbox div-override-checkbox" id="div-override-checkbox">
                            <input type="checkbox" class="override-checkbox css-control-input" id="override-checkbox" />
