<div class="js-inbox-nav d-none d-md-block">
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">{{session('farmasi')->sluger}}</h3>
            <div class="block-options">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item" id="pengaturan">
        ...
        <div class="block-content">
            <ul class="nav nav-pills flex-column push">
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'dashboard') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/dashboard')}}">
                        <span><i class="fa fa-fw fa-home mr-5"></i> Dashboard</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'transaksi') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/transaksi')}}">
                        <span><i class="fa fa-fw fa-money mr-5"></i> Transaksi</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'distribusi') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/distribusi')}}">
                        <span><i class="fa fa-fw fa-code-fork mr-5"></i> Distribusi</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'pengadaan') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/pengadaan')}}">
                        <span><i class="fa fa-fw fa-truck mr-5"></i> Pembelian</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'penghapusan') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/penghapusan')}}">
                        <span><i class="fa fa-fw fa-trash mr-5"></i> Penghapusan</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'item') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/item')}}">
                        <span><i class="fa fa-fw fa-cube mr-5"></i> Barang</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a style="padding-left: 28px;" class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'item_exp') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/item-exp')}}">
                        <span> -&nbsp;&nbsp;<i class="fa fa-fw fa-cube mr-5"></i> Barang Expired</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a style="padding-left: 28px;" class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'item_stok') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/item-stok')}}">
                        <span> -&nbsp;&nbsp;<i class="fa fa-fw fa-cube mr-5"></i> Barang Stok Kosong</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'stokopname') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/stokopname')}}">
                        <span><i class="fa fa-fw fa-calendar-check mr-5"></i> Stok Opname</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center justify-content-between @if($sidebar_active == 'laporan') active @endif" href="{{url('farmasi/'.session('farmasi')->slug.'/laporan')}}">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="name" placeholder="Nama Unit" value="{{session('farmasi')->sluger}}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                            ...
                            <!-- <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" placeholder="Berikan Informasi Lebih" value="{{session('farmasi')->telepon}}">
                                </div>
                            </div> -->
                        </div>
                        <div class="row">
