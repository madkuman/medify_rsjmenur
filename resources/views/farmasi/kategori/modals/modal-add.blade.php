                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama" placeholder="Nama Kategori" autocomplete="off" required>
                                </div>
                                <div class="form-group">
                                    <label class="css-control css-control-lg css-control-primary css-checkbox">
                                        <input type="checkbox" class="css-control-input" name="is_kandungan" id="is_kandungan" value="1"> <span class="css-control-indicator"></span> Kandungan Obat
                                    </label>
                                </div>
                            </div>
                        </div>
