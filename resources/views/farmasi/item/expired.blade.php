...
@section('title')
Farmasi Barang Expired
@endsection

@section('content')
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Barang (Warning Expired)</h3>
        ...
        <div class="block-content">
            <div class="block block-transparent">
                ...
                <div class="d-none" id="filter-data">
                    <form method="POST" action="{{url('farmasi/'.session('farmasi')->slug.'/item-exp')}}" id="formFilter">
                        {!!csrf_field()!!}
                        <div class="row">
                            <div class="col">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var table = $('#items').DataTable({
            ...
            ajax: {
                url: "{{ url('/farmasi/'.session('farmasi')->slug.'/item/load-exp') }}",
