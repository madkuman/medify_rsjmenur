...
<div class="row">
    ...
    <div class="col-3"><a class="block" href="{{url('farmasi/'.session('farmasi')->slug.'/master-bahan-aktif')}}">
    ...
    <div class="col-3"><a class="block" href="{{url('farmasi/'.session('farmasi')->slug.'/master-jenis-interaksi')}}">
            <div class="block-content"><i class="fa fa-fw fa-handshake mr-5"></i> Master Jenis Interaksi</div>
        </a></div>
    <div class="col-3"><a class="block" href="{{url('farmasi/'.session('farmasi')->slug.'/master-satuan-kekuatan')}}">
            <div class="block-content"><i class="fa fa-fw fa-balance-scale mr-5"></i> Master Satuan Kekuatan</div>
        </a></div>
    <div class="col-3"><a class="block" href="{{url('farmasi/'.session('farmasi')->slug.'/master-kode-rekening')}}">
            <div class="block-content"><i class="fa fa-fw fa-bank mr-5"></i> Master Kode Rekening</div>
        </a></div>
    <div class="col-3"><a class="block" href="{{url('farmasi/'.session('farmasi')->slug.'/master-kode-bidang')}}">
