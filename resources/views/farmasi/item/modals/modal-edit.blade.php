            ...
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <div class="block-content">
                        <div class="row">
                            <div class="col">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select class="js-select2 form-control" id="rute" name="rute" style="width: 100%;">
                                            @foreach($rute as $rute_item)
                                                ...
                                                <option value="{{$rute_item->id}}" selected>{{$rute_item->nama}}</option>
                                                @else
                                                <option value="{{$rute_item->id}}">{{$rute_item->nama}}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="bahan-aktif" name="bahan_aktif" style="width: 100%;">
                                        ...
                                        @foreach($bahan_aktif as $bahan_aktif_item)
                                            ...
                                            <option value="{{$bahan_aktif_item->id}}" selected>{{$bahan_aktif_item->nama}}</option>
                                            @else
                                            <option value="{{$bahan_aktif_item->id}}">{{$bahan_aktif_item->nama}}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" type="number" name="kekuatan_sediaan" id="kekuatan-sediaan" step="0.1" autocomplete="off" value="{{$kekuatan_sediaan}}">
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <select class="js-select2 form-control" id="satuan-kekuatan" name="satuan_kekuatan" style="width: 100%;">
                                                ...
                                                @foreach($satuan_kekuatan as $satuan_kekuatan_item)
                                                    ...
                                                    <option value="{{$satuan_kekuatan_item->id}}" selected>{{$satuan_kekuatan_item->nama}}</option>
                                                    @else
                                                    <option value="{{$satuan_kekuatan_item->id}}">{{$satuan_kekuatan_item->nama}}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kode_barang" name="kode_barang" placeholder="Kode Barang" value="{{ $item->item_detail->kode_barang ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="kode_atc">Kode Atc</label>
                                    <input type="text" class="form-control" id="kode_atc" name="kode_atc" placeholder="Kode Atc" value="{{ $item->item_detail->kode_atc ?? '' }}">
                                </div>
                                @else
                                <div class="form-group">
                                    <label for="penyedia">Satuan</label>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="kelas-terapi" name="kelas_terapi" style="width: 100%;">
                                        @foreach($kategori as $kategori_item)
                                            ...
                                            <option value="{{$kategori_item->id}}" selected>{{$kategori_item->nama}}</option>
                                            @else
                                            <option value="{{$kategori_item->id}}">{{$kategori_item->nama}}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="rak-obat" name="rak_obat" style="width: 100%;">
                                        @foreach($rak_obat as $rak_obat_item)
                                            ...
                                            <option value="{{$rak_obat_item->id}}" selected>{{$rak_obat_item->nama}}</option>
                                            @else
                                            <option value="{{$rak_obat_item->id}}">{{$rak_obat_item->nama}}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="formularium-rs" name="is_formularium_rs" style="width: 100%;">
                                        ...
                                        <option value="1" @if($is_formularium_rs) selected @endif>Ya</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="fornas" name="is_fornas" style="width: 100%;">
                                        <option value="0">Tidak</option>
                                        <option value="1" @if($is_fornas) selected @endif>Ya</option>
                                    </select>
                                </div>
                                
                                <div class="form-group">
                                    <label>Kode Rekening</label>
                                    <select class="js-select2 form-control" id="select-kode-rekening" name="kode_rekening_id" style="width: 100%;">
                                            <option value=""></option>
                                        @foreach($master_kode_rekening as $item_temp)
                                            @php $selected = '' @endphp
                                            @if ($item_temp->id == $item->item_detail->kode_rekening_id) @php $selected = 'selected' @endphp  @endif
                                            <option value="{{$item_temp->id}}" {{$selected}}>{{$item_temp->kode}} - {{$item_temp->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="select-kode-bidang" name="kode_bidang_id" style="width: 100%;">
                                            <option value=""></option>
                                        @foreach($master_kode_bidang as $item_temp)
                                            @php $selected = '' @endphp
                                            @if ($item_temp->id == $item->item_detail->kode_bidang_id) @php $selected = 'selected'; @endphp @endif
                                            <option value="{{$item_temp->id}}" {{$selected}}>{{$item_temp->kode}} - {{$item_temp->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="number" class="form-control" name="dosis_maksimal" placeholder="" value="{{ $item->item_detail->dosis_maksimal ?? '' }}">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="dosis_maksimal_satuan" placeholder="Satuan" value="{{ $item->item_detail->dosis_maksimal_satuan ?? '' }}">
                                        </div>     
                                    </div>
                                </div>
                                ...
                                <div id="div-main-indikasi">
                                    ...
                                    @if (count($indikasi) > 0)
                                        ...
                                        <div class="form-group div-item-indikasi">
                                            <input type="text" class="form-control" name="indikasi[]" placeholder="Indikasi" value="{{ $ind }}">
                                        </div>
                                        @endforeach
                                    @else
                                    <div class="form-group div-item-indikasi">
                                ...
                                <span class="btn btn-primary" id="btn-tambah-indikasi"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</span>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" name="retriksi_bpjs_jumlah" id="retriksi-bpjs" step="0.1" value="{{$retriksi_bpjs_jumlah}}">
                                </div>
                                <div class="form-group">
                                    <label for="retriksi-bpjs-data-lab">Retriksi BPJS Data Lab</label>
                                    <select id="select-retriksi-bpjs-data-lab" class="js-example-basic-multiple form-control" name="retriksi_bpjs_data_lab[]" multiple="multiple" style="width: 100%;">
                                        @foreach($form_lab_pk as $data_lab)
                                            <option value="{{$data_lab->id}}">{{$data_lab->parameter}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <input type="number" class="form-control" name="waktu_dosage_max_1" placeholder="" value="{{ $item->item_detail->waktu_dosage_max_1 ?? '' }}">
                                        </div>
                                        <div class="col-md-1">
                                            <p style="padding-top: 10px; font-size: 10pt">x</p>
                                        </div>
                                        <div class="col-md-5">
                                            <input type="number" class="form-control" name="waktu_dosage_max_2" placeholder="" value="{{ $item->item_detail->waktu_dosage_max_2 ?? '' }}">
                                        </div>     
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <select class="jenis-interaksi-kelas-terapi form-control" name="jenis_interaksi_kelas_terapi[]" style="width: 100%;">
                                                @foreach($jenis_interaksi as $jenis_interaksi_item)
                                                    ...
                                                    <option value="{{$jenis_interaksi_item->id}}" selected>{{$jenis_interaksi_item->nama}}</option>
                                                    @else
                                                    <option value="{{$jenis_interaksi_item->id}}">{{$jenis_interaksi_item->nama}}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-4">
                                            ...
                                            <input class="form-control" type="text" name="keterangan_interaksi_kelas_terapi[]" value="{{$jenis_interaksi_kelas_terapi_item->keterangan}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 main-div-interaksi-kelas-terapi">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <label>Keterangan</label>
                                            <input class="form-control" type="text" name="keterangan_interaksi_kelas_terapi[]">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <span class="btn btn-primary" id="btn-tambah-interaksi-kelas-terapi"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</span>
                           ...
                           <div class="col-12 main-div-interaksi-obat">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <select class="nama-interaksi-obat form-control" name="nama_interaksi_obat[]" style="width: 100%;">
                                                @foreach($item_template as $template_item)
                                                    ...
                                                    <option value="{{$template_item->id}}" selected>{{$template_item->nama}}</option>
                                                    @else
                                                    <option value="{{$template_item->id}}">{{$template_item->nama}}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <label>Keterangan</label>
                                            <input class="form-control" type="text" name="keterangan_interaksi_obat[]" value="{{$jenis_interaksi_obat_item->keterangan}}" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="col-12 main-div-interaksi-obat">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <label>Keterangan</label>
                                            <input class="form-control" type="text" name="keterangan_interaksi_obat[]">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <span class="btn btn-primary" id="btn-tambah-interaksi-obat"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</span>
                        <!-- end interaksi obat -->
                        @endif
