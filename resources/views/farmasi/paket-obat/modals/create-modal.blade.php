<div class="modal fade" id="modal-create-resep" role="dialog" aria-labelledby="modal-fadein" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fadein modal-dialog modal-lg" role="document">
            ...
            <div class="block mb-0">
                ...
                <div class="block-content">
                    <form action="{{url()->current()}}/create" id="form_create_resep" method="post" class="main-form-container">
                        ...
                        @include('farmasi.paket-obat.modals.components.form', ['extra_id' => ""])
