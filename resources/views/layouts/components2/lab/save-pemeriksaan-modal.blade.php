                ...
                <div class="block-content">
                    ...
                    <div class="ditagih" style="display: none;">
                        ...
                        <table class="table table-hover" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th style="border-top: 2px solid gainsboro; width: 50%">Nama</th>
                                    <th style="border-top: 2px solid gainsboro; width: 20%">Harga</th>
                                    <th style="border-top: 2px solid gainsboro; width: 5%">Qty</th>
                                    <th style="border-top: 2px solid gainsboro; width: 25%" class="text-center">Subtotal</th>
                                </tr>
                            </thead>
