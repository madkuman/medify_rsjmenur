...
<body>
		...
		<tr>
			...
			<td width="27%">
				<table>
					...
					<tr>
						<td class="big centered">{{strtoupper($departemen)}}</td>
					</tr>
				</table>
			</td>
	...
	<table>
		...
		<tr>
			<td class="ttd">
				@if(isset($transaksi->pemeriksa->ttd) && !is_null($transaksi->pemeriksa->ttd))
		...
		<tr>
			<td class="centered">Nama : {{$transaksi->pemeriksa->name ?? '...................................'}} </td>
			<td></td>
