<div class="row mx-0">
    <div class="form-group col-lg-3 col-12">
        ...
        <div class="input-group">
            <input type="text" class="js-datepicker form-control datepicker" data-autoclose="true"
                data-today-highlight="true" data-date-format="dd-mm-yyyy" value="" autocomplete="off"
                id="tanggalTransaksi" name="date" placeholder="Masukkan Tanggal Transaksi" required>
    ...
    <div class="form-group col-lg-3 col-12">
        ...
        <select class="js-select2 form-control" id="jenisLayanan" name="jenis_layanan" style="width: 100%;"
            data-placeholder="Pilih Asal Layanan" required="required">
    ...
    <div class="form-group col-lg-3 col-12">
        ...
        <select class="js-example-basic-multiple form-control js-select2" id="jenisPemeriksaan" name="pemeriksaan[]"
            multiple="multiple" data-placeholder="Pilih Layanan" style="width: 100%;">
    ...
    <div class="col-lg-3 col-12 mt-30">
        <a href="{{ url($link . '/transaksi/new') }}" type="btn" class="btn btn-primary" style="float: right;"><i
                class="fa fa-plus"></i> Buat Transaksi</a>
    </div>

</div>
<div class="clearfix"></div>
<div class="block-content">
    <table class="table table-bordered table-striped table-vcenter dataTable no-footer px-15"
        aria-describedby="DataTables_info" id="datatable">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            @foreach ($transaksi as $item)
                ...
                <tr>
                    ...
                    <td class="d-none d-sm-table-cell text-center full-only"
                        data-search="{{ $item->asal->departemen->nama ?? 'Tanpa Kasus' }}">
                        {{ $item->asal['nama'] ?? 'Tanpa Kasus' }}
                    </td>
                    <td class="d-none d-sm-table-cell text-center full-only"
                        data-order="{{ date('YmdHi', strtotime($item->created_at)) }}">
                    ...
                    <td style="border: none;" class="text-center">
                        <a href="{{ url($link . '/transaksi/permintaan') }}/{{ $item->slug }}"
                            class="btn btn-primary">Layani</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
