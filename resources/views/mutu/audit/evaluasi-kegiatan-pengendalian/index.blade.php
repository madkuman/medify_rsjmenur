...
@section('title')
Mutu - Audit - Evaluasi Kegiatan Pengendalian
@endsection

@section('subtitle')
Form Evaluasi Kegiatan Pengendalian
@endsection
				...
				<div class="block">
					<div class="block-header">
						...
						<div class="block-options">
							<button type="button" class="btn-alt btn-primary min-width-125 float-right" data-toggle="modal" data-target="#modal-kegiatan">Tambahkan Evaluasi Kegiatan Pengendalian</button>
						</div>
					</div>
								...
								<table class="table table-bordered table-vcenter js-dataTable-full" id="kegiatan-table">
									<thead>
										<tr>
											...
											<th class="text-center" style="width: 20%">Skala Kemungkinan</th>
											<th class="text-center" style="width: 20%">Skala Dampak</th>
											<th class="text-center">Kreteria Resiko</th>
...
@include('mutu.audit.evaluasi-kegiatan-pengendalian.components.modals')
@endsection
...
function initTabel() {
	table = $('#kegiatan-table').DataTable({
		...
		ajax: {
			dataSrc: "data",
			url  : API_URL + '/mutu/audit/evaluasi-kegiatan-pengendalian/get-data',
			type :'GET'
		},
		language: {
		...
		columns: [
			...
			{ data: 'uraian_resiko' },
			{ data: 'skala_kemungkinan', searchable: false, className: 'text-center' },
			{ data: 'skala_dampak', searchable: false, className: 'text-center' },
			{ data: 'kreteria_resiko', searchable: false, className: 'text-center' },
