...
@section('subtitle')
<span class="text-muted font-w400">Laporan</span> / Mata
@endsection
				...
				<li class="col-lg-3 col-sm-12 d-flex align-items-stretch">
                	<div class="block block-bordered py-20" style="width: 100%">
						...
						<div class="block-content block-content-full text-center pt-0">
							<button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#modal_mata">Buat Laporan</button>
							<a type="button" class="btn btn-warning" href="{{url('mutu/laporan/pengaturan/mata')}}">Pengaturan</a>
						</div>
					</div>
					    ...
					    <div class="modal-dialog modal-dialog-centered modal-bg">
					        <div class="modal-content ">
					            <div class="modal-body">
					                <form method="get" action="{{url('mutu/laporan/mata/audit-mata')}}" class="js-validation-be-contact">
					                    {{ csrf_field() }}
