...
@section('subtitle')
<span class="text-muted font-w400">Laporan</span> / Lab PA
@endsection
                	...
                	<div class="block block-bordered py-20" style="width: 100%">
						<div class="block-header">
							<div class="block-title text-center min-height-75 title">
								Ketepatan Pelayanan Lab PA
							</div>
						</div>
						<div class="block-content block-content-full text-center min-height-125 pt-0 desc">
							Laporan Mutu Terkait Ketepatan Pelayanan Laboratorium Patologi Anatomi
						</div>
						<div class="block-content block-content-full text-center pt-0">
							<button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#modal_labpa">Buat Laporan</button>
							<a type="button" class="btn btn-warning" href="{{url('mutu/laporan/pengaturan/labpa')}}">Pengaturan</a>
						</div>
					</div>
					    ...
					    <div class="modal-dialog modal-dialog-centered modal-bg">
					        <div class="modal-content ">
					            <div class="modal-body">
					                <form method="get" action="{{url('mutu/laporan/lab-pa/labpa')}}" class="js-validation-be-contact">
					                    {{ csrf_field() }}
