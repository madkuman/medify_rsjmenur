...
@section('subtitle')
<span class="text-muted font-w400">Laporan</span> / IT
@endsection
                ...
                <li class="col-lg-3 col-sm-12 d-flex align-items-stretch">
                	<div class="block block-bordered py-20" style="width: 100%">
						...
						<div class="block-content block-content-full text-center min-height-125 pt-0 desc">
							Laporan Mutu Terkait Respon Dalam Menangani Komplain IT
						</div>
						<div class="block-content block-content-full text-center pt-0">
							<button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#modal_komplain_it">Buat Laporan</button>
						</div>
					</div>
					    ...
					    <div class="modal-dialog modal-dialog-centered modal-bg">
					        <div class="modal-content ">
					            <div class="modal-body">
					                <form method="get" action="{{url('mutu/laporan/it/laporan-it')}}" class="js-validation-be-contact">
					                    {{ csrf_field() }}
