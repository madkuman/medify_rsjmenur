...
@section('subtitle')
<span class="text-muted font-w400">Laporan</span> / Radiologi
@endsection
			...
			<ul class="list row">
                	...
                	<div class="block block-bordered py-20" style="width: 100%">
						<div class="block-header">
							<div class="block-title text-center min-height-75 title">
								Film Ditolak/Film Keluar Lab Radiologi
							</div>
						</div>
						<div class="block-content block-content-full text-center min-height-125 pt-0 desc">
							Laporan Lab Radiologi berdasarkan Film yang ditolak/keluar
						</div>
						<div class="block-content block-content-full text-center pt-0">
							<button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#modal_radiologi_film">Buat Laporan</button>
						</div>
					</div>
					    ...
					    <div class="modal-dialog modal-dialog-centered modal-bg">
					        <div class="modal-content ">
					            <div class="modal-body">
					                <form method="get" action="{{url('mutu/laporan/radiologi/radiologi-film')}}" class="js-validation-be-contact">
					                    {{ csrf_field() }}
                ...
                <li class="col-lg-3 col-sm-12 d-flex align-items-stretch">
                	<div class="block block-bordered py-20" style="width: 100%">
						<div class="block-header">
							<div class="block-title text-center min-height-75 title">
								Ketepatan Pelayanan USG Lab Radiologi
							</div>
						</div>
						<div class="block-content block-content-full text-center min-height-125 pt-0 desc">
							Laporan Lab Radiologi berdasarkan Ketepatan Pelayanan
						</div>
						<div class="block-content block-content-full text-center pt-0">
							<button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#modal_radiologi_ketepatan_usg">Buat Laporan</button>
							<a type="button" class="btn btn-warning" href="{{url('mutu/laporan/pengaturan/radiologi-ketepatan-usg')}}">Pengaturan</a>
						</div>
					</div>
					...
					<div id="modal_radiologi_ketepatan_usg" class="modal fade " role="dialog">
					    <div class="modal-dialog modal-dialog-centered modal-bg">
					        <div class="modal-content ">
					            <div class="modal-body">
					                <form method="get" action="{{url('mutu/laporan/radiologi/radiologi-ketepatan-usg')}}" class="js-validation-be-contact">
					                    {{ csrf_field() }}
                ...
                <li class="col-lg-3 col-sm-12 d-flex align-items-stretch">
                	<div class="block block-bordered py-20" style="width: 100%">
						<div class="block-header">
							<div class="block-title text-center min-height-75 title">
								Ketepatan Pelayanan Konvensional Lab Radiologi
							</div>
						</div>
						<div class="block-content block-content-full text-center min-height-125 pt-0 desc">
							Laporan Lab Radiologi berdasarkan Ketepatan Pelayanan
						...
						<div class="block-content block-content-full text-center pt-0">
							<button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#modal_radiologi_ketepatan_konvensional">Buat Laporan</button>
							<a type="button" class="btn btn-warning" href="{{url('mutu/laporan/pengaturan/radiologi-ketepatan-konvensional')}}">Pengaturan</a>
						</div>
					</div>
					...
					<div id="modal_radiologi_ketepatan_konvensional" class="modal fade " role="dialog">
					    <div class="modal-dialog modal-dialog-centered modal-bg">
					        <div class="modal-content ">
					            <div class="modal-body">
					                <form method="get" action="{{url('mutu/laporan/radiologi/radiologi-ketepatan-konvensional')}}" class="js-validation-be-contact">
					                    {{ csrf_field() }}
