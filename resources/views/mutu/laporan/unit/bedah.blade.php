...
@section('subtitle')
<span class="text-muted font-w400">Laporan</span> / Bedah
@endsection
			...
			<ul class="list row">
                	...
                	<div class="block block-bordered py-20" style="width: 100%">
						<div class="block-header">
							<div class="block-title text-center min-height-75 title">
								Kesesuaian Diagnosis Rencana dan Pasca Operasi
							</div>
						</div>
						<div class="block-content block-content-full text-center min-height-125 pt-0 desc">
							Laporan Kasus, Kesesuaian Diagnosis Rencana dan Pasca Operasi Bedah
						</div>
						<div class="block-content block-content-full text-center pt-0">
							<button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#modal_kesesuaian_bedah">Buat Laporan</button>
						</div>
					</div>
					    ...
					    <div class="modal-dialog modal-dialog-centered modal-bg">
					        <div class="modal-content ">
					            <div class="modal-body">
					                <form method="get" action="{{url('mutu/laporan/bedah/kesesuaian-bedah')}}" class="js-validation-be-contact">
					                    {{ csrf_field() }}
                ...
                <li class="col-lg-3 col-sm-12 d-flex align-items-stretch">
                	<div class="block block-bordered py-20" style="width: 100%">
						<div class="block-header">
							<div class="block-title text-center min-height-75 title">
								Kesesuaian Pengisian Pra Bedah
							</div>
						</div>
						<div class="block-content block-content-full text-center min-height-125 pt-0 desc">
							Laporan Kasus, Kesesuaian Pengisian Pra Bedah Pasca Operasi Bedah
						</div>
						<div class="block-content block-content-full text-center pt-0">
							<button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#modal_kesesuaian_pra_bedah">Buat Laporan</button>
						</div>
					</div>
					...
					<div id="modal_kesesuaian_pra_bedah" class="modal fade " role="dialog">
					    <div class="modal-dialog modal-dialog-centered modal-bg">
					        <div class="modal-content ">
					            <div class="modal-body">
					                <form method="get" action="{{url('mutu/laporan/bedah/kesesuaian-asesmen-pra-bedah')}}" class="js-validation-be-contact">
					                    {{ csrf_field() }}
