...
<table>
	<tr>
		<td colspan="7">LAPORAN KETEPATAN THT Post Operasi Bedah Laring Mikroskopik</td>
	</tr>
	<tr>
		<td colspan="5">Post Operasi Bedah Laring Mikroskopik</td>
	...
	@foreach($result as $i => $r)
		<tr>
			...
			<td>{{$r->pasien->name ?? '-'}}</td>
			<td>{{$r->lokasi->nama ?? '-'}}</td>
			<td>{{$r->los}} Hari @if($r->los > 3) $overlos++; @endif</td>
		</tr>
	@endforeach
	<tr></tr>
	<tr></tr>
