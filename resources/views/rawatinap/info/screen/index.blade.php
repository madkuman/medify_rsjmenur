...
<head>
	<title>Screen TV - Info Ranap</title>
	@include('layouts.components2.header')
	@include('rawatinap.info.screen.components.style-css')
...
<body>
	...
	height: 150vh;
	width: 100vw;
	background-image: url('{{url("assets/img/bgmenur.png")}}');">
		@include('rawatinap.info.screen.components.content')
		...
		@include('rawatinap.info.screen.components.js')
	</div>
</body>
</html>
