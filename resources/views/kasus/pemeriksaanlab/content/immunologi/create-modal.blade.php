<div class="modal fade" id="modal-create-imun" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="block-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="hbs_ag" autocomplete="off">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="anti_hiv" autocomplete="off">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">mlU/ml</label>
                                    <label class="col-lg-3 col-form-label text-center">Negative</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="anti_hcv" autocomplete="off">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="ict_malaria" autocomplete="off">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center"></label>
                                    <label class="col-lg-3 col-form-label text-center">Negative</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="vdrl" autocomplete="off">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center"></label>
                                    <label class="col-lg-3 col-form-label text-center">Negative</label> 
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="coomb_test" autocomplete="off">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center"></label>
                                    <label class="col-lg-3 col-form-label text-center">Negative</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="hb_eag" autocomplete="off">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center"></label>
                                    <label class="col-lg-3 col-form-label text-center">Negative</label>
                                </div>
