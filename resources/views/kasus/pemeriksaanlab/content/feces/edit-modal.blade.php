<div class="modal fade" id="modal-edit-feces" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
            ...
            <div class="block rounded block-transparent mb-0">
                ...
                <div class="block-content">
                    <form class="js-validation-be-contact" action="{{url('kasus')}}/{{ $nomor_kasus }}/pemeriksaanlab/feces/create" method="post">
                        {{ csrf_field() }}
                        <input id="feces_id" name="feces_id" type="hidden">
                        <div class="row">
                            <div class="block-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="warna" autocomplete="off" id="warna">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="konsistensi" autocomplete="off" id="konsistensi">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="bau" autocomplete="off" id="bau">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="lendir" autocomplete="off" id="lendir">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="darah" autocomplete="off" id="darah">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>    
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="lekosit" autocomplete="off" id="lekosit">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="amoeba" autocomplete="off" id="amoeba">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="kista" autocomplete="off" id="kista">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="telur_cacing" autocomplete="off" id="telur_cacing">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                            ...
                            <div class="block-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="protein" autocomplete="off" id="protein">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="lemak" autocomplete="off" id="lemak">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="karbohidrat" autocomplete="off" id="karbohidrat">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="serat" autocomplete="off" id="serat">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="amylum" autocomplete="off" id="amylum">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="bakteri" autocomplete="off" id="bakteri">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input  type="text" class="form-control" name="benzidin_test" autocomplete="off" id="benzidin_test">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">-</label>
                                    <label class="col-lg-3 col-form-label text-center">-</label>
                                </div>
