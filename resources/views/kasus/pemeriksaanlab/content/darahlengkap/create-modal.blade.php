<div class="modal fade" id="modal-create-darah" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-fromright modal-dialog" role="document">
        <div class="modal-content">
            <div class="block rounded block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">Kimia Klinik</h3>
                        ...
                        <div class="row">
                            <div class="block-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="glukosa_2jam" autocomplete="off">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">mg/dl</label>
                                ...
                                <hr>
                                <h5 style="margin-bottom: 0px; margin-top: 80px;">Darah Lengkap / Hematologi</h5>
                                <div class="row">
                                    <label class="col-lg-3 col-form-label">Parameter</label>
                                    <div class="col-lg-4 col-form-label text-center">Hasil</div>
                                    <label class="col-lg-2 col-form-label text-center">Satuan</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="pembekuan" id="pembekuan" autocomplete="off">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="pendarahan" id="pendarahan" autocomplete="off">
                                    </div>
                                    <label class="col-lg-2 col-form-label text-center">m3</label>
