...
@section("title")
{{$kasus->judul_kasus}} - Ringkasan Pasien Masuk dan Keluar - Kasus
@endsection
			...
			<div class="col-lg-9 col-xl-9">
				<div class="block block-bordered">
					<div class="block-content">
						...
						<button type="button" class="btn btn-rounded btn-alt-primary min-width-125 float-right editBtn" data-toggle="modal" data-target="#addModal"><i class="fa fa-pencil"></i> Ringkasan Pasien Masuk dan Keluar Baru</button>
						@endif
						<h4>Ringkasan Pasien Masuk dan Keluar</h4>
						<hr>
						@php $count = count($ringkasan_pasien_masuk_dan_keluar) @endphp
						@forelse($ringkasan_pasien_masuk_dan_keluar as $item)
						...
						<h5 class="mb-5 pl-5">#Ringkasan Pasien Masuk dan Keluar {{$count}}</h5>
						...
						<div class="text-center py-50">
							<h4 class="font-w400 mb-5">Belum ada asesmen Ringkasan Pasien Masuk dan Keluar tersedia</h4>
							<p>Klik tombol <b>Ringkasan Pasien Masuk dan Keluar Baru</b> untuk melakukan asesmen Ringkasan Pasien Masuk dan Keluar</p>
						</div>
