            ...
            <form method="POST" action="{{url()->current()}}/save">
				<div class="block block-themed block-transparent mb-0">
				    <div class="block-header">
				        <h3 class="block-title">Lembar Komunikasi Informasi dan Edukasi Pasien dan Keluarga</h3>
					...
					@include("kasus.asesmen.lembar-komunikasi-informasi-dan-edukasi-pasien-dan-keluarga.form")
				</div>
