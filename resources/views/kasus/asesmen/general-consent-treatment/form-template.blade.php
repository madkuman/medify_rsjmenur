    ...
    <tr>
        ...
        <td class=" position-relative" colspan="1" rowspan="1">
            ...
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                ...
                <label class="form-check-label" style="margin-left: 20px;">“Saya menjamin bahwa pasien sudah membaca dan menandatangani <i> general consent for treatment </i> pembukaan data dari SATUSEHAT”</label>
            </div>
            @else
            <span class="medify-form-genv4-view-container"> 
                @if ($hasil_data_temp == '1')
                <span>☑<span style="margin-left: 20px;">“Saya menjamin bahwa pasien sudah membaca dan menandatangani <i> general consent for treatment </i>  pembukaan data dari SATUSEHAT”</span></span>
                @else
                <span>⬜ <span style="margin-left: 20px;">“Saya menjamin bahwa pasien sudah membaca dan menandatangani <i> general consent for treatment </i> pembukaan data dari SATUSEHAT”</span></span>
                @endif
            </span>
