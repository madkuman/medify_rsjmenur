...
<table style="width:100%" >
   <tr>
      <td style="vertical-align: middle;" width = "45%" class=" position-relative kop" colspan="1" rowspan="5">
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/assets/img/kop_menur.png'))) }}" height="80" width="400" />
      </td>
   </tr>
   <tr>
...
<table  style="width:100%">
    <tr>
         <td class=" position-relative" colspan="3" rowspan="1">
            <h5>PERSETUJUAN UMUM (GENERAL CONSENT FOR TREATMENT)</h5>
         </td>
    </tr>
    <tr>
         <td class=" position-relative" colspan="3" rowspan="1">
...
<table style="width:100%;">
    ...
    <tr>
        ...
        <td class=" position-relative" colspan="1" rowspan="1">
            <ol class="custom-ol">
                ...
                <li>Menggugat dan/atau menuntut Rumah Sakit apabila Rumah Sakit diduga memberikan pelayanan yang tidak sesuai dengan standar baik secara perdata ataupun pidana.</li>
    ...
    <tr>
        <td class=" position-relative" colspan="1" rowspan="1"></td>
        <td class=" position-relative" colspan="1" rowspan="1">
            <span>Kewajiban Pasien (Permenkes No. 4 Tahun 2018 Tentang Kewajiban Rumah Sakit dan Kewajiban Pasien)</span>
         </td>
    </tr>
    <tr>
        <td class=" position-relative" colspan="1" rowspan="1"></td>
        <td class=" position-relative" colspan="1" rowspan="1">
            <ol class="custom-ol">
                ...
                <li>Menerima segala konsekuensi atas keputusan pribadinya untuk menolak rencana terapi yang direkomendasikan oleh Tenaga Kesehatan dan/atau tidak mematuhi petunjuk yang diberikan oleh tenaga kesehatan untuk penyembuhan penyakit atau masalah kesehatannya.</li>
    ...
    <tr>
        ...
        <td class=" position-relative" colspan="1" rowspan="1">
            <ol class="custom-ol">
                <li>Mengajukan pertanyaan dan berpartisipasi aktif dalam diskusi dan keputusan mengenai perawatan kesehatan pasien.</li>
                <li>Memberikan informasi yang lengkap dan akurat tentang kesehatan dan riwayat kesehatan pasien termasuk kondisi sekarang, penyakit masa lalu, riwayat rawat inap dan pengobatan.</li>
                <li>Mendiskusikan masalah perawatan kesehatan, kekhawatiran, dan kebutuhan pribadi pasien dengan penyedia layanan kesehatan secara jujur dan beri tahu penyedia layanan kesehatan tentang setiap perubahan yang terjadi pada kesehatan pasien.</li>
                <li>Bekerja sama dengan semua petugas kesehatan yang terlibat dalam perawatan pasien dan berperilaku sopan dan saling menghormati.</li>
                <li>Menghormati hak penyedia layanan kesehatan dan untuk bertukar informasi dengan cara yang baik dan tidak melakukan kekerasan secara fisik maupun verbal saat dalam perawatan.</li>
                <li>Mengikuti instruksi asuhan kesehatan atau beri tahu staf kami jika pasien tidak dapat atau tidak bersedia mengikuti rencana asuhan.</li>
                <li>Menerima konsekuensi karena menolak rencana asuhan atau tidak mengikuti rencana asuhan.</li>
                <li>Menghormati hak dan privasi semua profesional pemberi asuhan, karyawan rumah sakit dan pasien lain.</li>
                <li>Memberitahu staf rumah sakit bila merubah keputusan persetujuan atas rencana asuhan yang telah disetujui.</li>
            </ol>
        </td>
    </tr>
    <tr>
        <td class=" position-relative" colspan="1" rowspan="1"></td>
        <td class=" position-relative" colspan="1" rowspan="1">
            <span>Kami telah mendapat informasi tentang “Hak, Kewajiban dan Tanggung Jawab Pasien" di Rumah Sakit Jiwa Menur Provinsi Jawa Timur melalui leaflet dan banner yang  disediakan oleh petugas.</span>
         </td>
    </tr>
</table>
<table style="width:100%;">
    ...
    <tr>
        ...
        <td class=" position-relative" colspan="1" rowspan="1">
            <ol class="custom-ol">
                <li>Kami telah memahami bahwa rumah sakit telah menginformasikan agar tidak membawa barang – barang berharga seperti perhiasan, uang, elektronik, dll untuk mencegah terjadinya kehilangan atau keamanan selama di rumah sakit.</li>
                <li>Kami juga mengerti bahwa kami harus memberitahu/menitipkan pada rumah sakit jika kami memiliki gigi palsu, kacamata, lensa kontak, prosthetics atau barang lainnya yang kami butuhkan untuk diamankan (tersedia formulir khusus).</li>
                <li>Kami memahami bahwa kami tidak diperkenankan untuk membawa makanan basah/memerlukan penyimpanan khusus/tidak berlabel/bertentangan dengan kondisi dan terapi diet pasien ketika diputuskan untuk menjalani rawat inap.</li>
            </ol>
        </td>
    </tr>
</table>
...
<table style="width:100%">
    ...
    <tr>
        <td class=" position-relative" colspan="1" rowspan="1"></td>
        <td class=" position-relative" colspan="1" rowspan="1">
            <span>Kami memahami informasi tentang pengaduan dan penanganan keluhan terkait pelayanan, perawatan dan pemberian pengobatan yang ada di rumah sakit bisa secara langsung melalui informasi/costumer service dan tidak secara langsung melalui kotak saran yang sudah disediakan, telp. (031) 5021635/ 08113633120 atau web rsjmenur.jatimprov.co.id.</span>
        </td>
    </tr>
    <tr>
...
<table style="width:100%">
            ...
            <table style="width:100%">
                ...
                <tr>
                    <td class=" position-relative vertical-align-middle" colspan="1" rowspan="1">
                        ...
                        <span class="medify-form-genv4-view-container"> 
                            @if ($hasil_data_temp == '1')
                            <span><img width="10" height="10" src='data:image/png;base64,'/> Ditanggung oleh perusahaan/ Instansi/  Asuransi*) {{ $hasil_data->pembiayaan['ditanggung_oleh_perusahaan_nama'] ?? '' }} dan kami bersedia melengkapi dan menyerahkan persyaratan administrasi pada saat akan dilakukan perawatan di Rumah Sakit Jiwa Menur Provinsi Jawa Timur.</span>
                            @else
                            <span><img width="10" height="10" src='data:image/png;base64,'/> Ditanggung oleh perusahaan/ Instansi/  Asuransi*) .............................................................. dan kami bersedia melengkapi dan menyerahkan persyaratan administrasi pada saat akan dilakukan perawatan di Rumah Sakit Jiwa Menur Provinsi Jawa Timur.</span>
                            @endif
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class=" position-relative vertical-align-middle" colspan="1" rowspan="1">
                        ...
                        <span class="medify-form-genv4-view-container"> 
                            @if ($hasil_data_temp == '1')
                            <span><img width="10" height="10" src='data:image/png;base64,'/> Ditanggung oleh BPJS dan kami bersedia melengkapi dan menyerahkan persyaratan administrasi sejak penderita akan dirawat.</span>
                            @else
                            <span><img width="10" height="10" src='data:image/png;base64,'/> Ditanggung oleh BPJS dan kami bersedia melengkapi dan menyerahkan persyaratan administrasi sejak penderita akan dirawat.</span>
                            @endif
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class=" position-relative vertical-align-middle" colspan="1" rowspan="1">
                        ...
                        <span class="medify-form-genv4-view-container"> 
                            @if ($hasil_data_temp == '1')
                            <span><img width="10" height="10" src='data:image/png;base64,'/> Apabila menghendaki naik kelas perawatan, Kami bersedia membayar selisih biaya yang harus ditanggung.</span>
                            @else
                            <span><img width="10" height="10" src='data:image/png;base64,'/> Apabila menghendaki naik kelas perawatan, Kami bersedia membayar selisih biaya yang harus ditanggung.</span>
                            @endif
                        </span>
                    </td>
                </tr>
    ...
    <tr>
        ...
        <td class=" position-relative" colspan="1" rowspan="1">
            ...
            <span class="medify-form-genv4-view-container"> 
                @if ($hasil_data_temp == '1')
                <span><img width="10" height="10" src='data:image/png;base64,'/><span style="margin-left: 20px;">“Saya menjamin bahwa pasien sudah membaca dan menandatangani consent pembukaan data dari SATUSEHAT”</span></span>
                @else
                <span><img width="10" height="10" src='data:image/png;base64,'/> <span style="margin-left: 20px;">“Saya menjamin bahwa pasien sudah membaca dan menandatangani consent pembukaan data dari SATUSEHAT”</span></span>
                @endif
            </span>
        </td>
    </tr>
    <tr>
        <td class=" position-relative" colspan="1" rowspan="1"></td>
        <td class=" position-relative" colspan="1" rowspan="1">
            <span>Dengan tanda tangan kami atau yang mewakili dibawah ini, kami menyatakan bahwa kami telah membaca dan memahami item pada Persetujuan Umum (General Consent For Treatment)</span>
        </td>
    </tr>
</table>
<br><br>
<table style="width: 100%">
    ...
    <tr>
        <td class=" position-relative" colspan="3" rowspan="1">
            <span><img width="10" height="10" src='data:image/png;base64,'/> : centang (√) salah satu sesuai jenis pembayaran pasien</span>
            <br>
