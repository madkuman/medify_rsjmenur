...
@section('title')
    {{ $kasus->judul_kasus }} - Resiko Melarikan Diri - Kasus
@endsection
...
@section('content')
                        ...
                        <div class="block-content">
                            @if (session('my_role_' . $kasus->nomor_kasus))
                                <button type="button"
                                    ...
                                    data-toggle="modal" data-target="#addModal"><i class="fa fa-pencil"></i> Resiko Melarikan Diri
                                    Baru</button>
                            @endif
                            <h4>Resiko Melarikan Diri</h4>
                            <hr>
                            ...
                            @forelse($alatbantu as $item)
                                ...
                                <h5 class="mb-5 pl-5">#Resiko Melarikan Diri {{ $count }}</h5>
                            ...
                            @empty
                                ...
                                <div class="text-center py-50">
                                    <h4 class="font-w400 mb-5">Belum ada asesmen Resiko Melarikan Diri tersedia</h4>
                                    <p>Klik tombol <b>Resiko Melarikan Diri Baru</b> untuk melakukan asesmen.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
    ...
    @include('kasus.asesmen.resiko-melarikan-diri.modal')
    @include('kasus.asesmen.resiko-melarikan-diri.modal-hasil')
@endsection
    ...
    <script type="text/javascript">
        ...
        $(".editBtn").click(function(e) {
            ...
            if (item != "" && item != undefined) {
                $("#id").val(item.id);
                @include('kasus.asesmen.resiko-melarikan-diri.js-form-edit')
            } else {
                $("#id").val(0);
                @include('kasus.asesmen.resiko-melarikan-diri.js-form-create')
            }
        ...
        $(".showBtn").click(function(e) {
            ...
            var hasil = `@include('kasus.asesmen.resiko-melarikan-diri.hasil')`;
