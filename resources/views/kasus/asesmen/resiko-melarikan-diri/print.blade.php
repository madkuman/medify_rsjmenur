...
<head>
    <meta name="description" content="Medify Hospital">
    <meta name="author" content="Medify">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>{{ $kasus->judul_kasus }} - Print Asesmen Resiko Melarikan Diri</title>
</head>
...
<body>
    ...
    <table class="ms-table-bordered ms-border-bottom-0">
        ...
        @php
            $faktor = ['Menolak Perawatan/Insight Jelek', 'Memiliki Keinginan Kuat/Kepentingan di Luar Rumah Sakit', 'Kebosanan', 'Perintah Halusinasi untuk Melarikan diri', 'Berkurang / kehilangan kontrol diri', 'Kemarahan, Frustasi', 'Perilaku seksual tidak wajar', 'Ketakutan terhadap pasien lain, NaKes dan Pengobatan', 'Penggunaan Napza'];
