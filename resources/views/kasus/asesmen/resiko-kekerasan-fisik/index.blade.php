...
@section('title')
    {{ $kasus->judul_kasus }} - Resiko Kekerasan Fisik - Kasus
@endsection
...
@section('content')
                        ...
                        <div class="block-content">
                            @if (session('my_role_' . $kasus->nomor_kasus))
                                <button type="button"
                                    ...
                                    data-toggle="modal" data-target="#addModal"><i class="fa fa-pencil"></i> Resiko Kekerasan
                                    Fisik
                                    Baru</button>
                            @endif
                            <h4>Resiko Kekerasan Fisik</h4>
                            <hr>
                            ...
                            @forelse($alatbantu as $item)
                                ...
                                <h5 class="mb-5 pl-5">#Resiko Kekerasan Fisik {{ $count }}</h5>
                            ...
                            @empty
                                ...
                                <div class="text-center py-50">
                                    <h4 class="font-w400 mb-5">Belum ada asesmen Resiko Kekerasan Fisik tersedia</h4>
                                    <p>Klik tombol <b>Resiko Kekerasan Fisik Baru</b> untuk melakukan asesmen.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
    ...
    @include('kasus.asesmen.resiko-kekerasan-fisik.modal')
    @include('kasus.asesmen.resiko-kekerasan-fisik.modal-hasil')
@endsection
    ...
    <script type="text/javascript">
        ...
        $(".editBtn").click(function(e) {
            ...
            if (item != "" && item != undefined) {
                $("#id").val(item.id);
                @include('kasus.asesmen.resiko-kekerasan-fisik.js-form-edit')
            } else {
                $("#id").val(0);
                @include('kasus.asesmen.resiko-kekerasan-fisik.js-form-create')
            }
        ...
        $(".showBtn").click(function(e) {
            ...
            var hasil = `@include('kasus.asesmen.resiko-kekerasan-fisik.hasil')`;
