...
<table style="width:100%;">
    <tr>
        <td style="width: 20%" class=" position-relative" colspan="1" rowspan="1">
            <span>NAMA PEMBERI INFORMASI</span>
        </td>
...
<table style="width:100%" class="c-table--bordered">
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[diagnosis]" id="radio-input-cafqw"
                    value="1" @php $hasil_data_temp=$hasil_data->{'sign'}->{'diagnosis'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-cafqw"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'diagnosis'} ?? '' @endphp @if ($hasil_data_temp == '1')
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[diagnosis]" id="radio-input-sadsa"
                    value="0" @php $hasil_data_temp=$hasil_data->{'sign'}->{'diagnosis'} ?? '' @endphp
                    @if ($hasil_data_temp == '0') checked @endif> <label class="form-check-label"
                    for="radio-input-sadsa"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'diagnosis'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[kondisi]" id="radio-input-cafqw"
                    value="1" @php $hasil_data_temp=$hasil_data->{'sign'}->{'kondisi'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-cafqw"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'kondisi'} ?? '' @endphp @if ($hasil_data_temp == '1')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[kondisi]" id="radio-input-fsadaw"
                    value="0" @php $hasil_data_temp=$hasil_data->{'sign'}->{'kondisi'} ?? '' @endphp
                    @if ($hasil_data_temp == '0') checked @endif> <label class="form-check-label"
                    for="radio-input-fsadaw"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'kondisi'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[tindakan_yang_diusulkan]"
                    id="radio-input-fsawr" value="1"
                    @php $hasil_data_temp=$hasil_data->{'sign'}->{'tindakan_yang_diusulkan'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-fsawr"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'tindakan_yang_diusulkan'} ?? '' @endphp @if ($hasil_data_temp == '1')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            ...
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'tindakan_yang_diusulkan'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[tata_cara]" id="radio-input-sdsa2"
                    value="1" @php $hasil_data_temp=$hasil_data->{'sign'}->{'tata_cara'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-sdsa2"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'tata_cara'} ?? '' @endphp @if ($hasil_data_temp == '1')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[tata_cara]" id="radio-input-sdad"
                    value="0" @php $hasil_data_temp=$hasil_data->{'sign'}->{'tata_cara'} ?? '' @endphp
                    @if ($hasil_data_temp == '0') checked @endif> <label class="form-check-label"
                    for="radio-input-sdad"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'tata_cara'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[manfaat_dan_risiko]"
                    id="radio-input-sadsadsda" value="1"
                    @php $hasil_data_temp=$hasil_data->{'sign'}->{'manfaat_dan_risiko'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-sadsadsda"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'manfaat_dan_risiko'} ?? '' @endphp @if ($hasil_data_temp == '1')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            ...
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'manfaat_dan_risiko'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[nama_orang_mengerjakan]"
                    id="radio-input-asasd" value="1"
                    @php $hasil_data_temp=$hasil_data->{'sign'}->{'nama_orang_mengerjakan'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-asasd"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'nama_orang_mengerjakan'} ?? '' @endphp @if ($hasil_data_temp == '1')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            ...
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'nama_orang_mengerjakan'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[kemungkinan_alternatif_orang]"
                    id="radio-input-asasd" value="1"
                    @php $hasil_data_temp=$hasil_data->{'sign'}->{'kemungkinan_alternatif_orang'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-asasd"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'kemungkinan_alternatif_orang'} ?? '' @endphp @if ($hasil_data_temp == '1')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            ...
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'kemungkinan_alternatif_orang'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[prognosis_pasien]" id="radio-input-asasd"
                    value="1" @php $hasil_data_temp=$hasil_data->{'sign'}->{'prognosis_pasien'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-asasd"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'prognosis_pasien'} ?? '' @endphp @if ($hasil_data_temp == '1')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[prognosis_pasien]"
                    id="radio-input-sdaasdsax" value="0"
                    @php $hasil_data_temp=$hasil_data->{'sign'}->{'prognosis_pasien'} ?? '' @endphp
                    @if ($hasil_data_temp == '0') checked @endif> <label class="form-check-label"
                    for="radio-input-sdaasdsax"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'prognosis_pasien'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[kemungkinan_hasil]" id="radio-input-asasd"
                    value="1" @php $hasil_data_temp=$hasil_data->{'sign'}->{'kemungkinan_hasil'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-asasd"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'kemungkinan_hasil'} ?? '' @endphp @if ($hasil_data_temp == '1')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[kemungkinan_hasil]"
                    id="radio-input-sdaasdsax" value="0"
                    @php $hasil_data_temp=$hasil_data->{'sign'}->{'kemungkinan_hasil'} ?? '' @endphp
                    @if ($hasil_data_temp == '0') checked @endif> <label class="form-check-label"
                    for="radio-input-sdaasdsax"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'kemungkinan_hasil'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
    ...
    <tr>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            <div class="form-check form-check-inline medify-form-genv4-input-container">
                <input class="form-check-input" type="radio" name="sign[kemungkinan_hasil_tindakan]"
                    id="radio-input-asasd" value="1"
                    @php $hasil_data_temp=$hasil_data->{'sign'}->{'kemungkinan_hasil_tindakan'} ?? '' @endphp
                    @if ($hasil_data_temp == '1') checked @endif> <label class="form-check-label"
                    for="radio-input-asasd"> </label>
            </div>
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'kemungkinan_hasil_tindakan'} ?? '' @endphp @if ($hasil_data_temp == '1')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
        ...
        <td class=" position-relative text-center" colspan="1" rowspan="1">
            ...
            <span class="medify-form-genv4-view-container"> @php $hasil_data_temp = $hasil_data->{'sign'}->{'kemungkinan_hasil_tindakan'} ?? '' @endphp @if ($hasil_data_temp == '0')
                    <span style='font-family:calibri'>&#x2714;</span>
                @else
                    <span style='font-family:calibri'></span>
                @endif </span>
