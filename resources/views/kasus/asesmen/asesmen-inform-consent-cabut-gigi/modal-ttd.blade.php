		...
		<div class="modal-content" >
			<div class="block block-themed block-transparent mb-0">
				<div class="block-header ">
					<h3 class="block-title">TTD untuk <span id="ttdUntuk" class="text-capitalize"></span></h3>
				...
				<div class="block-content row">				
                    {{csrf_field()}}
                    <input type="text" id="nama_persetujuan_pasien" name="persetujuan_pasien" class="form-control">
