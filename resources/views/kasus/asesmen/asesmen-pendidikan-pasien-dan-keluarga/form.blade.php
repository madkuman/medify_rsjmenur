...
<div class="block-content" style="padding-left: 25px; padding-right: 25px;">
	...
	<div class="row">
		...
		<div class="col-12">
			<h5 class="pt-15">Hambatan Dalam Belajar</h5>
		</div>
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Pendengaran" class="css-control-input" name="hambatan[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Penglihatan" class="css-control-input" name="hambatan[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Kognitif" class="css-control-input" name="hambatan[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Fisik" class="css-control-input" name="hambatan[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Budaya" class="css-control-input" name="hambatan[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Agama" class="css-control-input" name="hambatan[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Emosi" class="css-control-input" name="hambatan[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Bahasa" class="css-control-input" name="hambatan[]">
		...
		<div class="form-group col-md-3 col-sm-12">
			<label>Hambatan Lain (tulis yang tidak tercantum diatas)</label>
			<input type="text" class="form-control" name="hambatan[]">
		</div>
		<div class="form-group col-md-3 col-sm-12">
			<label>Penerjemah (bila dibutuhkan)</label>
		...
		<div class="col-12">
			<h5 class="pt-15">Kebutuhan Pembelajaran Pasien</h5>
		</div>
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Diagnosa & Manajemen" class="css-control-input" name="pembelajaran[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Obat-obatan" class="css-control-input" name="pembelajaran[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Perawatan Luka" class="css-control-input" name="pembelajaran[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Rehabilitas" class="css-control-input" name="pembelajaran[]">
					<span class="css-control-indicator"></span> Rehabilitas
				</label>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Manajemen Nyeri" class="css-control-input" name="pembelajaran[]">
		...
		<div class="col-md-3">
			<div class="form-group mb-5">
				<label class="css-control css-control-primary css-checkbox">
					<input type="checkbox" value="Diet dan Nutrisi" class="css-control-input" name="pembelajaran[]">
		...
		<div class="form-group col-md-3 col-sm-12">
			<label>Kebutuhan Belajar Lain (tulis yang tidak tercantum diatas)</label>
