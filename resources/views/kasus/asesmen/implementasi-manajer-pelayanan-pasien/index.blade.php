        ...
        $(document).ready(function() {
            ...
            $(".editBtn").click(function(e) {
                ...
                var fields = [{
                    ...
                    {
                        selector: ".data-implementasi",
                        key: "implementasi"
                    },
                    {
                        selector: ".data-evaluasi",
                        key: "evaluasi"
                    },
                    {
                        selector: ".data-paraf",
                ...
                if (item != "" && item != undefined) {
                    ...
                    // form-create
                    $("#id").val(0);
                    var new_fields = fields.filter(function(item) {
                        return item.selector !== ".data-implementasi";
                    });
                    setFormValue(new_fields, null)
                    $("input[name=diagnosa_medis]").val("");
                    $("input[name=mpp]").val("");
                }
            ...
            $(".showBtn").click(function(e) {
                ...
                var evaluasi_fields = [{
                        selector: "#myModalBody span.datahasil-tgl",
                        key: "tgl"
                    },
                    {
                        selector: "#myModalBody span.datahasil-jam",
                        key: "jam"
                    },
                    {
                        selector: "#myModalBody td.datahasil-implementasi",
                        key: "implementasi"
                    },
                    {
                        selector: "#myModalBody td.datahasil-evaluasi",
                        key: "evaluasi"
                    },
                    {
                        selector: "#myModalBody td.datahasil-paraf",
                        key: "paraf"
                    }
                ];
            ...
            function setFormValue(fields, item, is_text=false) {
                fields.forEach(function(field) {
                    ...
                    $elements.each(function(index, element) {
                        if (item && item.data && index < item.data.length) {
                            if (is_text) {
                                $(element).text(item.data[index][field.key]);
                            } else {
                                $(element).val(item.data[index][field.key]);
                            }
                        } else {
                            $(element).val("");
                        }
