...
@section("title")
{{$kasus->judul_kasus}} - Pengkajian Awal Anestesi dan Sedasi - Kasus
@endsection
			...
			<div class="col-lg-9 col-xl-9">
				<div class="block block-bordered">
					<div class="block-content">
						...
						<button type="button" class="btn btn-rounded btn-alt-primary min-width-125 float-right editBtn" data-toggle="modal" data-target="#addModal"><i class="fa fa-pencil"></i> Pengkajian Awal Anestesi dan Sedasi Baru</button>
						@endif
						<h4>Pengkajian Awal Anestesi dan Sedasi</h4>
						<hr>
						@php $count = 1 @endphp
						@forelse($pengkajian_awal_anestesi_dan_sedasi as $item)
						...
						@endif
						<h5 class="mb-5 pl-5">#Pengkajian Awal Anestesi dan Sedasi {{$count++}}</h5>
						<div class="row" id="">
							@include("kasus.asesmen.pengkajian-awal-anestesi-dan-sedasi.hasil")
						</div>
						...
						<div class="text-center py-50">
							<h4 class="font-w400 mb-5">Belum ada asesmen Pengkajian Awal Anestesi dan Sedasi tersedia</h4>
							<p>Klik tombol <b>Pengkajian Awal Anestesi dan Sedasi Baru</b> untuk melakukan asesmen Pengkajian Awal Anestesi dan Sedasi</p>
						</div>
...
@include("kasus.asesmen.pengkajian-awal-anestesi-dan-sedasi.modal")
@endsection

@section("js")
<script src="{{url("")}}/assets/js/plugins/jquery-masked-inputs/jquery.mask.min.js"></script>
<script type="text/javascript">
	var data = JSON.parse({!!json_encode(str_replace("`", "'", $pengkajian_awal_anestesi_dan_sedasi))!!});
