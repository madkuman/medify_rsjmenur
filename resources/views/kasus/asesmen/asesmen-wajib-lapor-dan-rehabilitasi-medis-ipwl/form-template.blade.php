...
<table style="width:100%;">
    <tr>
        <td width = "18%" class=" position-relative" colspan="1" rowspan="1"> <span>Tanggal Kedatangan</span>
        </td>
    ...
    <tr>
        ...
        <td class=" position-relative" colspan="1" rowspan="1">
            <span>{{ $kasus->identitas->jenis_kelamin }}</span> </td>
    </tr>
    <tr>
        <td class=" position-relative" colspan="1" rowspan="1"> <span>Telp/HP</span> </td>
        <td class=" position-relative" colspan="1" rowspan="1"> <span>:</span> </td>
        <td class=" position-relative" colspan="1" rowspan="1"> <span>{{ $kasus->identitas->no_hp }}</span>
        </td>
        <td class=" position-relative" colspan="1" rowspan="1"> </td>
        <td class=" position-relative" colspan="1" rowspan="1"> </td>
        <td class=" position-relative" colspan="1" rowspan="1"> </td>
...
<table style="width: 100%;" class="c-table--bordered">
    <tr>
        ...
        <td class=" position-relative" colspan="5" rowspan="1" style="border-left: none; border-bottom:none;">
            <span>Jenis Cara Penggunaan</span> </td>
    </tr>
    <tr>
        <td class=" position-relative" colspan="5" rowspan="1" style="border-left: none;border-top:none;">
            <span>1. Oral 2. Nasal/sublingual/suppositoria 3. Merokok 4. Injeksi Non 5. IV</span> </td>
    </tr>
    <tr>
