               ...
               <div class="col-8">
                    ...
                    <div class="block mt-5">
                         ...
                         <div class="block-content">
                              @if(session('my_role_'.$kasus->nomor_kasus) && $hasil->created_by == Auth::user()->id)
                              <a class="btn btn-outline-primary pull-right" href="{{url()->current()}}/edit" >Edit</a>
                              <button class="btn btn-outline-danger btnDelete pull-right mr-10" type="button" >Hapus</button>
                              @endif
