    ...
    <div class="bg-black-op-75">
        <div class="content content-full">
            <div class="row gutters-tiny py-20">
                <div class="col-1">
                    <div class="full-only">
                        <img class="img-avatar img-avatar-thumb" src="{{asset($kasus->identitas->avatar_thumb)}}" alt="">
                    </div>
                </div>
                <div class="col-10">
                    ...
                    <h2 class="h5 font-w500 text-white-op mb-0">{{$header->identitas_nama}} {{'#'.$kasus->pasien->no_rm_formatted ?? ''}}</h2>
                    ...
                    <h2 class="h6 font-w400 text-white-op mb-5">Tanggal MRS: {{date('d F Y, H:i', strtotime($kasus->mrs_at))}}
                    </h2>
                    @else
                    <h2 class="h6 font-w400 text-white-op mb-5">Tanggal MRS: {{date('d F Y, H:i', strtotime($kasus->created_at))}}
                    </h2>
                    @endif
