    ...
    if(responseLength){
        ...
        response.forEach(function(kategori){
            ...
            kategori.spesimen.forEach(function(spesimen){
                ...
                formCode += `<div>
                                <label class="css-control css-control-primary css-checkbox spesimen-mk-item">
                                <input type="checkbox" name="spesimen_mikrobiologi[]" value="${spesimen.id}" class="css-control-input spesimen-mk-item-input" data-input-keterangan="${spesimen.input_keterangan}">
