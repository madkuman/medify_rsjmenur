<div id="modal-order-delete" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Konfirmasi Hapus</h5>
            </div>
            <form method="POST" action="{{url('gizi/pemesanan/delete')}}">
                {!! csrf_field() !!}
                <div class="modal-body text-center" id="modal-body">
                    <input type="hidden" id="pemesanan-detail-delete-id" name="pemesanan_detail_id" value="">
                    <input type="hidden" id="kasus-id" name="kasus_id" value={{ $kasus->id }}>
                    <div class="row">
                        <div class="col-12">
