							...
							<div class="form-group row mb-20">
								...
								<div class="col-12">
									<select class="form-control" id="turun_bb" name="turun_bb">
										...
										<option value="2">Tidak Yakin (Skor : 2)</option>
										<option value="1">Ya 1-5 kg (Skor : 1)</option>
										<option value="2">Ya 6-10 kg (Skor : 2)</option>
										<option value="3">Ya 11-15 kg (Skor : 3)</option>
										<option value="4">Ya > 15 kg (Skor : 4)</option>
										<option value="2">Ya, tidak tahu penurunannya (Skor : 2)</option>
									</select>
								</div>
