    ...
    <div class="row">
        <div class="col-lg-12">
            <button type="button" class="btn-alt btn-primary min-width-125 float-right" data-toggle="modal"
                data-target="#modal-create-pemeriksaan"><i class="fa fa-pencil"></i> Buat Surat Keterangan</button>
        </div>
    </div>
    <div class="row">
        @if (count($pemeriksaan) == 0)
            <div class="col-12 text-center py-50">
                <h4 class="font-w400 mb-5">Belum ada surat keterangan</h4><br>
                <p>Klik tombol <b>Surat Keterangan</b> untuk menambahkan Surat Keterangan baru</p>
            </div>
        @endif
