...
<div class="modal fade" id="modal-delete-jiwa{{$key}}" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
            ...
            <div class="block rounded block-transparent mb-0">
                ...
                <div class="form-group row">
                    <div class="col-12 text-center">
                      <form action="{{url('kasus')}}/{{$kasus->nomor_kasus}}/pemeriksaan-spesialis/jiwa/delete" method="post">
                          {{ csrf_field() }}
                          ...
                          <button type="submit" class="btn-alt btn-hero btn-danger min-width-175 float-center">
                              <i class="fa fa-send mr-5"></i> Delete bacaan {{$key+1}}
                          </button>
