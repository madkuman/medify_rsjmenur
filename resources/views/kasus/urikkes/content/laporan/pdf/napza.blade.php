...
<body>
	...
	<table width="100%" class="noBorder">
		...
		<tr>
			...
			<td>:@if($pasien->marriage == 2) Menikah @elseif($pasien->marriage == 3) Duda/Janda @else Single @endif</td>
		</tr>
		<tr>
			<td>Agama</td>
	...
	<div style="padding-right: 50px">
		...
		Surat keterangan Pemeriksaan Napza ini digunakan untuk keperluan <span style="font-weight: 700">{{$keperluan}}</span>
	</div>
	<br>
	<table width="100%" class="noBorder">
		<tr>
	...
	<table width="100%" class="noBorder">
		...
		<tr>
			<td width="35%">&nbsp;</td>
			<td width="50%" class="centered"><div style="white-space: pre"> {!! nl2br($keterangan_ttd) !!}</div></td>
		</tr>
	</table>
</body>
</html>