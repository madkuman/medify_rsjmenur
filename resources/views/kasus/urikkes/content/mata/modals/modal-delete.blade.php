...
<div class="modal fade" id="modal-delete-mata{{$key}}" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
            ...
            <div class="block rounded block-transparent mb-0">
                ...
                <div class="form-group row">
                    <div class="col-12 text-center">
                      <form action="{{url('kasus')}}/{{$kasus->nomor_kasus}}/pemeriksaan-spesialis/mata/delete" method="post">
                          {{ csrf_field() }}
