<script type="text/javascript">
    $('#btn-add-edit-pembayaran-tambahan').click(function() {
        content = `@include('kasus.datamedis.content.identitas.components.select-edit-pembayaran-tambahan', [
            'active_select_pembayaran_tambahan' => 0,
        ])`
    ...
    function syncSEP() {
        var sync_sep = BASE_URL + "bpjs/sep/search/{{ $kasus->active_sep ?? '' }}";
    }
</script>
