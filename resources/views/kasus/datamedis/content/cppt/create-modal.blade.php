<div class="modal fade" id="modal-create-cppt" tabindex="-1" role="dialog" aria-labelledby="modal-fromright"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="block rounded block-transparent mb-0">
                ...
                <div class="block-content">
                    <form class="js-validation-be-contact"
                        action="{{ url('kasus') }}/{{ $nomor_kasus }}/datamedis/cppt/create" method="post"
                        enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="">
                            <div class="">
                                <input type="hidden" class="form-control form-control-lg" id=""
                                    name="nomor-kasus" placeholder="" value="{{ $nomor_kasus }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <textarea class="form-control form-control-lg search-diagnosis" id="cppt-create-a" name="assessment" rows="3"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="file" class="form-control" id="cppt-create-files" name="cppt_files[]"
                                    multiple>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-12 text-center">
                                <button type="submit"
                                    class="btn-alt btn-click-animate btn-hero btn-primary min-width-175 float-right">
