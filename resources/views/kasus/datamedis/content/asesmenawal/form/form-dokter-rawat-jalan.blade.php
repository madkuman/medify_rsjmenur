<style type="text/css">
    #modal-dokter-rawat-jalan{
        padding-right: 0px !important;
    }
</style>
<div class="modal fade" id="modal-dokter-rawat-jalan" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" action="{{url()->current()}}/save">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <input type="hidden" name="jenis" value="Rawat Jalan Dokter">
