<style type="text/css">
    #modal-dokter-rawat-inap{
        padding-right: 0px !important;
    }
</style>
<div class="modal fade" id="modal-dokter-rawat-inap" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" action="{{url()->current()}}/save">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <input type="hidden" name="jenis" value="Rawat Inap Dokter">
