        ...
        <div class="col-lg-12 mb-5">
            ...
            <div class="dropdown float-right">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#modal-dokter-gawat-darurat">
                        <i class="si si-note mr-5"></i> Gawat Darurat
                    </a>
                    <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#modal-dokter-rawat-jalan">
            ...
            <div class="dropdown float-right">
                <button type="button" class="btn-alt btn-rounded btn-primary min-width-125 float-right" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="asesmenlain">
                    <i class="fa fa-angle-down"></i> Asesmen Lainnya
                </button>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="asesmenlain">
                    <a class="dropdown-item" href="{{url('kasus')}}/{{$kasus->nomor_kasus}}/asesmen/pengkajian-awal-pasien-terminal" target="_blank">
...
<form method="POST" action="{{url('')}}/kasus/{{$kasus->nomor_kasus}}/datamedis/cppt/delete" id="formDeleteRapt">
    {{csrf_field()}}
