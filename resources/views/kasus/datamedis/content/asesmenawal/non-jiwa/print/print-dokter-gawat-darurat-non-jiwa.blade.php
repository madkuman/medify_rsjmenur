...
<html>
<head>
	<title>ASESMEN AWAL GAWAT DARURAT - NON JIWA</title>
	<style type="text/css">
		table{
...
<body>
	...
	<table style="margin-top: 10px; border-collapse: separate;">
		<tr>
			<td width="45%" class="big" style="border: 2px solid black">
				ASESMEN AWAL GAWAT DARURAT - NON JIWA
			</td>
	...
	<table width="100%" class="content">
		...
		<tr class="submenu">
			<td colspan="2" class="align-top border-bottom"><b>VITAL SIGN</b></td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Tekanan Darah / TD</td>
			<td class="align-top border-bottom">: {{$asesmen->vital_td_sistol ?? '-'}} / {{$asesmen->vital_td_diastol ?? '-'}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Nadi / N</td>
			<td class="align-top border-bottom">: {{$asesmen->vital_nadi ?? '-'}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Suhu / T</td>
			<td class="align-top border-bottom">: {{$asesmen->vital_suhu ?? '-'}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Frekuensi Nafas / RR</td>
			<td class="align-top border-bottom">: {{$asesmen->vital_frekuensi_nafas ?? '-'}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">O2 (lpm)</td>
			<td class="align-top border-bottom">: {{$asesmen->vital_o2 ?? '-'}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">SpO2</td>
			<td class="align-top border-bottom">: {{$asesmen->vital_spo2 ?? '-'}}</td>
		</tr>
	</table>
	<br>
	<table width="100%" class="content">
		...
		<tr>
			...
			<td class="centered">
				@if(!empty($asesmen_get->created_by))
					@php
						$nama = \App\User::find($asesmen_get->created_by)->name ?? null;
