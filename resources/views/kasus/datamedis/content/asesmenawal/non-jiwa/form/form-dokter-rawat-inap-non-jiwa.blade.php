<style type="text/css">
    #modal-dokter-rawat-inap-non-jiwa{
        padding-right: 0px !important;
    }
</style>
<div class="modal fade" id="modal-dokter-rawat-inap-non-jiwa" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
            ...
            <form method="POST" action="{{url('')}}/kasus/{{$kasus->nomor_kasus}}/asesmen/asesmen-awal-dokter-non-jiwa/save">
                <div class="block block-themed block-transparent mb-0">
                    <div class="block-header">
                        <h3 class="block-title">Asesmen Awal Rawat Inap - Non Jiwa</h3>
                    ...
                    <input type="hidden" name="jenis" value="Rawat Inap Dokter Non Jiwa">
