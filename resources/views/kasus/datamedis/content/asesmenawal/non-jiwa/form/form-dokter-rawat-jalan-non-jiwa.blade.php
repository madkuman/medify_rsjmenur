<style type="text/css">
    #modal-dokter-rawat-jalan-non-jiwa{
        padding-right: 0px !important;
    }
</style>
<div class="modal fade" id="modal-dokter-rawat-jalan-non-jiwa" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
            ...
            <form method="POST" action="{{url('')}}/kasus/{{$kasus->nomor_kasus}}/asesmen/asesmen-awal-dokter-non-jiwa/save">
                <div class="block block-themed block-transparent mb-0">
                    <div class="block-header">
                        <h3 class="block-title">Asesmen Awal Rawat Jalan - Non Jiwa</h3>
                    ...
                    <input type="hidden" name="jenis" value="Rawat Jalan Dokter Non Jiwa">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="col-6">
                                        <input type="number" class="form-control form-control-lg"  name="vital_td_sistol">
                                        <small>Sistol</small>
                                    </div>
                                    <div class="col-6">
                                        <input type="number" class="form-control form-control-lg"  name="vital_td_diastol">
                                        <small>Diastol</small>
                                    </div>
                                </div>  
                            </div>
