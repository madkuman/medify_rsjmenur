	...
	<div class="col-md-6">
		<table width="100%">
			...
			<tr>
				...
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['gizi_anak_tampak_kurus'] ?? '-'}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Ada penurunan BB dalam 1 bulan terakhir</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['gizi_ada_turun_bb_1_bln'] ?? '-'}}</td>
			</tr>
			<tr>
				...
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['gizi_ada_salah_satu_kondisi'] ?? '-'}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Ada penyakit / keadaan yang mengakibatkan malnutrisi</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['gizi_ada_penyakit_malnutrisi'] ?? '-'}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Skor</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['gizi_skor_akhir'] ?? '-'}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Resiko</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['gizi_hasil_resiko'] ?? '-'}}</td>
			</tr>
			@else
			<tr>
				<td class="align-top border-bottom">Penurunan Berat Badan 6 Bulan Terakhir</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['gizi_enam_bulan'] ?? '-'}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Asupan Makan Pasien</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['gizi_asupan'] ?? '-'}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Pasien dengan kondisi khusus</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['pasien_kondisi_khusus'] ?? '-'}}</td>
			</tr>
			@endif
