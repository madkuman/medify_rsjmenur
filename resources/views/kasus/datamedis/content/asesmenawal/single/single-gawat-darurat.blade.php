...
<tr>
	...
	<tr>
			...
			<tr>
				<td class="align-top border-bottom">Tanggal selesai pengkajian triage</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['tanggal_selesai_pengkajian_triage'] ?? '-'}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Jam selesai pengkajian triage</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['jam_selesai_pengkajian_triage'] ?? '-'}}</td>
			</tr>
			<tr>
	...
	<div class="col-md-6">
		<table width="100%">
			...
			<tr>
				...
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['gizi_asupan_skor'] + $item['gizi_enam_bulan_skor']}}</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" class="align-top border-bottom"><b>DIAGNOSA KEPERAWATAN INTENSIF</b></td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Intensif</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['intensif'] ?? '-') !!}</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="align-top border-bottom" colspan="3">
					<table width="100%">
						<tr>
							<td width="15%"><b><u>Jam</u></b></td>
							<td width="85%"><b><u>Tindakan</u></b></td>
						</tr>
						@php if(isset($item['tindakan_implementasi_keperawatan_array'])) $tindakan = json_decode($item['tindakan_implementasi_keperawatan_array']) @endphp
						@if(isset($tindakan))
						@foreach($tindakan as $tindakans)
						<tr>
							<td>{{$tindakans->jam_implementasi_keperawatan ?? '-'}}</td>
							<td>{{$tindakans->tindakan_implementasi_keperawatan_array ?? '-'}}</td>
						</tr>
						@endforeach
						@endif
					</table>
