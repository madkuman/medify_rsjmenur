<div class="row">
	<div class="col-md-6">
		<table width="100%">
			...
			<tr>
				<td class="align-top border-bottom">Ruangan</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['ruangan'] ?? '-'}}</td>
			</tr>
			<tr>
	...
	<div class="col-md-6">
		<table width="100%">
			...
			<tr>
				...
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_tanggal_risiko_jatuh']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Jam</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_jam_risiko_jatuh']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Usia</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_usia']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Status Mental</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_status_mental']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Eliminasi</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_eliminasi']}}</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" class="align-top border-bottom">{{$item['edmonson_pengobatan_tanpa'] == '1' ? "✔" : "❌"}} Tanpa obat-obatan</td>
			</tr>
			<tr>
				<td colspan="3" class="align-top border-bottom">{{$item['edmonson_pengobatan_jantung'] == '1' ? "✔" : "❌"}} Obat-obatan jantung</td>
			</tr>
			<tr>
				<td colspan="3" class="align-top border-bottom">{{$item['edmonson_pengobatan_psikotoprik'] == '1' ? "✔" : "❌"}} Obat-obatan psikotropik (termasuk benzodiazepin dan antidepresan)</td>
			</tr>
			<tr>
				<td colspan="3" class="align-top border-bottom">{{$item['edmonson_pengobatan_tambahan'] == '1' ? "✔" : "❌"}} Mendapat tambahan obat-obatan PRN (psikiatri, anti nyeri) yang diberikan dalam 24 jam terakhir</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" class="align-top border-bottom">{{$item['edmonson_diagnosa_bipolar'] == '1' ? "✔" : "❌"}} Bipolar / Gangguan schizoaffective (F 31 / F25)</td>
			</tr>
			<tr>
				<td colspan="3" class="align-top border-bottom">{{$item['edmonson_diagnosa_obat'] == '1' ? "✔" : "❌"}} Penggunaan obat-obatan terlarang / ketergantungan alkohol (F 10 - F 19)</td>
			</tr>
			<tr>
				<td colspan="3" class="align-top border-bottom">{{$item['edmonson_diagnosa_gangguan'] == '1' ? "✔" : "❌"}} Gangguan depresi mayor (F 32.2; F32.3)</td>
			</tr>
			<tr>
				<td colspan="3" class="align-top border-bottom">{{$item['edmonson_diagnosa_demensia'] == '1' ? "✔" : "❌"}} Demensia / delirium ( F 00 - F 03; F 05)</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Ambulasi</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_ambulasi']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Nutrisi</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_nutrisi']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Gangguan Pola Tidur</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_gangguan_pola_tidur']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Riwayat Jatuh</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_riwayat_jatuh']}}</td>
			</tr>
			<tr>
				...
				<td class="align-top border-bottom">
					<b>
						{{ $item['edmonson_usia_skor'] +
						$item['edmonson_status_mental_skor'] +
						$item['edmonson_eliminasi_skor'] +
						$item['edmonson_pengobatan_tanpa_skor'] +
						$item['edmonson_pengobatan_jantung_skor'] +
						$item['edmonson_pengobatan_psikotoprik_skor'] +
						$item['edmonson_pengobatan_tambahan_skor'] +
						$item['edmonson_diagnosa_bipolar_skor'] +
						$item['edmonson_diagnosa_obat_skor'] +
						$item['edmonson_diagnosa_gangguan_skor'] +
						$item['edmonson_diagnosa_demensia_skor'] +
						$item['edmonson_ambulasi_skor'] +
						$item['edmonson_nutrisi_skor'] +
						$item['edmonson_gangguan_pola_tidur_skor'] +
						$item['edmonson_riwayat_jatuh_skor'] }}
					</b>
				</td>
			</tr>
			<tr>
				<td colspan="3" class="align-top border-bottom"><b>TINDAKAN RESIKO JATUH</b></td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Tanggal</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_tanggal_pasien']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Jam</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_jam_pasien']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Pasang stiker warna kuning di gelang identitas</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_pasang_stiker_warna_kuning']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Tempelkan stiker warna kuning di RM pasien</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_tempelkan_stiker_warna_kuning']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Pakaikan baju dengan penanda "fall risk"</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_pakaikan_baju_dengan_penanda']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Pakaikan sprei dengan penanda "fall risk"</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_pakaikan_sprei_dengan_penanda']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Motivasi keluarga untuk menunggu pasien</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_motivasi_keluarga']}}</td>
			</tr>
			<tr>
				...
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_tempatkan_pasien_dekat_nurse_station']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Lakukan pemasangan fiksasi fisik apabila diperlukan dengan persetujuan keluarga</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_lakukan_pemasangan_fiksasi_fisil']}}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Orientasikan pasien / penunggu tentang lingkungan / ruangan</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{{$item['edmonson_orientasikan_pasien']}}</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" class="align-top border-bottom"><b>DIAGNOSA KEPERAWATAN JIWA</b></td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Perilaku Kekerasan</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['perilaku_kekerasan'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Halusinasi</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['halusinasi'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Waham</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['waham'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Risiko Bunuh Diri</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['risiko_bunuh_diri'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Panik</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['panik'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Putus Dzat</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['putus_dzat'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Over Dosis</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['overdosis'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Kerusakan Komunikasi Verbal</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['kerusakan_komunikasi_verbal'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Defisit Perawatan Diri</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['defisit_perawatan_diri'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Intoleransi Aktivitas</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['intoleransi_aktivitas'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Isolasi Sosial</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['isolasi_sosial'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Diagnosa Keperawatan Lainnya</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['diagnosa_keperawatan_lainnya'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td colspan="3" class="align-top border-bottom"><b>DIAGNOSA KEPERAWATAN NON JIWA</b></td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Bersihan Jalan Nafas Tidak Efektif</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['bersihan_jalan_nafas_tidak_efektif'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Pola Nafas Tidak Efektif</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['pola_nafas_tidak_efektif'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Hipertermia</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['hipertermia'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Defisit Volume Cairan</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['defisit_volume_cairan'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Nyeri Akut</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['nyeri_akut'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Kerusakan Integritas Kulit</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['kerusakan_integritas_kulit'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Kelebihan Volume Cairan</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['kelebihan_volume_cairan'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Risiko Infeksi</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['risiko_infeksi'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Perfusi Jaringan Cerebral Tidak Efektif</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['perfusi_jaringan_cerebral_tidak_efektif'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Gangguan Mobilitas Fisik</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['gangguan_mobilitas_fisik'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Diagnosa Keperawatan Non Jiwa Lainnya</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['diagnosa_non_jiwa_keperawatan_lainnya'] ?? '-') !!}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['tindakan_implementasi_keperawatan'] ?? '-') !!}</td>
			</tr>
			<tr>
				<td class="align-top border-bottom">Evaluasi implementasi keperawatan</td>
				<td class="align-top border-bottom">:</td>
				<td class="align-top border-bottom">{!! nl2br($item['evaluasi_implementasi_keperawatan'] ?? '-') !!}</td>
			</tr>
		</table>
	</div>
</div>
