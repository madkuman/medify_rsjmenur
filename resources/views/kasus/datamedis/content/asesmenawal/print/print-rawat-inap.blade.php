...
<html>
<head>
	<title>ASESMEN AWAL RAWAT INAP</title>
	<style type="text/css">
		table{
...
<body>
	...
	<table class="bordered" style="border-collapse: separate; margin-bottom: 10px;">
		<tr>
			<td width="25%" class="centered box"><b>ALERGI: </b><br> {{$asesmen['alergi'] ?? '-'}}
			</td>
			<td width="25%" class="centered box"><b>RISIKO: </b><br> {{$asesmen['risiko'] ?? '-'}}
			</td>
			<td width="25%" class="centered box"><b>RUANGAN: </b><br> {{$asesmen['ruangan'] ?? '-'}}
			</td>
			<td width="25%" class="centered box"><b>TANGGAL DAN JAM: </b><br> {{$asesmen['tanggal_datang'] ?? '-'}}, {{$asesmen['jam_datang'] ?? '-'}}
			</td>
		</tr>
	</table>
	...
	<table width="100%" class="content">
		...
		<tr>
			...
			<td class="align-top border-bottom">: {{$asesmen['edmonson_tanggal_risiko_jatuh']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Jam</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_jam_risiko_jatuh']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Usia</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_usia']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Status Mental</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_status_mental']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Eliminasi</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_eliminasi']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Pengobatan</td>
			<td class="align-top border-bottom">: </td>
		</tr>
		<tr class="{{$asesmen['edmonson_pengobatan_tanpa'] == '1' ? '' : 'd-none'}}">
			<td colspan="2" class="align-top border-bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="check">4</b> Tanpa obat-obatan</td>
		</tr>
		<tr class="{{$asesmen['edmonson_pengobatan_jantung'] == '1' ? '' : 'd-none'}}">
			<td colspan="2" class="align-top border-bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="check">4</b> Obat-obatan jantung</td>
		</tr>
		<tr class="{{$asesmen['edmonson_pengobatan_psikotoprik'] == '1' ? '' : 'd-none'}}">
			<td colspan="2" class="align-top border-bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="check">4</b> Obat-obatan psikotropik (termasuk benzodiazepin dan antidepresan)</td>
		</tr>
		<tr class="{{$asesmen['edmonson_pengobatan_tambahan'] == '1' ? '' : 'd-none'}}">
			<td colspan="2" class="align-top border-bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="check">4</b> Mendapat tambahan obat PRN (psikiatri, anti nyeri) yang diberikan dalam 24 jam terakhir</td>
		</tr>		
		<tr>
			<td class="align-top border-bottom">Diagnosa</td>
			<td class="align-top border-bottom">: </td>
		</tr>
		<tr class="{{$asesmen['edmonson_diagnosa_bipolar'] == '1' ? '' : 'd-none'}}">
			<td colspan="2" class="align-top border-bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="check">4</b> Bipolar / Gangguan schizoaffective (F 31 / F25)</td>
		</tr>
		<tr class="{{$asesmen['edmonson_diagnosa_obat'] == '1' ? '' : 'd-none'}}">
			<td colspan="2" class="align-top border-bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="check">4</b> Penggunaan obat-obatan terlarang / ketergantungan alkohol (F 10 - F 19)</td>
		</tr>
		<tr class="{{$asesmen['edmonson_diagnosa_gangguan'] == '1' ? '' : 'd-none'}}">
			<td colspan="2" class="align-top border-bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="check">4</b> Gangguan depresi mayor (F 32.2; F32.3)</td>
		</tr>
		<tr class="{{$asesmen['edmonson_diagnosa_demensia'] == '1' ? '' : 'd-none'}}">
			<td colspan="2" class="align-top border-bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="check">4</b> Demensia / delirium ( F 00 - F 03; F 05)</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Ambulasi</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_ambulasi']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Nutrisi</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_nutrisi']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Gangguan Pola Tidur</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_gangguan_pola_tidur']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Riwayat Jatuh</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_riwayat_jatuh']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom"><b>Total Skor</b></td>
			<td class="align-top border-bottom">: 
				<b>
					{{ $asesmen['edmonson_usia_skor'] +
					$asesmen['edmonson_status_mental_skor'] +
					$asesmen['edmonson_eliminasi_skor'] +
					$asesmen['edmonson_pengobatan_tanpa_skor'] +
					$asesmen['edmonson_pengobatan_jantung_skor'] +
					$asesmen['edmonson_pengobatan_psikotoprik_skor'] +
					$asesmen['edmonson_pengobatan_tambahan_skor'] +
					$asesmen['edmonson_diagnosa_bipolar_skor'] +
					$asesmen['edmonson_diagnosa_obat_skor'] +
					$asesmen['edmonson_diagnosa_gangguan_skor'] +
					$asesmen['edmonson_diagnosa_demensia_skor'] +
					$asesmen['edmonson_ambulasi_skor'] +
					$asesmen['edmonson_nutrisi_skor'] +
					$asesmen['edmonson_gangguan_pola_tidur_skor'] +
					$asesmen['edmonson_riwayat_jatuh_skor'] }}
				</b>
			</td>
		</tr>
	</table>
	...
	<table width="100%" class="content">
		...
		<tr class="submenu">
			<td colspan="2" class="align-top border-bottom"><b>TINDAKAN RESIKO JATUH</b></td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Tanggal</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_tanggal_pasien']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Jam</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_jam_pasien']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Pasang stiker warna kuning di gelang identitas</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_pasang_stiker_warna_kuning']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Tempelkan stiker warna kuning di RM pasien</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_tempelkan_stiker_warna_kuning']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Pakaikan baju dengan penanda "fall risk"</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_pakaikan_baju_dengan_penanda']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Pakaikan sprei dengan penanda "fall risk"</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_pakaikan_sprei_dengan_penanda']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Motivasi keluarga untuk menunggu pasien</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_motivasi_keluarga']}}</td>
		</tr>
		<tr>
			...
			<td class="align-top border-bottom">: {{$asesmen['edmonson_tempatkan_pasien_dekat_nurse_station']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Lakukan pemasangan fiksasi fisik apabila diperlukan dengan persetujuan keluarga</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_lakukan_pemasangan_fiksasi_fisil']}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Orientasikan pasien / penunggu tentang lingkungan / ruangan</td>
			<td class="align-top border-bottom">: {{$asesmen['edmonson_orientasikan_pasien']}}</td>
		</tr>
	</table>
	<br>
	<table width="100%" class="content">
	...
	<table width="100%" class="content">
		...
		<tr class="submenu">
			<td colspan="2" class="align-top border-bottom"><b>IMPLEMENTASI KEPERAWATAN</b></td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Tanggal jam implementasi</td>
			<td class="align-top border-bottom">: {{$asesmen['tanggal_jam_implementasi_keperawatan'] ?? '-'}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Tindakan implementasi</td>
			<td class="align-top border-bottom">: {!! nl2br($asesmen['tindakan_implementasi_keperawatan'] ?? '-') !!}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Evaluasi implementasi</td>
			<td class="align-top border-bottom">: {!! nl2br($asesmen['evaluasi_implementasi_keperawatan'] ?? '-') !!}</td>
		</tr>
	</table>
	<br><br>
	<table width="100%">
