...
<body>
	...
	<table width="100%" class="content">
		...
		<tr>
			...
			<td class="align-top border-bottom">: {{$asesmen['tindakan_implementasi_keperawatan'] ?? '-'}}</td>
		</tr>
		<tr>
			<td class="align-top border-bottom">Evaluasi implementasi</td>
			<td class="align-top border-bottom">: {{$asesmen['evaluasi_implementasi_keperawatan'] ?? '-'}}</td>
		</tr>
	</table>
	<br><br>
	<table width="100%">
