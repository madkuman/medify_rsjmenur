    ...
    <div class="modal-dialog modal-dialog-fromright modal-dialog modal-full" role="document" style="min-width: 100%; margin: 0;">
        <div class="modal-content">
            <div class="block rounded block-transparent mb-0">
                ...
                <form class="js-validation-be-contact" action="{{url('kasus')}}/{{ $nomor_kasus }}/datamedis/tindakan/create-manual" method="post">
                    {{ csrf_field() }}
                    <input type="hidden" name="kasus_id" value="{{$kasus->id}}">
                    <input type="hidden" name="lokasi" value="{{$kasus->lokasi->lokasi_id}}">
                    <input type="hidden" name="kategori_id" id="tagihanCreateKategoriIDManual" value="{{$kasus->lokasi->lokasi->kategori_keuangan_id}}">
                    <div class="row">
                        <div class="col-md-6">
