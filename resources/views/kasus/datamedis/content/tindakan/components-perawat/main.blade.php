<div id="create-modal-content-perawat">
    ...
    <div class="row">
        <div class="col-lg-3 col-md-12 col-xs-12 perawat-class">
            ...
            <div class="form-group">
                <select class="form-control" id="tipe_tarif" name="tipe_tarif" required="">
        ...
        <div class="col-lg-9 col-md-12 col-xs-12 perawat-class">
            <div class="row">
                ...
                <div class="col-12">
                    <input type="text" class="form-control form-control-lg"   placeholder="Deskripsi Tindakan" id="tindakan-perawat" autocomplete="off">
        ...
        <div class="col-12 form-group">
            <small>Menampilkan <span id="perawat-total-hasil"></span> Hasil Pencarian</small>
        </div>
    </div>

    <div class="top-tindakan" id="top-tindakan">
        ...
        <div class="form-group" data-toggle="slimscroll" data-height="350px" data-always-visible="true"  data-size="8px">
            <div class="hasil-pencarian hide" id="hasil-pencarian">
            </div>
            <div class="pt-100 text-center " id="loading-tindakan-perawat-search">
                <span class="fa fa-4x fa-spinner fa-spin text-primary text-center loader"></span>
            </div>
            <div class="block-content hasil-pencarian text-center pt-100" id="hasil-pencarian-empty">
                <h4 class="mb-10">Tidak Ditemukan untuk Keyword "<span id="create-tindakan-perawat-keyword"></span>" dan tipe tarif "<span id="create-tindakan-perawat-tipe"></span>"</h4>
