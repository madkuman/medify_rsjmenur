        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="block-content">
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ url('kasus') }}/{{ $nomor_kasus }}/datamedis/resep/create"
                                id="form_create_resep" method="post" class="main-form-container">
                                {{ csrf_field() }}
                                ...
                                <input type="hidden" id="metode_pembayaran" name="metode_pembayaran"
                                    value="{{ $kasus->pasien_pembayaran_id }}">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="nama-apotek" name="nama-apotek"
                                                required="">
                                                <option value="" disabled="" selected="">Pilih Tujuan
                                                    Farmasi</option>
                                                @foreach ($pharmacies as $pharmacy)
                                                    @if ($pharmacy->jenis_detail->nama == 'Gudang')
                                                        @continue
                                                    @endif
                                                    <option value="{{ $pharmacy->id }}"
                                                        data-slug="{{ $pharmacy->slug }}"
                                                        @if ($autoselect_id == $pharmacy->id) selected 
                                        @php $autoselect_farmasi = true; @endphp @endif>
                                                        {{ $pharmacy->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-8">
                                        <label class="css-control css-control-primary css-checkbox">
                                            <input type="checkbox" name="kirim-farmasi" id="resepKirimFarmasiCheck"
                                                class="css-control-input" checked>
                                            <span class="css-control-indicator"></span> Kirimkan permintaan ke farmasi
                                            tersebut.
                                        </label>
                                    </div>
                                    <div class="col-4">
                                ...
                                <div id="form-resep" @if (!$autoselect_farmasi) style="display: none;" @endif>
                                    @if ($user->profesi != 1)
                                        <div class="row">
                                            <div class="col-12">
                                                @include(
                                                    'kasus.datamedis.content.resep.components.dokter-create',
                                                    ['id_radio' => 'dokter']
                                                )
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-9">
                                            <div class="form-group">
                                                <label>Paket Obat</label><i class="fa fa-spin fa-spinner"
                                                    id="loading-paket"></i>
                                                <br>
                                                <select class="form-control js-select2" id="selectPaket"
                                                    data-width="100%">
                                    ...
                                    <div class="row">
                                        <div class="col-9">
                                            @if (config('app.fitur_kasus_resep_kategori'))
                                                ...
                                                <div id="container-kategori-resep-dispensing_aseptik"
                                                    style="display: none">
                                            ...
                                            @else
                                                @include('kasus.datamedis.content.resep.components.form', [
                                                    'extra_id' => '',
                                                ])
                                            @endif
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12 text-center">
                                            <label
                                                class="css-control css-control-primary css-checkbox div-override-checkbox">
                                                <input type="checkbox" class="override-checkbox css-control-input" />
                                                <span class="css-control-indicator"></span> <strong>Abaikan
                                                    Peringatan</strong>
                                            </label>
                                        </div>
                                        <div class="col-12 text-center">
                                            <button type="submit" id=""
                                                class="btn submit-resep btn-click-animate btn-hero btn-alt-primary min-width-175">
