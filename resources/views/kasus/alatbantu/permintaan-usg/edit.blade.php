        ...
        <div class="modal-content" >
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header ">
                    <h3 class="block-title">Edit Form Permintaan Pemeriksaan Ultrasonografi</h3>
                        ...
                        <div class="col-md-12">
                            <form method="POST" action="" id="form-edit">
                                ...
                                <div class="form-group  mb-20">
                                    ...
                                    <textarea class="form-control" id="edit_tujuan" name="tujuan" rows="3"></textarea>
                                </div>
                                <div class="form-group  mb-20">
                                    <label class=" mb-5">Hasil</label>
                                    <textarea class="form-control" id="edit_hasil" name="hasil" rows="3"></textarea>
                                </div>
