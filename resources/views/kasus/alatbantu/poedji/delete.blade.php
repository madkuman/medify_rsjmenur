<div class="modal fade" id="poedjiModalDelete" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fromright modal-dialog" role="document">
        <div class="modal-content">
            <div class="block rounded block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">Poedji Rochjati <span id="title-number"></span></h3>
                ...
                <div class="block-content">
                    <form class="js-validation-be-contact" action="{{url()->current()}}/delete" method="post">
                        ...
                        <input type="hidden" class="form-control form-control-lg" id="poedjiDeleteID" name="id">
                        <h5 class="font-w400">
                            Apakah anda yakin akan menghapus data skor poedji ini?
                        </h5>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                ...
                                <button type="submit" class="btn-alt btn-click-animate btn-hero btn-primary min-width-100 float-right">
                                    <i class="fa fa-send mr-5"></i> Hapus Skor
                                </button>
                            </div>
                        </div>
