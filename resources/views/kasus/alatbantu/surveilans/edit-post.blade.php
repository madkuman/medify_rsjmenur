					...
					<div class="block-content row">
						...
						<div class="col-md-4 col-12">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="hari_ke" autocomplete="off" id="hari_ke">
								</div>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="rawat_luka" id="rawat_luka">
									<span class="css-control-indicator"></span> Rawat Luka
								</label>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="dressing_transparan" id="dressing_transparan">
									<span class="css-control-indicator"></span> Dressing Transparan
								</label>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="dressing_hypavix" id="dressing_hypavix">
									<span class="css-control-indicator"></span> Dressing Hypavix
								</label>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="buang_cairan" id="buang_cairan">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<select class="form-control" id="aff_drain" name="aff_drain" id="aff_drain">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="angkat_jahitan" id="angkat_jahitan">
									<span class="css-control-indicator"></span> Angkat Jahitan
								</label>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="antibiotik_post" id="antibiotik_post">
									<span class="css-control-indicator"></span> Antibiotik
								</label>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="krs" id="krs">
									<span class="css-control-indicator"></span> KRS
								</label>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="kontrol_poli" id="kontrol_poli">
									<span class="css-control-indicator"></span> Kontrol Poli
								</label>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="infeksi" id="infeksi">
						...
						<div class="col-md-4 col-12 infeksi-content" style="display: none">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<select class="form-control jenis_lokasi_infeksi" id="jenis_lokasi_infeksi" name="jenis_lokasi_infeksi" id="jenis_lokasi_infeksi">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<select class="form-control" id="lokasi_spesifik_infeksi" name="lokasi_spesifik_infeksi" id="lokasi_spesifik_infeksi">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="lokasi_spesifik_infeksi_lain2" autocomplete="off" id="lokasi_spesifik_infeksi">
								</div>
							</div>
						</div>
						<div class="col-md-4 col-12 infeksi-content" style="display: none">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="dx_dokter" id="dx_dokter">
