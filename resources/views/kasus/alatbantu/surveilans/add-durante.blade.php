<div class="modal" id="addModalDurante" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-fullscreen">
		<form action="{{url()->current()}}/create" method="POST">
			<div class="modal-content" >
				<div class="block block-themed block-transparent mb-0">
					<div class="block-header ">
						<h3 class="block-title">Form Pengumpulan Data Surveilans Infeksi Luka Operasi - Durante Operasi</h3>
					...
					<div class="block-content row">
						...
						<div class="col-md-4 col-12">
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="js-datepicker form-control" autocomplete="off" name="tgl_mrs" data-week-start="1" data-autoclose="true" data-date-format="dd/mm/yy" value="">
								</div>
							</div>
							<div class="form-group row mb-5">
								<label class="col-12" for="tgl_operasi">Tanggal Operasi</label>
								<div class="col-12">
									<input type="text" class="js-datepicker form-control" autocomplete="off" name="tgl_operasi" data-week-start="1" data-autoclose="true" data-date-format="dd/mm/yy" value="">
								</div>
							</div>
							<div class="form-group row mb-5">
								<label class="col-12" for="lama_operasi">Lama Operasi</label>
								<div class="col-12">
									<input type="text" name="lama_operasi" class="form-control time" placeholder="hh:mm" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="bb" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="kualifikasi_lain2" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="prosedur_lain2" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
								<label class="col-12" for="diagnosa">Diagnosa</label>
								<div class="col-12">
									<input type="text" class="form-control" name="diagnosa" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
						...
						<div class="col-md-4 col-12">
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="sirkulasi" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
								<label class="col-12" for="air_count">Air Count OT</label>
								<div class="col-12">
									<input type="text" class="form-control" name="air_count" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
								<label class="col-12" for="kelembaban">Kelembaban Ruang OT</label>
								<div class="col-12">
									<input type="text" class="form-control" name="kelembaban" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="jenis_drain" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
								<label class="col-12" for="suhu_ruang">Suhu Ruang (&#176;C)</label>
								<div class="col-12">
									<input type="text" class="form-control" name="suhu_ruang" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="jenis_implant" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="obat_antibiotik" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
								<label class="col-12" for="dosis_antibiotik">Dosis</label>
								<div class="col-12">
									<input type="text" class="form-control" name="dosis_antibiotik" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
								<label class="col-12" for="jam_antibiotik">Diberikan jam</label>
								<div class="col-12">
									<input type="text" class="form-control time" placeholder="hh:mm" name="jam_antibiotik" autocomplete="off">
								</div>
							</div>
						...
						<div class="col-md-4 col-12">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="chlorhexidine">
									<span class="css-control-indicator"></span> Chlorhexidine
								</label>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="povidone_iodine">
									<span class="css-control-indicator"></span> Povidone Iodine
								</label>
							</div>
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									<input type="checkbox" class="css-control-input" name="alkohol_70">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="disinfeksi_lain" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
								<label class="col-12" for="staff">Jumlah Staff</label>
								<div class="col-12">
									<input type="text" class="form-control" name="staff" autocomplete="off">
								</div>
							</div>
							<div class="form-group row mb-5">
							...
							<div class="form-group row mb-5">
								...
								<div class="col-12">
									<input type="text" class="form-control" name="dosis_profilaksis" autocomplete="off" id="dosis_profilaksi">
								</div>
							</div>
							<div class="form-group row mb-5">
