		...
		<div class="modal-content" >
			<div class="block block-themed block-transparent mb-0">
				<div class="block-header ">
					<h3 class="block-title">Eliminasi Defekasi</h3>
				...
				<div class="block-content row">
					<div class="col-md-12">
						<form action="{{url()->current()}}/create" method="POST">
							...
							<tr>
								<th>Status Defikasi</th>
								<td>
									<label class="mews-item" id="normal">
										<input type="radio" name="defekasi" checked="" />
										<div>Normal</div>
									</label>
								</td>
								<td>
									<label class="mews-item" id="tidak-normal">
										<input type="radio" name="defekasi" />
							...
							<tr>
								<td></td>
								<td id="defekasi-ket" style="display:none;" colspan="2">
							...
							<tr>
								...
								<td>
									<label>
										<input type="text" name="konsistensi" class="form-control">
									</label>
								</td>
							</tr>
							<tr>
