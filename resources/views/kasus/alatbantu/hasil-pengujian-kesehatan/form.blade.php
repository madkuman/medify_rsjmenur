...
<table style="width:100%">
    <tr>
        <td class="position-relative" colspan="1" rowspan="1">
            <h5 style="text-align: center; padding: 20px 0px">HASIL PENGUJIAN KESEHATAN</h5>
        </td>
    </tr>
</table>
<table style="width:100%">
    <tr>
        ...
        <td> / 4 / 102.8 / {{ date('Y') }}</td>
    </tr>
</table>
<table style="width: 100%">
    <tr>
        <td>
            <h6>Tim Penguji Kesehatan Pegawai Negeri Sipil di RS Jiwa Menur Provinsi Jawa Timur yang ditetapkan
                berdasarkan Keputusan Menteri Kesehatan Republik Indonesia Nomor HK.01.07/MENKES/119/2025 tanggal 24
                Februari 2025, menerangkan bahwa:</h6>
        </td>
    </tr>
</table>
<table style="width: 100%">
    ...
    <tr>
        ...
        <td class="position-relative" colspan="1" rowspan="1">
            <textarea name="alamat"
                class="form-control">{{ ucwords(strtolower($kasus->pasien->address)) }}, Kel. {{ ucwords(strtolower($kasus->pasien->alamat_kelurahan->nama)) }}, Kec. {{ ucwords(strtolower($kasus->pasien->alamat_kecamatan->nama)) }}, {{ ucwords(strtolower($kasus->pasien->alamat_kota->nama)) }}</textarea>
        </td>
    </tr>
    <tr>
