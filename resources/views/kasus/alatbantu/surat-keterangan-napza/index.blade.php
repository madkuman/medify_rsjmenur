...
@section('title')
    {{ $kasus->judul_kasus }} - Surat Keterangan Pemeriksaan Napza
@endsection
...
@section('content')
    <main id="main-container">
                        ...
                        <div class="block-content">
                            @if (session('my_role_' . $kasus->nomor_kasus))
                                <button id="create-btn" type="button"
                                    ...
                                    <i class="fa fa-pencil"></i> Surat Keterangan Pemeriksaan Napza Baru
                                </button>
                                <h4>Surat Keterangan Pemeriksaan Napza</h4>
                                <hr>
                            @endif
                            ...
                            @forelse ($alat_bantu as $item)
                                ...
                                @endif
                                <h5 class="mb-5 pl-5">#Surat Keterangan Pemeriksaan Napza {{ $loop->iteration }}</h5>
                                <div class="row">
                                    <div class="col-6">
                            ...
                            @empty
                                <div class="text-center py-50">
                                    <h4 class="font-w400 mb-5">Belum ada Surat Keterangan Pemeriksaan Napza tersedia
                                    </h4>
                                    <p>Klik tombol <strong>Surat Keterangan Pemeriksaan Napza Baru</strong> untuk melakukan
                                        pembuatan Surat Keterangan Pemeriksaan Napza Baru</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
                    ...
                    <form id="create-edit-form" method="POST" action="#">
                        ...
                        <div class="block block-themed block-transparent mb-0">
                            ...
                            <div id="create-edit-modal-content" class="block-content"
                                ...
                                @include('kasus.alatbantu.surat-keterangan-napza.form')
                            </div>
                        </div>
        ...
        {{-- ./Modal Surat Keterangan Pemeriksaan Napza Baru --}}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            function setValueForFormEdit(value) {
                ...
                $("input[name=metamphethamine]").is(":checked");
                $("input[name=amphetamine]").is(":checked");
                $("input[name=morphine_heroin]").is(":checked");
                $("input[name=mariyuana_thc]").is(":checked");
                $("input[name=benzodiazepine]").is(":checked");
                $("input[name=coccain]").is(":checked");
            }
        });
    </script>
@endsection
