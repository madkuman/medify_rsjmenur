<div class="modal" id="editModalSurveilans" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form action="{{url()->current()}}/edit-surveilans" method="POST">
			...
			<div class="modal-content" >
				<div class="block block-themed block-transparent mb-0">
					...
					<div class="block-content row">
						...
						<input type="hidden" name="lokasi_id" value="" id="input_lokasi_id">
						<div class="col-12">
							<h4>Gejala</h4>
						</div>
						<div class="col-md-5 col-12">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="temperatur_kulit" id="temperatur_kulit" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="konsitensi_jaringan" id="konsitensi_jaringan" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="gatal" id="gatal"  value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="nyeri" id="nyeri" value="1">
						...
						<div class="col-md-6 col-12">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="abrasi" id="abrasi" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="melepuh" id="melepuh" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="lubang_yang_dangkal" id="lubang_yang_dangkal"  value="1">
						...
						<div class="col-md-5 col-12">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="necrosis_jaringan_subkutan" id="necrosis_jaringan_subkutan" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="lubang_yang_dalam" id="lubang_yang_dalam" value="1">
						...
						<div class="col-md-6 col-12">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="necrosis_luas" id="necrosis_luas" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="kerusakan_otot_tulang" id="kerusakan_otot_tulang" value="1">
						...
						<div class="col-md-6">
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="ganti_posisi" id="ganti_posisi" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="kasur_angin" id="kasur_angin" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="perban_hidrokoloid" id="perban_hidrokoloid" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="perban_alginat" id="perban_alginat" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="krim_dan_salep" id="krim_dan_salep" value="1">
						...
						<div class="col-md-6">
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="antibiotik" id="antibiotik" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="suplemen_makanan" id="suplemen_makanan" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="debridement" id="debridement" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="analgesik" id="analgesik" value="1">
							...
							<div class="form-group mb-5">
								<label class="css-control css-control-primary css-checkbox">
									...
									<input type="checkbox" class="css-control-input" name="pembedahan" id="pembedahan" value="1">
