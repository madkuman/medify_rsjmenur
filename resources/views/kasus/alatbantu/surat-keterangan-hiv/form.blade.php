...
<table style="width:100%">
    <tr>
        <td class="position-relative" colspan="1" rowspan="1">
            <h5 style="text-align: center; padding: 20px 0px">SURAT KETERANGAN BEBAS FISIK</h5>
        </td>
    </tr>
</table>
<table style="width:100%">
...
<table style="width:100%">
    <tr>
        <td class="position-relative" colspan="1" rowspan="1">
            <h6>Pada pemeriksaan laboratorium tanggal</h6>
        </td>
    </tr>
</table>
<table style="width: 100%">
    ...
    <tr>
        <td width="20%" class="position-relative" colspan="1" rowspan="1"><span>HIV (Rapid Test)</span>
        </td>
        <td width="2%" class="position-relative" colspan="1" rowspan="1"><span>:</span></td>
        <td class="position-relative" colspan="1" rowspan="1">
            <div class="form-group medify-form-genv4-input-container">
                <input type="text" class="form-control" name="hiv" value="">
            </div>
            <div class="form-group medify-form-genv4-view-container">
            </div>
        </td>
