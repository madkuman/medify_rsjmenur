...
@section('title')
    {{ $kasus->judul_kasus }} - Surat Keterangan Bebas HIV
@endsection
                        ...
                        <div class="block-content">
                            @if (session('my_role_' . $kasus->nomor_kasus))
                                <button id="create-btn" type="button"
                                    ...
                                    <i class="fa fa-pencil"></i> Surat Keterangan Bebas HIV Baru
                                </button>
                                <h4>Surat Keterangan Bebas HIV</h4>
                                <hr>
                            @endif
                            ...
                            @forelse ($alat_bantu as $item)
                                ...
                                @endif
                                <h5 class="mb-5 pl-5">#Surat Keterangan Bebas HIV {{ $loop->iteration }}</h5>
                                <div class="row">
                                    <div class="col-6">
                            ...
                            @empty
                                <div class="text-center py-50">
                                    <h4 class="font-w400 mb-5">Belum ada Surat Keterangan Bebas HIV tersedia
                                    </h4>
                                    <p>Klik tombol <strong>Surat Keterangan Bebas HIV Baru</strong> untuk melakukan
                                        pembuatan Surat Keterangan Bebas HIV Baru</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
                    ...
                    <form id="create-edit-form" method="POST" action="#">
                        ...
                        <div class="block block-themed block-transparent mb-0">
                            ...
                            <div id="create-edit-modal-content" class="block-content"
                                ...
                                @include('kasus.alatbantu.surat-keterangan-hiv.form')
                            </div>
                        </div>
