<div class="modal" id="addTataLaksana" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content" >
			<div class="block block-themed block-transparent mb-0">
				<div class="block-header ">
					<h3 class="block-title">Tatalaksana Pencegahan</h3>
				...
				<div class="block-content row">
					<div class="col-md-12">
						<table class="mews table table-vcenter">
							...
							<tr class="item-rendah" style="display: none;">
								<td>Orientasi ruangan: bel pasien, kamar mandi dll.</td>
								<td>
									<label class="css-control css-control-primary css-checkbox ">
										<input type="checkbox" class="terlaksana css-control-input"/>
							...
							<tr class="item-tinggi" style="display: none;">
						...
						<div class="modal-footer">
							<div class="form-group">
								...
								<button type="button" class="btn btn-click-animate btn-primary btn-simple" id="submit_tatalaksana">Submit</button>
							</div>
						</div>
					</div>
				</div>
