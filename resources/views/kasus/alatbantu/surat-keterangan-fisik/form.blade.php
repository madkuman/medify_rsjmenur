...
<table style="width: 100%">
    ...
    <tr>
        ...
        <td width="2%" class="position-relative" colspan="1" rowspan="1"><span>:</span></td>
        <td class="position-relative" colspan="1" rowspan="1">
            <textarea name="alamat" class="form-control">{{ ucwords(strtolower($kasus->pasien->address)) }}, Kel. {{ ucwords(strtolower($kasus->pasien->alamat_kelurahan->nama)) }}, Kec. {{ ucwords(strtolower($kasus->pasien->alamat_kecamatan->nama)) }}, {{ ucwords(strtolower($kasus->pasien->alamat_kota->nama)) }}</textarea>
        </td>
    </tr>
    <tr>
