<div class="col-md-6">
	<table class="table table-sm table-striped table-vcenter" style="width: 100%">
		<thead>
			<tr>
				<th class="text-center">Diagnosis Medis</th>
			</tr>
			<tr>
		...
		<tbody>
			...
			{{--<tr>
				<td>Preskripsi Diet : Makanan Khusus</td>
				<td class="text-center">{{$res->makanan_khusus or '-'}}</td>
			</tr>--}}
			<tr>
				<td>Tindak Lanjut</td>
...
<div class="col-md-6">
	<table class="table table-sm table-striped table-vcenter" style="width: 100%">
		...
		<tbody>
			...
			{{--<tr>
				<th>Intervensi Gizi : Pemesanan Diet</th>
			</tr>
			<tr>
				<td> - {{$res->pemesanan_diet or '-'}}</td>
			</tr>
			<tr>
				<th>Intervensi Gizi : Edukasi / Konseling Gizi</th>
			</tr>
			<tr>
				<td> - {{$res->edukasi_konseling or '-'}}</td>
			</tr>
			<tr>
				<th>Intervensi Gizi : Kolaborasi Pelayanan</th>
			</tr>
			<tr>
				<td> - {{$res->kolaborasi_pelayanan or '-'}}</td>
			</tr>--}}
			<tr>
