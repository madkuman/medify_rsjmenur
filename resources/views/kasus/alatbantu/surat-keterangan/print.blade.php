...
<table width="80%" align="center" style="padding-left: 50px;">
    ...
    <tr>
        <td>{{$i++}}.</td>
        <td>
            Memerlukan rawat inap di Rumah Sakit Jiwa Menur Provinsi Jawa Timur dari tanggal : {{ $val->mulai_rawat_inap
            ?? '...............................' }} s/d {{ $val->selesai_rawat_inap ?? '...............................'
            }}
        </td>
    </tr>
    @endif
    ...
    <tr>
        <td>{{$i++}}.</td>
        <td>
            Memerlukan rawat jalan dari tanggal {{ $val->mulai_rawat_jalan ?? '...............................' }} s/d
