...
@section('title')
{{$kasus->judul_kasus}} - Asesmen Mata - Kasus
@endsection
			...
			<div class="col-lg-9 col-xl-9">
				<div class="block block-bordered">
					<div class="block-content">
						...
						<h4 class="pt-10">Asesmen Mata</h4>
						<hr>
						<div class="row">
							@php $count = 1 @endphp
							...
							<div class="col-8"> 
								...
								@endif
								@endif
								<h5 class="mb-5 pl-5">#Asesmen Mata {{$count++}}</h5>
								@php $res = json_decode($item->val) @endphp
								<div class="p-10" id="">
									@include('kasus.alatbantu.mata.tabel-hasil')
									@include('kasus.alatbantu.mata.creator')
								</div>
							</div>
							<div class="col-12">
								<hr class="m-0">
							...
							<div class="col-12">
								<div class="text-center py-50">
									<h4 class="font-w400 mb-5">Belum ada Asesmen Mata tersedia</h4>
									<p>Klik tombol <b>Asesmen Mata Baru</b> untuk melakukan Asesmen Mata</p>
								</div>
							</div>
...
@include('kasus.alatbantu.mata.add')
@include('kasus.alatbantu.mata.view-modal')
@endsection
