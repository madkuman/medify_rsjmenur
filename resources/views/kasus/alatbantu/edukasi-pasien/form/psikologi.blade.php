...
@section('table-tag')
<table class="table table-hover table-striped table-borderless table-vcenter" id="psikologiTable">
@overwrite

@section('add-button')
<button class="btn btn-block btn-alt-primary tambahRecord" id="tambahPsikologi" type="button">Tambah Record</button>
@overwrite

@section('jenis-form')
<input type="hidden" name="jenis" value="Psikologi/Rehabmed">
@overwrite
