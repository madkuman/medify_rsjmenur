...
@section('table-tag')
<table class="table table-hover table-striped table-borderless table-vcenter" id="manageNyeriTable">
@overwrite

@section('add-button')
<button class="btn btn-block btn-alt-primary tambahRecord" id="tambahManageNyeri" type="button">Tambah Record</button>
@overwrite

@section('jenis-form')
<input type="hidden" name="jenis" value="Manajemen Nyeri">
@overwrite

@section('tr')
<tr>
    <td>
        <input type="hidden" name="materi[]" value="Relaksasi">
        Relaksasi
    </td>
    <td>
...
<tr>
    <td>
        <input type="hidden" name="materi[]" value="Distraksi">
        Distraksi
    </td>
    <td>
        <input type="text" class="js-datepicker form-control" name="tanggal[]" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yyyy" value="{{date('d/m/Y', time())}}" required="">
...
<tr>
    <td>
        <input type="hidden" name="materi[]" value="Mobilisasi">
        Mobilisasi
    </td>
    <td>
        <input type="text" class="js-datepicker form-control" name="tanggal[]" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yyyy" value="{{date('d/m/Y', time())}}" required="">
...
<tr>
    <td>
        <input type="hidden" name="materi[]" value="Kolaborasi">
        Kolaborasi
    </td>
    <td>
        <input type="text" class="js-datepicker form-control" name="tanggal[]" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yyyy" value="{{date('d/m/Y', time())}}" required="">
