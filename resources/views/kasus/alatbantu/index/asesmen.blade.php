...
<div class="" id="asesmen-list">
    <ul class="list row row-deck">
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url('kasus')}}/{{$kasus->nomor_kasus}}/asesmen/pasien-covid">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url('kasus')}}/{{$kasus->nomor_kasus}}/asesmen/monitoring-transfusi-darah">
                <div class="block-header">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url('kasus')}}/{{$kasus->nomor_kasus}}/asesmen/pengkajian-ulang-pasien-terminal">
                <div class="block-header">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url()->current()}}/patograf">
                ...
                <div class="block-content">
                    ...
                    <p class="desc"> PAtograf sebagai alat pemantauan persalinan normal dan juga sebagai alat pengambilan keputusan klinis</p>
                </div>
            </a>
        </li>
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url('kasus')}}/{{$kasus->nomor_kasus}}/asesmen/lembar-observasi">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url()->current()}}/managemen-dan-asesmen-ulang-nyeri">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url()->current()}}/asesmen-risiko-jatuh-psikiatri">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url()->current()}}/surat-keterangan-pemeriksaan-kematian">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url()->current()}}/penilaian-kualitas-hidup-lansia">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url()->current()}}/surat-permintaan-masuk-rumah-sakit">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url('kasus')}}/{{$kasus->nomor_kasus}}/asesmen/pengantar-pengiriman-pasien">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url('kasus')}}/{{$kasus->nomor_kasus}}/asesmen/asesmen-pendidikan-pasien-dan-keluarga">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center" style="display: none">
            <a class="block block-link-pop block-themed" href="{{url('kasus')}}/{{$kasus->nomor_kasus}}/asesmen/lembar-komunikasi-informasi-dan-edukasi-pasien-dan-keluarga">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url('kasus')}}/{{$kasus->nomor_kasus}}/asesmen/skoring-derajat-gejala-psikotik">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url()->current()}}/asesmen-napza-rawat-jalan-non-ipwl">
                <div class="block-header bg-primary">
        ...
        <li class="col-md-4 text-center">
            <a class="block block-link-pop block-themed" href="{{url()->current()}}/instrumen-activity-daily-living">
                <div class="block-header bg-primary">
