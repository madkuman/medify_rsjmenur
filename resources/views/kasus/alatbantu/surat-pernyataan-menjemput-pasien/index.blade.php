...
@section('title')
    {{ $kasus->judul_kasus }} - Surat Pernyataan Menjemput Pasien
@endsection
...
@section('content')
    <main id="main-container">
                        ...
                        <div class="block-content">
                            @if (session('my_role_' . $kasus->nomor_kasus))
                                <button id="create-btn" type="button"
                                    ...
                                    <i class="fa fa-pencil"></i> Surat Pernyataan Menjemput Pasien Baru
                                </button>
                                <h4>Surat Pernyataan Menjemput Pasien</h4>
                                <hr>
                            @endif
                            ...
                            @forelse ($alat_bantu as $item)
                                ...
                                @endif
                                <h5 class="mb-5 pl-5">#Surat Pernyataan Menjemput Pasien {{ $loop->iteration }}</h5>
                                <div class="row">
                                    <div class="col-6">
                            ...
                            @empty
                                <div class="text-center py-50">
                                    <h4 class="font-w400 mb-5">Belum ada Surat Pernyataan Menjemput Pasien tersedia
                                    </h4>
                                    <p>Klik tombol <strong>Surat Pernyataan Menjemput Pasien Baru</strong> untuk melakukan
                                        pembuatan Surat Pernyataan Menjemput Pasien Baru</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
                    ...
                    <form id="create-edit-form" method="POST" action="#">
                        ...
                        <div class="block block-themed block-transparent mb-0">
                            ...
                            <div id="create-edit-modal-content" class="block-content"
                                ...
                                @include('kasus.alatbantu.surat-pernyataan-menjemput-pasien.form')
                            </div>
                        </div>
        ...
        {{-- ./Modal Surat Pernyataan Menjemput Pasien Baru --}}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            function setValueForFormEdit(value) {
                ...
                $("input[name=no_telepon]").val(value?.no_telepon);
                $("input[name=tanggal_lahir]").val(value?.tanggal_lahir);
                $("input[name=hubungan]").val(value?.hubungan);
            }
        });
    </script>
@endsection
