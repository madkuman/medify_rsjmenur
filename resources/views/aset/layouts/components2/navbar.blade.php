...
<header id="page-header" class="header-has-logo ">
    ...
    <div class="content-header">
        <div class="content-header-logo">
            <div class="ml-10 d-inline-block">
                <button type="button" class="btn btn-circle btn-dual-secondary" style="padding-top: 3px;" onclick="openNav()">
            ...
            <div class="d-inline-block">
                <a class="link-effect font-w600" href="{{url('')}}">
                    <span class="d-none d-md-inline-block">
                        <span class="font-size-xl text-black">Medify</span>
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <div class="col text-right">
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Nama User<i class="fa fa-angle-down ml-5"></i>
                            </button>
    ...
    @include('aset.layouts.components2.sidebar')