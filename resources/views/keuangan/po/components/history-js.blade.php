...
function draw(filter,tanggal_start,tanggal_end){
    ...
    ajax: {
        ...
        url: url = API_URL + '/keuangan/po/get',
    },
    columns: [
        ...
        { data: 'id', name: 'id', className: 'text-center', 
            render: function(data, type, row, meta){
                data = `<a href="{{url('keuangan/po')}}/`+data+`" class="btn btn-sm btn-alt-primary" data-toggle="tooltip" title="Lihat Detail Transaksi">&nbsp;<i class="fa fa-search-plus"></i></a>`;
