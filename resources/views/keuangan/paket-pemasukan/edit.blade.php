    ...
    <div class="block-content">
        <div class="row">
            ...
            <div class="col-5" id="input-judul-container">
                ...
                <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan Judul Penerimaan" value="{{$pemasukan->judul}}">
            ...
            <div class="col-12">
                <table class="main-table table table-hover table-striped table-borderless table-vcenter">
                    ...
                    <tr id="transaksi-{{$rownum+1}}" data-id="{{$rownum+1}}">
                        ...
                        <input type="text" class="d-none" id="tarif_kelas_id{{$rownum+1}}" value="{{$item->tarif_kelas_id}}">
...
@section('js')
<script src="{{asset('js/keuangan/pemasukan/editv1.4.js')}}"></script>
<script>
