...
@section('title')
Pemasukan #{{$pemasukan->id}} - Keuangan
@endsection
    ...
    <div class="block">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <button type="button" class="btn btn-sm btn-alt-primary" onclick="popupwindow('{{url()->current()}}/print-nota','Piutang',500,1000) " data-toggle="tooltip" title="Print Nota">
                    <i class="si si-printer"></i>
                </button>
                <button type="button" class="btn btn-sm btn-alt-primary" onclick="popupwindow('{{url()->current()}}/print-kwitansi','Piutang',500,1000) " data-toggle="tooltip" title="Print Kwitansi">
                    <i class="si si-printer"></i>
                </button>
                @if(!empty($pemasukan->piutang_id))
                <button class="btn btn-sm btn-alt-warning disabled" data-toggle="tooltip" title="Tidak bisa di edit. Harus dihapus terlebih dahulu dan melakukan pembayaran ulang" >
                    <i class="fa fa-edit"></i>
                </button>
                @else
                <a href="edit/{{$pemasukan->id}}" class="btn btn-sm btn-alt-warning" data-toggle="tooltip" title="Edit Detail Transaksi">
                    <i class="fa fa-edit"></i>
                </a>
                @endif
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="table-warning">
                            ...
                            <td class="font-w700 text-right">Rp {{number_format($pemasukan->total)}}</td>
                        </tr>
                        <tr>
                            <td colspan="8">&nbsp;</td>
                        </tr>
                        ...
                        <tr class="table-info">
                            ...
                            <td class="font-w700 text-right">Rp {{number_format($pemasukan->total_pembayaran)}}</td>
                        </tr>
                        <tr class="table-info">
                            <td colspan="7" class="font-w700 text-uppercase text-right">Deposit Digunakan</td>
                            <td class="font-w700 text-right">Rp {{number_format($pemasukan->total_deposit)}}</td>
                        </tr>
                        <tr class="table-info">
                            <td colspan="7" class="font-w700 text-uppercase text-right">Kembalian</td>
                            <td class="font-w700 text-right">Rp {{number_format($pemasukan->total_kembalian)}}</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
