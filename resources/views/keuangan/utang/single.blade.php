...
@section('title')
Faktur {{$utang->no_faktur}} - Keuangan
@endsection
...
<div class="content p-0" id="print-content">
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Faktur {{$utang->no_faktur}}</h3>
            <div class="block-options">
                ...
                <a href="{{url('keuangan/penerimaan')}}/edit/{{$utang->id}}" class="btn btn-sm btn-alt-warning" data-toggle="tooltip" title="Edit Detail Transaksi">
        ...
        <div class="block-content">
            ...
            <!-- END Table -->
            @if (empty($utang->no_pjk) && !empty($utang->no_faktur))
            <div class="row">
                <div class="col-md-12" style="float: right;">
                    <a class="btn btn-primary btn-fill pull-right" href="{{url('keuangan/pjk/baru?utang_id='.$utang->id)}}">Buat PJK</a>
                </div>
            </div>
            @endif
            <!-- Footer -->
