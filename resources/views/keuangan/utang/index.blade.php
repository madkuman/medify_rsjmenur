    ...
    <div class="col-md-12">
        <div class="block">
            <div class="block-header block-header-default py-20">
                <span><h4 class="mb-0">Transaksi Penerimaan Belum Diproses</h4><hr>
                </span>
            ...
            <div class="block-content py-20">
                <table class="table table-striped table-hover table-vcenter js-dataTable-simple" id="transaksiTable">
                    <thead>
                        <tr>
                            <th class="text-center" style="width: 100px;">No. Faktur  </th>
...
@section('js')
@include('keuangan.utang.components.index-js')
