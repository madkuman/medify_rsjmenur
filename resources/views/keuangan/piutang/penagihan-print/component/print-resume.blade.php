...
<table>
    <tr>
        <td><img src="{{asset('assets/img/rumkital.png')}}" height="50" style="float: left;margin-right: 5px">
        </td>
        <td>
            <h4>{{config('app.name')}}</h4>
            <h5>Jl.Menur No. 120, Kode Pos 60282., Jawa Timur</h5>
            <h5 >Telp (031) 5937268 Fax (031)5937266</h5>
        </td>
    </tr>
</table>
...
<table width="100%">
    ...
    <tr>
        ...
        <td>:</td>
        <td>{{$row['resume']->waktu_kontrol}} ; Klinik : {{$row['resume']->poli->name ?? '-'}} ; Rumah Sakit : {{config('app.name')}} SBY ;</td>
    </tr>
    <tr>
        <td>12.</td>
