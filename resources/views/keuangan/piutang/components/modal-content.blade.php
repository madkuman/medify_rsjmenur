    ...
    <div class="row">
        <div class="col-8">
            <div class="form-group">
                ...
                <small class="error-deskripsi-notfound hide text-danger"></small>
            </div>
        </div>
        <div class="col-4">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-5">
            <div class="row">
                <div class="col-12">
                    <label>Staf</label>
                    <select class="form-control user-select2 created_by" style="width: 100%">
                    </select>
                </div>
                <div class="col-12">
                    <label>ID</label>
