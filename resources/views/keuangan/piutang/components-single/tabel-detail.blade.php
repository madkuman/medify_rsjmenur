<div class="block">
    <div class="block-header block-header-default">
        ...
        <div class="block-options">
            <button type="button" class="btn btn-sm btn-alt-primary d-none" onclick="popupwindow('{{url('')}}/keuangan/piutang/{{$piutang->id}}/print-lokasi','Piutang',500,1000) " data-toggle="tooltip" title="Print Nota Lokasi">
            ...
            <button type="button" class="btn btn-sm btn-alt-primary" onclick="popupwindow('{{url('')}}/keuangan/piutang/{{$piutang->id}}/print','Piutang',500,1000) " data-toggle="tooltip" title="Print Nota Pasien">
                <i class="si si-printer"></i>
            </button>
             <button type="button" class="btn btn-sm btn-alt-primary" onclick="popupwindow('{{url('')}}/keuangan/piutang/{{$piutang->id}}/print-klaim','Piutang',500,1000) " data-toggle="tooltip" title="Print Nota Klaim">
                <i class="si si-printer"></i>
            </button>
        ...
        <div class="table-responsive push">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    @foreach($piutang->sister as $tagihan)
                    <tr>
