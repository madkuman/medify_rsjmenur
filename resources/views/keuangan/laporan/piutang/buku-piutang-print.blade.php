<table>
    <thead>
        ...
        <tr>
            <th colspan="3" style="text-decoration: underline;">BENDAHARA</th>
        </tr>
        <tr>
            <th colspan="9">BUKU PIUTANG {{config('app.name')}}</th>                            
        </tr>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$item->nama}}</td>
            <td>{{$item->piutang_bulan_lalu}}</td>
            <td>{{$item->piutang_bulan_ini}}</td>
            <td>{{$item->piutang_sd_bulan_ini}}</td>
