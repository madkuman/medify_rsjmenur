...
<div class="block rounded">
    ...
    <div class="block-content">
        <form class="form-horizontal form-material" action="{{ route('pengeluaran_kwitansi_create',['id' => $items->id]) }}" method = "get">
        <div class="row">
            <div class="col-3">
                <label for="example-datepicker1">Tanggal Transaksi</label>
                <input type="text" class="js-datepicker form-control" name="tanggal_transaksi" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="Masukkan Tanggal" value="{{date('d-m-Y', strtotime($items->tanggal_transaksi))}}">
            </div>
            <div class="col-4">
            ...
            <div class="col-4">
                ...
                <select class="js-select2 form-control" name="kode_anggaran" style="width: 100%;" data-placeholder="Pilih Kategori Transaksi">
                    ...
                    <option value="{{$item->id}}" @if($item->id == $items->kategori_id) selected @endif>{{$item->name}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-3 text-muted">
                ...
                <input type="number" class="form-control" name="subtotal" placeholder="Masukkan Jumlah Total Tagihan" value="{{$items->total}}">
            </div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="row">
            <div class="col-3">
                ...
                <input type="text" class="form-control" name="pembayar_nama" placeholder="Masukkan Nama Pembayar" value="{{$items->pembayar}}">
            </div>
            <div class="col-3">
        ...
        <div class="row">
            <div class="col-3">
                ...
                <input type="text" class="form-control" name="penerima_nama" placeholder="Masukkan Nama Penerima" value="{{$items->penerima}}">
            </div>
            <div class="col-3">
