<!-- modal bayar -->
  <div id="edit_nomor_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="POST" action="{{url()->current()}}/edit-nomor-surat">
          {{csrf_field()}}
        <div class="block block-themed">
          <div class="block-header bg-primary">
            <h5 class="block-title">Ubah Penagihan</h5>
          ...
          <div class="block-content">
            <div class="row mb-20 form-group align-items-center">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" name="judul" value="{{$paket->judul}}">
              </div>
            </div>
            <div class="row mb-20 form-group align-items-center">
              <div class="col-md-5">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control" name="nomor_surat" value="{{$paket->nomor_surat}}">
              </div>
            </div>
