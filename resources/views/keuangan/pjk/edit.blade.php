...
<div class="block rounded">
    <div class="block-header">
        <h3 class="block-title">Edit PJK</h3>
    </div>
    <div class="block-content">
        <div class="row">
            ...
            <div class="col-4">
                ...
                <input type="text" class="form-control" id="nopjk" name="nopjk" value="{{$utang->nomor_pjk}}" disabled>
            </div>
            <div class="col-4">
                <label for="example-datepicker1">Tanggal PJK</label>
                <input type="text" class="js-datepicker form-control" id="tanggaltransaksi" name="tanggaltransaksi" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="Masukkan Tanggal PJK" value="{{date('d-m-Y', strtotime($utang->tanggal_transaksi))}}">
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-4">
                ...
                <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan Judul Utang" value="{{$utang->judul}}">
            </div>
            <div class="col-4">
                ...
                <select class="js-select2 form-control" id="akunpjk" name="akunpjk" style="width: 100%;" data-placeholder="Pilih Akun">
                    ...
                    <option value="{{$item->id}}" @if($item->id == $utang->akun_pjk_id) selected @endif>{{$item->name}}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="row">
            <div class="col-4">
                ...
                <input type="text" class="form-control" id="nospkktr" name="nospkktr" placeholder="Masukkan Nomor SPK/KTR" @if(!empty($utang->no_spkktr)) value="{{$utang->no_spkktr}}" @endif>
            </div>
            <div class="col-4">
                <label for="example-datepicker1">Tanggal SPK/KTR</label>
                <input type="text" class="js-datepicker form-control" id="tanggalspkktr" name="tanggalspkktr" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="Masukkan Tanggal SPK/KTR" @if(!empty($utang->tanggal_spkktr)) value="{{date('d-m-Y', strtotime($utang->tanggal_spkktr))}}" @endif>
            </div>
            <div class="col-4">
                {{--<!-- <label for="example-datepicker1">Penerima Utang</label>-->--}}
                <input type="hidden" class="form-control" id="penerima" name="penerima" placeholder="Masukkan Penerima Utang" value="{{$utang->penerima}}">
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-4">
                ...
                <input type="text" class="form-control" id="nosprin" name="nosprin" placeholder="Masukkan Nomor Sprin" @if(!empty($utang->no_sprin)) value="{{$utang->no_sprin}}" @endif>
            </div>
            <div class="col-4">
                <label for="example-datepicker1">Tanggal Sprin</label>
                <input type="text" class="js-datepicker form-control" id="tanggalsprin" name="tanggalsprin" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="Masukkan Tanggal Sprin" @if(!empty($utang->tanggal_sprin)) value="{{date('d-m-Y', strtotime($utang->tanggal_sprin))}}" @endif>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-4">
                ...
                <input type="text" class="form-control enter-new-field" id="nopo" name="nopo" autocomplete="on" placeholder="Masukkan Nomor PO" value="{{$utang->no_po}}">
            </div>
            <div class="col-4">
                <label for="example-datepicker1">Tanggal PO</label>
                <input type="text" class="js-datepicker form-control enter-new-field" id="tanggalpo" name="tanggalpo" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="Masukkan Tanggal PO" @if(!empty($utang->tanggal_po)) value="{{date('d-m-Y', strtotime($utang->tanggal_po))}}" @endif>
            </div>
        </div>
        <br>
        <div class="row">
...
@section('js')
@include('keuangan.pjk.components.edit-js')
