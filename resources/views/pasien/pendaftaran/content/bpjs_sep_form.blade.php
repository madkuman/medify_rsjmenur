<div class="col-12 form-group input-group bpjs"  id="sep_select_wrapper" style="display: none;">
	<select name="sep" class="form-control js-select2 sep_input" id="sep_select" data-placeholder="Nomor SEP Pasien" style="width: 91%;">
    <option value=""></option>
    @foreach($sep as $item)
	    @if(isset($item->no_sep))
	    <option value="{{json_encode($item)}}">{{$item->no_sep}} - @if($item->jenis_pelayanan == 1) Rawat Inap @else Rawat Jalan @endif</option>
	    @endif
    @endforeach
	</select>
	<div class="input-group-append" style="width: 9%;">
        <button type="button" class="btn btn-alt-primary" id="sep_select_refresh" data-tanggal-start="{{date('d-m-Y',strtotime("-1 month"))}}" data-tanggal-end="{{date('d-m-Y')}}" data-ppk="{{config('app.bpjs_ppk')}}">
...
<div class="col-12 form-group input-group bpjs" style="display: none;">
...
<div class="col-12 form-group input-group "  id="sep_custom_wrapper" style="display: none;">
...
<div class="col-12 form-group bpjs" id="sep_button_wrapper"  style="display: none;">
