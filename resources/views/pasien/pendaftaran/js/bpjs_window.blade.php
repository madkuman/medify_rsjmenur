<script type="text/javascript">
    ...
    function preview_sep(sep) {
        ...
        if(sep){
            ...
            $('#data_sep_jenis_pelayanan').text(((sep.jenis_pelayanan ?? sep.jnsPelayanan) == 1) ? "Rawat Inap" : "Rawat Jalan");
	...
	$('#sep_button').on('click', function(){
		popupwindow(new_sep_url+"&pembayaran_id="+$('#selectPembayaran').val(), "Terbitkan SEP Baru", 700, 1000);
	});
    ...
    $('#sep_button_auto').on('click', function(){
        ...
        if(valLayanan == 1) {
            ...
            if(dokter_id == null) {
                callSwal('error','Dokter Praktek Kosong','Dokter praktek masih kosong. Silahkan pilih dokter praktek','');
                return
            }
        }
        else
