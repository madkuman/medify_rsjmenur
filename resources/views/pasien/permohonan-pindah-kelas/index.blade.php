		...
		<div class="block block-bordered">
			<div class="block-content">
				<button type="button" class="btn btn-rounded btn-alt-primary min-width-125 float-right editBtn">
					<i class="fa fa-pencil mr-2"></i> Surat Permohonan Baru
				</button>
				
				<h4>Surat Permohonan Pindah Kelas</h4>
				<hr>
				@php $count = 1 @endphp
				...
				<h5 class="mb-5 pl-5">#Surat Permohonan Pindah Kelas {{$count++}}</h5>
				...
				<div class="text-center py-50">
					<h4 class="font-w400 mb-5">Belum ada Surat Permohonan Pindah Kelas tersedia</h4>
					<p>Klik tombol <b>Surat Permohonan Baru</b> untuk membuat Surat Permohonan Pindah Kelas Pasien</p>
				</div>
...
@include("pasien.permohonan-pindah-kelas.modal")
@include("pasien.permohonan-pindah-kelas.modal-hasil")
@endsection
...
<script type="text/javascript">
	...
	$(".editBtn").click(function(e){
	 	...
	 	if(item != "" && item != undefined) {
	 		$("#id").val(id);
			@include("pasien.permohonan-pindah-kelas.js-form-edit")
	 	} else {
	 		$("#id").val(0);
	 		resetForm();
	 	}
	...
	$(".showBtn").click(function(e){
		...
		var ruangan_pasien = $(`:text[name="ruangan_pasien"]`).val();
		...
		ruangan_pasien = ruangan_pasien ? ruangan_pasien : "-";
		...
		var awal_kelas = item.awal_kelas ? item.awal_kelas.nama : "-";
		var tujuan_kelas = item.tujuan_kelas ? item.tujuan_kelas.nama : "-";
		var ruangan = item.ruangan ? item.ruangan : "-";

		var hasil = `@include("pasien.permohonan-pindah-kelas.hasil")`;
	...
	function resetForm() {
		@include("pasien.permohonan-pindah-kelas.js-form-create")
	}
</script>
@endsection