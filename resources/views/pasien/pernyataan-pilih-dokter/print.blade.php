...
@section('title')
{{$identitas->name}} - Surat Pernyataan Pilih Dokter
@endsection
...
<table width="100%">
    <tr>
        <td width="90%"></td>
        <td width="10%" class="border" align="center">RM. 19.K1</td>
    </tr>
</table>
    ...
    <td width="45%">
        <div style="border: 1px solid #000;">
            <table width="100%" cellpadding="3">
                <tr>
                    <td width="32%">No. RM</td>
                    <td width="3%">:</td>
                    <td width="65%">{{ $identitas->no_rm }}</td>
                </tr>
                <tr>
                    <td>Nama</td>
                    <td>:</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ indonesian_date($identitas->date_of_birth) }} / {{$identitas->age}} Tahun</td>
                </tr>
            </table>
        </div>
    </td>
...
<table width="100%" style="margin: 20px">
    <tr>
        <td align="center">
            <h3>SURAT PERNYATAAN MEMILIH DOKTER</h3>
        </td>
    </tr>
</table>
...
<div style="border: 1px solid black; padding: 5px;">
    ...
    <table width="100%" cellpadding="5">
        ...
        <tr>
            <td colspan="3">Dengan ini menyatakan bersuggguh-sungguh untuk memilih dokter <b>{{ $surat->dokter->name ?? "........................................." }}</b> yang akan merawat Pasien :</td>
        </tr>
        <tr>
            <td>No. RM</td>
            <td>:</td>
    ...
    <table width="100%">
        ...
        <tr>
            <td align="center">(............................................)</td>
            <td align="center">(............................................)</td>
            <td align="center">({{ $val->nama_wali ?? "............................................" }})</td>
        </tr>
    </table>
</div>
