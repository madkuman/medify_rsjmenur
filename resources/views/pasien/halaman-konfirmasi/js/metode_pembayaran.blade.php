    ...
    function lihatMetode(id)
    {
        ...
        $.ajax({
            ...
            success:function(data){
                if (data.perusahaan.type=='1') {
                ...
                else if(data.perusahaan.type=='2'){
                    $('#form-no-sep').hide();
                    $('#nomorSEP').hide();
                    $('#infoBPJSWrapper').hide();
                    ...
                    $('#noSEP').val(0);
                    $("#InfoPembayaran").html(`
                        <div class="col-12 font-w600 h3">Perusahaan Kerjasama</div>
                        <div class="col-lg-4 col-12">
                        <div class="font-w600">Jenis Pasien</div>                            
                        </div>
                        <div class="col-lg-8 col-12 mb-5">Perusahaan Kerjasama</div>
                        <div class="col-lg-4 col-12">
                        <div class="font-w600">Perusahaan</div>                            
                        </div>
                        <div class="col-lg-8 col-12 mb-5">`+data.perusahaan.nama+`</div>
                        <div class="col-lg-4 col-12">
                        <div class="font-w600">Nomor Keanggotaan</div>                            
                        </div>
                        <div class="col-lg-8 col-12 mb-5">`+data.no_asuransi+`</div>
                        <div class="col-lg-4 col-12 mb-5">
                        <div class="font-w600">Kelas Perawatan</div>                            
                ...
                else if(data.perusahaan.type=='3'){
                    $('#form-no-sep').hide();
                    $('#nomorSEP').hide();
                    $('#infoBPJSWrapper').hide();
                    $('#sep_button_wrapper').hide();
                    $('#noSEP').val(0);
                    $("#InfoPembayaran").html(`
                        <div class="col-12 font-w600 h3">Asuransi</div>
                        <div class="col-lg-4 col-12">
                        <div class="font-w600">Jenis Pasien</div>                            
                        </div>
                        <div class="col-lg-8 col-12 mb-5">Asuransi</div>
                        <div class="col-lg-4 col-12">
                        <div class="font-w600">Nama Asuransi</div>                            
                        </div>
                        <div class="col-lg-8 col-12 mb-5">`+data.perusahaan.nama+`</div>
                        <div class="col-lg-4 col-12">
                ...
                else if(data.perusahaan.type=='4'){
                    $('#form-no-sep').hide();
                    $('#nomorSEP').hide();
                    $('#infoBPJSWrapper').hide();
                    $('#sep_button_wrapper').hide();
