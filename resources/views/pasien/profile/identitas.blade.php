<div class="card">
    <div class="card-body">
            ...
            <div class="row mb-20">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-9 col-sm-6">
                            {{ $identitas->place_of_birth or '-' }},
                            {{ date('d F Y', strtotime($identitas->date_of_birth)) }}
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-9 col-sm-6">
                            @if (!empty($identitas->agama))
                                {{ $identitas->agama->nama or '-' }}
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mb-20">
                        ...
                        <div class="col-lg-9 col-sm-6">
                            ...
                            @if (!empty($identitas->alamat_kecamatan))
                                {{ $identitas->alamat_kelurahan->nama or '-' }},
                                {{ $identitas->alamat_kecamatan->nama or '-' }},
                                {{ $identitas->alamat_kota->nama or '-' }},
                                {{ $identitas->alamat_kota->provinsi->nama or '-' }}
                            @endif
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-lg-9 col-sm-6">
                                ...
                                @if (!empty($identitas->wali->alamat_kecamatan))
                                    {{ $identitas->wali->alamat_kelurahan->nama or '-' }},
                                    {{ $identitas->wali->alamat_kecamatan->nama or '-' }},
                                    {{ $identitas->wali->alamat_kota->nama or '-' }},
                                    {{ $identitas->wali->alamat_kota->provinsi->nama or '-' }}
                                @endif
                            </div>
                        </div>
                        <div class="row mb-10">
        ...
        @php
            $pasien_photo_data_ktp =
                !empty($identitas->photo_identity) && $identitas->photo_identity != 'assets/img/placeholder.jpg';
            $pasien_photo_data_kk = !empty($identitas->file_kk) && $identitas->file_kk != 'assets/img/placeholder.jpg';
            $pasien_photo_data_kartu_asuransi =
                !empty($identitas->file_kartu_asuransi) &&
                $identitas->file_kartu_asuransi != 'assets/img/placeholder.jpg';
            $available_photo_data =
                $pasien_photo_data_ktp && $pasien_photo_data_kk && $pasien_photo_data_kartu_asuransi;
        @endphp
        <div class="row mt-20">
                    ...
                    <div class="col-lg-4 col-sm-12">
                        <div class="block block-rounded pasien-foto-data">
                            <div class="block-content">
                                <form method="POST" action="{{ url('pasien/download/berkas') }}"
                                    onsubmit="$(this).unbind('submit')">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="filename" value="{{ $identitas->photo_identity }}">
                                    <input type="hidden" name="file_rename"
                                        value="foto_ktp_pasien_rm_{{ $identitas->no_rm }}">
                                    <button type="submit" class="btn btn-circle btn-alt-secondary btn-download"><i
                        ...
                        <div class="block block-rounded pasien-foto-data">
                            <div class="block-content">
                                <form method="POST" action="{{ url('pasien/download/berkas') }}"
                                    ...
                                    <input type="hidden" name="file_rename"
                                        value="foto_kk_pasien_rm_{{ $identitas->no_rm }}">
                                    <button type="submit" class="btn btn-circle btn-alt-secondary btn-download"><i
                                            class="fa fa-download"></i></button>
                                </form>
                            ...
                            <div class="block-content">
                                <form method="POST" action="{{ url('pasien/download/berkas') }}"
                                    ...
                                    <input type="hidden" name="filename"
                                        value="{{ $identitas->file_kartu_asuransi }}">
                                    <input type="hidden" name="file_rename"
                                        value="foto_kartu_asuransi_pasien_rm_{{ $identitas->no_rm }}">
                                    <button type="submit" class="btn btn-circle btn-alt-secondary btn-download"><i
                                            class="fa fa-download"></i></button>
                                </form>
                ...
                <div class="mt-20">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-sm-12">
                            <a href="{{ url()->current() }}/pembayaran/baru" class="btn" style="padding: 0;">+
                            ...
                            <div class="col-lg-4 col-sm-12">
                                ...
                                <div class="block-header">
                                    <h3 class="block-title">
                                        ...
                                        @else
                                            <button type="button"
                                                onclick="setPembayaranUtama({{ $identitas->id }},{{ $bayar->id }})"
                                                class="btn btn-sm btn-circle btn-noborder btn-outline-secondary pull-right"
                                                title="Jadikan Pembayaran Utama"><i class="fas fa-key"></i></button>
                                        @endif
                                    </h3>
                                    @if (count($pembayaran) != 1)
                                        <button type="button"
                                            class="btn btn-sm btn-circle btn-noborder btn-outline-danger pull-right d-none"
                                            onclick="pembayaranDeleteModal({{ $bayar->id }})"><i
                                                class="fa fa-trash"></i></button>
                                    @endif
                                    <a href="{{ url()->current() }}/pembayaran/edit/{{ $bayar->id }}"
                                        class="btn btn-sm btn-circle btn-noborder btn-outline-info pull-right"><i
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                <h6 class="pt-10">
                    ...
                    <span class="float-right"> <i class="fa fa-clock-o text-muted"></i> {{ $identitas->tanggal }}
                    </span>
...
<div class="modal" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="modal-large" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="POST" action="{{ url('rawatinap/pengaturan/ruangan/edit') }}"
                    ...
                    <div class="block-content">
                        ...
                        <div class="form-group row">
                            <div class="col-md-8 text-left">
                                ...
                                <input type="text" class="form-control" name="name" id="inputEditRuanganNama"
                                    placeholder="..">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary btn-hero"
