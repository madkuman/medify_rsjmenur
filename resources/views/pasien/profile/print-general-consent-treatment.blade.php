...
<html>
<head>
    <title>Print General Consent For Treatment</title>
    <style type="text/css">
        body, p {
            font-size: 12px;
...
<body>
    ...
    <table>
        <tr>
            <td>
                <h4>PERSETUJUAN UMUM (GENERAL CONSENT FOR TREATMENT)</h4>        
            </td>
        </tr>
        <tr>
    ...
    <ol>
        ...
        Kami menyatakan bahwa segala biaya yang timbul sehubungan dengan dirawatnya Kami, maka : <br>
            ...
            <p style="margin-top: 10px;">Dengan tanda tangan Kami atau yang mewakili dibawah ini, Kami menyatakan bahwa Kami telah membaca dan memahami item pada Persetujuan Umum (General Consent For Treatment).</p>
        </li>
    </ol>
