<div class="pt-80 pb-10 px-5 text-center">
    <h2 class=" font-w700 my-10 text-light">Antrian Pendaftaran Pasien Baru</h2>
</div>
...
<div class="row justify-content-center px-5">
    <div class="col-sm-8 col-md-6 col-xl-5">
        <div class="form-group mt-20">
            <button class="btn btn-block btn-hero btn-noborder big-button btn-primary" id="btn-cetak-pasien-baru">
