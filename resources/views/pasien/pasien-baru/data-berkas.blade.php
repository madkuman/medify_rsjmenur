    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="avatar-upload berkas-upload">
                ...
                <div class="avatar-preview berkas-preview">
                    <div id="imagePreview_file_ktp" style="background-image: url({{url('assets/img/placeholder.jpg')}});">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="avatar-upload berkas-upload">
                ...
                <div class="avatar-preview berkas-preview">
                    <div id="imagePreview_file_kk" style="background-image: url({{url('assets/img/placeholder.jpg')}});">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="avatar-upload berkas-upload">
                ...
                <div class="avatar-preview berkas-preview">
                    <div id="imagePreview_file_kartu_asuransi" style="background-image: url({{url('assets/img/placeholder.jpg')}});">
                    </div>
                </div>
            </div>
        </div>
