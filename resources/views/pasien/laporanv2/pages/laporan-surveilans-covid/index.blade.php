...
@section('title')
Laporan Surveilans Covid - Laporan - Administrasi & Rekam Medis
@endsection
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
        <thead>
            <tr>
                ...
                <th>Diagnosis Tambahan</th>
                <th>DPJP</th>
                <th>Status KRS</th>
                <th>Tanggal KRS</th>
                <th>Hasil Skrining</th>
                <th>Keterangan Skrining</th>
            </tr>
        </thead>
        <tbody>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/laporan-surveilans-covid/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/laporan-surveilans-covid/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
