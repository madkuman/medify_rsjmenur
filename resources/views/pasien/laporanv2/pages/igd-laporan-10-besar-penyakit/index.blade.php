...
@section('title')
IGD - Laporan 10 Besar Penyakit - Laporan - Administrasi & Rekam Medis
@endsection
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
        <thead>
            <tr>
                ...
                <th>Jumlah LK</th>
                <th>Jumlah PR</th>
                <th>Jumlah IGD KRS Hidup</th>
                <th>Jumlah IGD KRS Mati</th>
                <th>Jumlah MRS Rawat Inap</th>
                <th>Total Pasien</th>
            </tr>
        </thead>
        <tbody>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/igd-laporan-10-besar-penyakit/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        var dataTableObj = $('.js-dataTable-full').DataTable();
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/igd-laporan-10-besar-penyakit/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
