...
@section('title')
Laporan - Asal Rujukan Rawat Jalan
@endsection
...
<div class="block-content">
   ...
   <div class="row">
      ...
      <div class="col-4">
         ...
         <select id="layanan" class="custom-select">
...
<script type="text/javascript">
   ...
   $('.btn-get-data').click(function(){
      ...
      $.ajax({ 
         url: API_URL + '/pasien/laporan-v2/page/laporan-asal-rujukan-rajal-ranap-igd/get-total-data',
         dataType: 'json',
         tryCount : 0,
         retryLimit : 3,
         data : 'datestart='+start_date+'&dateend='+end_date+'&datafetched='+data_fetched+'&limit='+data_per_fetch+'&layanan='+layanan,
  ...
  function getDataset()
   {
      ...
      $.ajax({ 
         url: API_URL + '/pasien/laporan-v2/page/laporan-asal-rujukan-rajal-ranap-igd/get-data',
         dataType: 'json',
         tryCount : 0,
         retryLimit : 3,
         data : 'datestart='+start_date+'&dateend='+end_date+'&datafetched='+data_fetched+'&limit='+data_per_fetch+'&layanan='+layanan,
