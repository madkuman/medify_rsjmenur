...
@section('title')
Laporan Kunjungan Unit Tindakan - Laporan - Administrasi & Rekam Medis
@endsection
...
<div class="block-content">
    ...
    <div class="row">
        ...
        <div class="col-4">
            @include('pasien.laporanv2.components.form-select2',$unit_tindakan)
        </div>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        unit_tindakan = $('select[name="unit_tindakan"]').val()
        data_fetched = 0;
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/laporan-kunjungan-unit-tindakan/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'datestart='+start_date+'&dateend='+end_date+'&unit_tindakan='+unit_tindakan,
    ...
    function getDataset()
    {
        var dataTableObj = $('.js-dataTable-full').DataTable();
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/laporan-kunjungan-unit-tindakan/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'datestart='+start_date+'&dateend='+end_date+'&datafetched='+data_fetched+'&limit='+data_per_fetch+'&unit_tindakan='+unit_tindakan,
            success:function(results){
