...
@section('title')
RL 5.2.2 Kunjungan Gangguan Jiwa - Laporan - Administrasi & Rekam Medis
@endsection
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-522-kunjungan-gangguan-jiwa/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'poli='+poli,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-522-kunjungan-gangguan-jiwa/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'datestart='+start_date+'&dateend='+end_date+'&poli='+poli,
            success:function(results){
