...
@section('title')
DKK - @ 4. Laporan Mingguan W2 RS - Laporan - Administrasi & Rekam Medis
@endsection
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
        <thead>
            <tr>
                ...
                <th colspan="2" class="text-center">Kasus</th>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/dkk-4-laporan-mingguan-w2-rs/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/dkk-4-laporan-mingguan-w2-rs/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
