...
@section('title')
DKK - 18 Laporan Bulanan Pelayanan Geriatri - Laporan - Administrasi & Rekam Medis
@endsection
...
@section('page-title')
DKK - 18 Laporan Bulanan Pelayanan Geriatri
@endsection
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        export_data = [];
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/dkk-18-laporan-bulanan-pelayanan-geriatri/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : {
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/dkk-18-laporan-bulanan-pelayanan-geriatri/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : {
