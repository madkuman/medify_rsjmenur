<script type="text/javascript">
    ...
    $('.btn-get-data').click(function() {
        ...
        $.ajax({
            url: API_URL + '/pasien/laporan-v2/page/rl-3-2-rawat-darurat/get-total-data',
            dataType: 'json',
            data : {
                tahun_transaksi
            },
    ...
    function getDataset() {
        $.ajax({
            url: API_URL + '/pasien/laporan-v2/page/rl-3-2-rawat-darurat/get-data',
            dataType: 'json',
            tryCount: 0,
            retryLimit: 3,
            data: {
            ...
            success: function(results) {
                ...
                arr_jenis_pelayanan = results?.arr_jenis_pelayanan
