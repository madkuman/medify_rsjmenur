...
@section('title')
RL 3.13a Obat Pengadaan - Laporan - Administrasi & Rekam Medis
@endsection
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
        <thead>
            <tr>
                ...
                <th>Jumlah Item Obat Tersedia di Rumah Sakit</th>
                <th>Jumlah Item Obat Formulatorium Tersedia di Rumah Sakit</th>
            </tr>
        </thead>
        <tbody>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-313a-obat-pengadaan/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-313a-obat-pengadaan/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
