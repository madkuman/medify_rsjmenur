...
@section('title')
DKK - 33. Laporan Bulanan ISPA - Laporan - Administrasi & Rekam Medis
@endsection
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full nowrap" id="example">
        <thead>
           <tr>
               ...
               <th colspan="31">Realisasi Penemuan</th>
               <th rowspan="4">Jumlah yang dihitung napas atau ada TDDK</th>
               <th colspan="10" rowspan="2">Kematian pada Balita karena Pneumonia</th>
               <th colspan="6">I S P A  &#62; 5 th</th>
           </tr>
           <tr>
               <th colspan="6">PNEUMONIA</th>
               <th colspan="6">PNEUMONIA BERAT</th>
               <th colspan="10">Jumlah PNEUMONIA & PNEUMONIA BERAT</th>
               <th colspan="9">Penderita batuk bukan Pneumonia</th>
               <th colspan="3" rowspan="2">Bukan Pneunomia</th>
               <th colspan="3" rowspan="2">Pneunomia</th>
           </tr>
           <tr>
               <th colspan="3"> &#60; 1 </th>
               <th colspan="3"> 1 - &#60; 5 </th>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        export_data = [];
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/dkk-33-laporan-bulanan-ispa/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : {
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/dkk-33-laporan-bulanan-ispa/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : {
