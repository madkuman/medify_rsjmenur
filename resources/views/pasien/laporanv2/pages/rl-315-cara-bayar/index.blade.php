...
@section('title')
RL 3.11 Cara Bayar - Laporan - Administrasi & Rekam Medis
@endsection
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
        <thead>
            <tr>
                ...
                <th>PASIEN RAWAT INAP_JPK</th>
                <th>PASIEN RAWAT INAP_JLD</th>
                <th>JUMLAH PASIEN RAWAT JALAN</th>
                <th>JUMLAH PASIEN RAWAT JALAN_LAB.</th>
                <th>JUMLAH PASIEN RAWAT JALAN_RAD.</th>
                <th>JUMLAH PASIEN RAWAT JALAN_LL</th>
            </tr>
        </thead>
        <tbody>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-315-cara-bayar/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-315-cara-bayar/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
