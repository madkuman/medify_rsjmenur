...
@section('title')
RL 3.14 Rujukan - Laporan - Administrasi & Rekam Medis
@endsection
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
        <thead>
            <tr>
                ...
                <th style="white-space: nowrap;" class="bg-info">Rujukan dari<br>Puskesmas</th>
                <th style="white-space: nowrap;" class="bg-info">Rujukan dari<br>Faskes Lain</th>
                <th style="white-space: nowrap;" class="bg-info">Rujukan dari<br>RS Lain</th>
                <th style="white-space: nowrap;" class="bg-primary">Dirujuk ke<br>Puskesmas</th>
                <th style="white-space: nowrap;" class="bg-primary">Dirujuk ke<br>Faskes Lain</th>
                <th style="white-space: nowrap;" class="bg-primary">Dirujuk ke<br>RS Lain</th>
                <th style="white-space: nowrap;" class="bg-success">Rujukan<br>lalu dirujuk</th>
                <th style="white-space: nowrap;" class="bg-success">Tanpa Rujukan<br>lalu dirujuk</th>
                <th style="white-space: nowrap;" class="bg-success">Rujukan dan<br>dirujuk sama</th>
            </tr>
        </thead>
        <tbody>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-314-rujukan/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-314-rujukan/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
