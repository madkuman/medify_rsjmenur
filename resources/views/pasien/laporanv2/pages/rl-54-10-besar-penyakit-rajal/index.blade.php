...
@section('title')
RL 5.4 10 Besar Penyakit Rawat Jalan - Laporan - Administrasi & Rekam Medis
@endsection
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-54-10-besar-penyakit-rajal/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        var dataTableObj = $('.js-dataTable-full').DataTable();
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-54-10-besar-penyakit-rajal/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
