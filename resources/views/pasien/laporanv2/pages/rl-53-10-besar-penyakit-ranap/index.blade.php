...
@section('title')
RL 5.3 10 Besar Penyakit Rawat Inap - Laporan - Administrasi & Rekam Medis
@endsection
    ...
    <div class="row">
        ...
        <div class="col-4">
            <div class="form-group">
                <label for="penyedia">Jumlah Diagnosa</label>
                <select class="js-select2 form-control input-jumlah" name="jumlah" style="width: 100%;">
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-53-10-besar-penyakit-ranap/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'datestart='+start_date+'&dateend='+end_date+'&jumlah='+jumlah,
    ...
    function getDataset()
    {
        var dataTableObj = $('.js-dataTable-full').DataTable();
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-53-10-besar-penyakit-ranap/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'datestart='+start_date+'&dateend='+end_date+'&datafetched='+data_fetched+'&icd='+array_10[data_fetched],
            success:function(results){
