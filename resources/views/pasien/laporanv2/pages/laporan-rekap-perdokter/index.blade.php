...
@section('title')
Laporan Rekap Perdokter - Laporan - Administrasi & Rekam Medis
@endsection
...
<div class="block-content">
    ...
    <div class="row">
        ...
        <div class="col-4">
            @include('pasien.laporanv2.components.form-select2',$asuransi_select)
        </div>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        perusahaan_tipe = $('select[name="perusahaan_tipe"]').val()
        data_fetched = 0;
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/laporan-rekap-perdokter/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'datestart='+start_date+'&dateend='+end_date+'&perusahaan_tipe='+perusahaan_tipe,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/laporan-rekap-perdokter/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'datestart='+start_date+'&dateend='+end_date+'&datafetched='+data_fetched+'&limit='+data_per_fetch+'&perusahaan_tipe='+perusahaan_tipe,
            success:function(results){
