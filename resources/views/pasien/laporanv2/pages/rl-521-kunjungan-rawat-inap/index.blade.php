...
@section('title')
RL 5.2.1 Kunjungan Rawat Inap - Laporan - Administrasi & Rekam Medis
@endsection
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-521-kunjungan-rawat-inap/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-521-kunjungan-rawat-inap/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
