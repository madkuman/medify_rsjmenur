...
@section('title')
Data Rincian Rawat Inap - Laporan - Administrasi & Rekam Medis
@endsection
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
        <thead>
            <tr>
                ...
                <th>No Asuransi</th>
                <th>No SEP</th>
                <th>Ruangan Rawat Inap Masuk</th>
                <th>Tanggal Kunjungan</th>
                <th>Jam Kunjungan</th>
                <th>Baru / Lama</th>
                <th>DPJP</th>
                <th>Diagnosa Utama</th>
                <th>Diagnosa Tambahan</th>
                <th>ICD9</th>
                <th>Tanggal KRS</th>
                <th>Ruangan Keluar</th>
                <th>Status Keluar</th>
                <th>Alasan Keluar</th>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/data-rincian-rawat-inap/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/data-rincian-rawat-inap/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
