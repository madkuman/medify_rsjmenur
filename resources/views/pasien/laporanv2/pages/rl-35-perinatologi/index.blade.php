...
@section('title')
RL 3.5 Perinatologi - Laporan - Administrasi & Rekam Medis
@endsection
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-35-perinatologi/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-35-perinatologi/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
