...
@section('title')
RL 1.3 Tempat Tidur - Laporan - Administrasi & Rekam Medis
@endsection
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-13-tempat-tidur/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rl-13-tempat-tidur/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'datafetched='+data_fetched+'&limit='+data_per_fetch,
            success:function(results){
