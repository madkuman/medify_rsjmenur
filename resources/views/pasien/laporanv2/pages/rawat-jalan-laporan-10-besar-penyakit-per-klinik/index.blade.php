...
@section('title')
Rawat Jalan - Laporan 10 Besar Penyakit Per Poli - Laporan - Administrasi & Rekam Medis
@endsection
...
@section('page-title')
Rawat Jalan - Laporan 10 Besar Penyakit Per Poli
@endsection
    ...
    <div class="row">
        ...
        <div class="col-4">
            <div class="form-group">
                ...
                <small>Kosongkan untuk melihat data dari semua poli</small>
            </div>
        </div>
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
        <thead>
            <tr>
                ...
                <th>Jumlah LK</th>
                <th>Jumlah PR</th>
                <th>Jumlah Pasien Baru</th>
                <th>Jumlah Pasien Lama</th>
                <th>Total Pasien</th>
            </tr>
        </thead>
        <tbody>
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rawat-jalan-laporan-10-besar-penyakit-per-klinik/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
    ...
    function getDataset()
    {
        var dataTableObj = $('.js-dataTable-full').DataTable();
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/rawat-jalan-laporan-10-besar-penyakit-per-klinik/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : 'datestart='+start_date+'&dateend='+end_date+'&datafetched='+data_fetched+'&poli='+poli+'&dtd='+array_10[data_fetched],
            success:function(results){
