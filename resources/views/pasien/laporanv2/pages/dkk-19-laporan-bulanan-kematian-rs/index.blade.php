...
@section('title')
DKK - 19. Laporan Bulanan Kematian RS - Laporan - Administrasi & Rekam Medis
@endsection
...
@section('page-title')
DKK - 19. Laporan Bulanan Kematian RS
@endsection
...
<script type="text/javascript">
    ...
    $('.btn-get-data').click(function(){
        ...
        export_data = [];
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/dkk-19-laporan-bulanan-kematian-rs/get-total-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : {
    ...
    function getDataset()
    {
        ...
        $.ajax({ 
            url: API_URL + '/pasien/laporan-v2/page/dkk-19-laporan-bulanan-kematian-rs/get-data',
            dataType: 'json',
            tryCount : 0,
            retryLimit : 3,
            data : {
