<table>
    <thead>
        ...
        <tr>
            <th></th>
            <th></th>
            <th colspan="2">Daftar 10 Besar Penyakit Rawat jalan</th>
        </tr>
        <tr>
            <th></th>
        </tr>
        ...
        <tr>
            ...
            <th rowspan="3" colspan="2">Kasus Baru Menurut Jenis Kelamin</th>
            <th rowspan="5">Jumlah Kasus Baru</th>
            <th rowspan="5">Jumlah Kunjungan</th>
        </tr>
        <tr></tr>
        <tr></tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{$dtd->transaksi['baru-1'] ?? 0}}</td>
            <td>{{$dtd->transaksi['baru-2'] ?? 0}}</td>
            <td>{{$dtd->transaksi['baru'] ?? 0}}</td>
            <td>{{$dtd->transaksi['all'] ?? 0}}</td>
        </tr>
        @endforeach
