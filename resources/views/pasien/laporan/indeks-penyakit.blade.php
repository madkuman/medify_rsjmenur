<table>
	<tr>
		<td colspan="12">INDEKS PENYAKIT</td>
	</tr>
	<tr>
...
<table>
	<tr>
		<td colspan="2">Kode ICD X</td>
		<td colspan="8">: @if(!empty($dx->icd10->code_icd)) {{$dx->icd10->code_icd}} @endif</td>
	<tr>
		<td colspan="2">Diagnosis</td>
		<td colspan="8">: @if(!empty($dx->icd10->code_icd)) {{$dx->icd10->long_desc}} @endif </td>
	</tr>
	<tr>
		<td rowspan="3">No</td>
	...
	<tr>
		...
		<td>
			@if($kasus->status_krs->nama == 'Sehat' || $kasus->status_krs->nama == 'Membaik')
			Sehat
			@endif
		</td>
		<td>
		...
		<td>
			@if($kasus->status_krs->nama != 'Sehat' && $kasus->status_krs->nama !='Meninggal' && $kasus->status_krs->nama != 'Membaik' )
