                    ...
                    <div class="content content-full">
                        ...
                        <form class="js-validation-signin px-30" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <div class="form-material floating">
                                        <input id="email" type="text" id="login-email" class="form-control" name="email" value="{{ old('email') }}" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-30">
                                    <a class="link-effect text-muted mr-10 mb-5 d-inline-block" id="register-button" href="{{ route('register') }}">
