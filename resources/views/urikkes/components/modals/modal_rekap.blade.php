@php($modal_tipe = "rekap")
<div class="modal fade" id="modal-rekap" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fromright modal-lg" role="document">
        <div class="modal-content">
            <div class="block rounded block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">Rekapitulasi Hasil Uji dan Pemeriksaan Kesehatan</h3>
                ...
                <div class="block-content">
                    <form class="js-validation-be-contact" action="{{url('urikkes/laporan/rekap/')}}" method="post" target="_blank">
                        {{ csrf_field() }}
