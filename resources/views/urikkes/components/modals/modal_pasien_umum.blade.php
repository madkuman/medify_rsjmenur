@php($modal_tipe = "pasien_umum")
<div class="modal fade" id="modal-pasien-umum" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fromright modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="block rounded block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">Laporan Pasien Umum</h3>
                ...
                <div class="block-content">
                    <form class="js-validation-be-contact" action="{{url('urikkes/laporan/pasien_umum/')}}" method="post" target="_blank">
                        {{ csrf_field() }}
