	...
	<div class="content">
		...
		<div class="row">
            ...
            <div class="block-header">
              ...
              <a href="{{url('kamaroperasi/paket/edit/'.$paket->id)}}" class="btn btn-secondary" style="margin-left: 10px;"><i class="fa fa-edit"></i> Edit Paket</a>
							<hr>
            </div>
                  ...
                  <table class="table table-sm table-striped table-hover">
                    ...
                    @foreach ($items as $item)
                      <tr>
                        ...
                        <td>{{$item->jumlah ?? '-'}} {{ $item->getItem->satuan ?? '-' }}</td>
                      </tr>
                    @endforeach
                  </table>
                </div>
