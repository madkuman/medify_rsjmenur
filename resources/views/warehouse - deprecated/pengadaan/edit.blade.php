...
@section('content')
    ...
    <div class="card stacked-form">
        <form id="wizardForm" method="POST" action="{{action('Warehouse\Pengadaan\EditController@confirm')}}">
            {!! csrf_field() !!}
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" placeholder="Isikan Barang Tertukar" rows="5" >{{$transaction->description}}</textarea>
                        </div>
                    </div>
                </div>
                {{-- <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-5">
                            <div class="form-group error-stock" id="items_form_group_{{$i}}">
                                <select class="selectpicker" id="selectBarang{{$i}}" data-style="btn-default btn-outline" data-width="100%" name="items[{{$i}}]" data-live-search="true">
                                    <option value="">Pilih</option>
                                    @foreach($items as $item)
                                        <option value="{{$item->id}}" data-price="{{$item->price}}" data-qty="{{$item->qty_ready}}" @if($item->id == $detail->item_id) selected="true" @endif>{{$item->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" id="jumlah{{$i}}" class="form-control" placeholder="Jumlah" value="{{$detail->qty}}" name="qty[{{$i}}]">
                                    </div>
                                </div>
                                {{-- <div class="col-md-5">
                                    <div class="form-group">
            ...
            '<div class="row justify-content-center item">' +
                '<div class="col-md-5">' +
                    '<div class="form-group error-stock" id="items_form_group_'+x+'">' +
                        '<select class="selectpicker" id="selectBarang'+x+'" data-style="btn-default btn-outline" data-width="100%" name="items[]" data-live-search="true">' +
                            '<option value="">Pilih</option>' +
                            @foreach($items as $item)
                ...
                '<div class="col-md-5">' +
                    '<div class="row">' +
                        '<div class="col-md-4">' +
                            '<div class="form-group">' +
                                '<input type="number" class="form-control" id="jumlah'+x+'" placeholder="Jumlah" name="qty['+x+']">' +
                            '</div>' +
                        '</div>' +
                        '<div class="col-md-5">' +
                            '<div class="form-group">' +
