            ...
            <div class="card stacked-form">
                ...
                <div class="card-body ">
                    ...
                    <div class="form-group has-label">
                        ...
                        <select class="selectpicker" data-live-search="true" id="kategori" data-style="btn-default btn-outline" data-width="100%">
                            <option value="">Semua</option>
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            ...
                            <strong>Pengadaan tertolak</strong>
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            ...
                            <span class="form-check-sign"></span>
                            <strong>Pengadaan diterima</strong>
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            ...
                            <span class="form-check-sign"></span>
                            <strong>Pengadaan belum diverifikasi</strong>
                        </label>
                    </div>
                </div>
    ...
    <div class="col-md-9 col-sm-7">
        <div class="card main-content transaction-index">
            <div class="card-header ">
                ...
                <p class="card-category">Daftar semua pengadaan yang pernah dilakukan</p>
                <br>
                <div class="row">
                    <div class="col-sm-8">
                ...
                <table class="table">
                    ...
                    <tbody id="hasilSearch">                        
                        @foreach($transactions as $transaction)
                            ...
                            <tr class="transaction clickable-row" data-href="{{url('warehouse/pengadaan/'.$transaction->slug)}}">
                            @else
                            <tr class="unread transaction clickable-row" data-href="{{url('warehouse/pengadaan/'.$transaction->slug)}}">
                            @endif
                            <td>                                
                                <span class="in"><i class="fa fa-share" rel="tooltip" data-original-title="Transaksi Masuk"></i> </span>
                            </td>
                            <td>
                                @if($transaction->seller_detail != null)
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        /*function searchCallback() {
          ...
          var min_price = $('#hargaMin').value ? $('#minPrice').val() : 0;
          var max_price = $('#hargaMax').value ? $('#maxPrice').val() : 999999;          
          ...
          index.search("", {
             ...
             "facets": "[]",
             "numericFilters": "[\"total_price <="+max_price+"\",\"total_price >="+min_price+"\"]"
                ...
                content.hits.forEach(function(item) {
                    var date = new Date(item.created_at);
                      ...
                      str += `</td>
                          ...
                          str += `</td>
                          <td>Rp. `; if(item.total_price!= null) str+= item.total_price; else str += 0; 
                          str+= `</td>
        ...
        function filterData(page) {
          ...
          if (tertolak) {
            ...
            $.ajax({
                type:'POST',
                url:'{{url("warehouse/pengadaan/filter")}}/' + page,
                data: {supplier:supplier, jenis:jenis, kategori:kategori, min_price:min_price, max_price:max_price, min_date:min_date, max_date:max_date, status:status, numb:numb},
                dataType:'json', 
                beforeSend: function() {
                    console.log("loading...");
                    var loadingScreen = 
                ...
                success:function(data){
                    ...
                    data.data.forEach(function(item) {
                        ...
                        str += `</td>
                            <td>`;
                                if(item.seller_detail != null) str+= item.seller_detail.nama; 
                                else str += "-";
                            str += `</td>
                            <td>`+formatDate(date)+`</td>
                            <td>Rp. `; if(item.total_price!= null) str+= formatMoney(item.total_price); else str += 0; 
                            str+= `</td>
                            <td>`; if(item.status == 2) str += "(tertolak) "+item.explanation; else if(item.description!= null) str += item.description;
                            str += `</td>
                        </tr>`;
        ...
        function loadPage(page) {
            ...
            $.ajax({
                type:'GET',
                url:'{{url("warehouse/pengadaan/page")}}/' + page,
                dataType: 'json',
                beforeSend: function() {
                    console.log("loading...");
                    var loadingScreen = 
