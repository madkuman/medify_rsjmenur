...
<div class="card main-content transaction-index">
    ...
    <div class="card-header "> 
        ...
        <h4 class="card-title">Pengadaan Terbaru</h4>
        <p class="card-category">Pengadaan tercatat pada hari ini</p>
    </div>
    ...
    <div class="card-body table-full-width inventory">
        <table class="table">
            ...
            <tbody>
                ...
                <a href="{{url('warehouse/pengadaan/'.$transaction->slug)}}" rel="tooltip" title="" data-original-title="Lihat Transaksi">
                    ...
                    @endif
                        ...
                        <td>
                            @if($transaction->category == "Beli")
                                {{$transaction->seller_detail->nama}}
                            @elseif($transaction->category == "Retur")
                        ...
                        {{-- <td class="td-actions text-right">
                            <a href="{{url('warehouse/pengadaan/'.$transaction->slug)}}" rel="tooltip" title="" class="btn btn-info btn-link btn-xs" data-original-title="Lihat Transaksi">
