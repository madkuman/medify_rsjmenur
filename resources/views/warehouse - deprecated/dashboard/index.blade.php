...
@section('content')
        ...
        <div class="block-content">
            <table class="table table-hover table-vcenter">
                ...
                <tbody>
                	...
                	<tr class="clickable-row" data-href="{{url('gudang/distribusi/'.$row->slug)}}">
                		<td>{{$i++}}</td>
                		<td>{{$row->farmasi_detail->nama}}</td>
                        <td>{{$row->kategori}}</td>
    ...
    <div class="row row-deck">
	    <div class="col-xl-4">
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title"><center>Kategori Barang</center></h3>
                </div>
                <div class="block-content block-content-full">
        ...
        <div class="col-xl-8">
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title"><center>Total Penerimaan Supplier</center></h3>
                </div>
                <div class="block-content block-content-full">
        ...
        {{-- <div class="col-xl-4">
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title"><center>Stok Barang</center></h3>
                </div>
                <div class="block-content block-content-full">
	...
	<script type="text/javascript">
		var BeCompCharts = function() {
		    var initRandomEasyPieChart = function(){
                ...
                var kategori = <?php echo json_encode($perKategori) ?>;
                var supplier = <?php echo json_encode($perSupplier) ?>;
