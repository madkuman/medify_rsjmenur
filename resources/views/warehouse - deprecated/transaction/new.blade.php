...
@section('content')
    ...
    <form id="wizardForm" enctype="multipart/form-data" method="POST" action="{{url('warehouse/transaction/new')}}">
        {!! csrf_field() !!}
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker" data-style="btn-default btn-outline" data-width="130px" name="type" id="jenisTransaksi">
                                        <option value="Permintaan" data-content=''>Permintaan
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label class="control-label" id="asal-tujuan">Tujuan Barang
                                        <star class="star">*</star>
                                    </label>
                                    <select id="client" class="selectpicker" id="client" data-style="btn-default btn-outline" data-live-search="true" data-width="100%" data-size="4" name="client">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-5">
                                    <div class="form-group error-stock" id="items_form_group_1">
                                        ...
                                        {{-- <select class="selectpicker selectBarang" id="selectBarang1" onchange="cekStok(1)" data-style="btn-default btn-outline" data-width="100%" name="items[]" data-live-search="true">
                                            <option value="">Pilih</option>
                                            @foreach($items as $item)
                                                <option value="{{$item->id}}" data-price="{{$item->price}}" data-qty="{{$item->qty_ready}}">{{$item->name}} (Stok = {{$item->qty_ready}})</option>
                                            @endforeach
                                        </select> --}}
                                        <select id="selectBarang1" class="selectpicker2" data-style="btn-default btn-outline" data-live-search="true" name="items[]" data-width="100%" onchange="cekStok(1)"></select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="jumlah1" class="form-control" placeholder="Jumlah" onkeyup="cekStok(1)" onchange="cekStok(1)" name="qty[]">
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-5">
                                            <div class="form-group">
            ...
            '<div class="row justify-content-center item" id="details'+x+'">' +
                '<div class="col-md-5">' +
                    '<div class="form-group error-stock" id="items_form_group_'+x+'">' +
                        '<select id="selectBarang'+x+'" class="selectpicker2" data-style="btn-default btn-outline" data-live-search="true" name="items[]" data-width="100%" onchange="cekStok('+x+')"></select>' +
                ...
                '<div class="col-md-5">' +
                    '<div class="row">' +
                        '<div class="col-md-4">' +
                            '<div class="form-group">' +
                                '<input type="number" class="form-control" id="jumlah'+x+'" placeholder="Jumlah" onkeyup="cekStok('+x+')" onchange="cekStok('+x+')" name="qty[]">' +
                            '</div>' +
                        '</div>' +
                        '<div class="col-md-5">' +
                            '<div class="form-group">' +
