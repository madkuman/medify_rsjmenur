        ...
        <div class="block-content">
            <div class="block block-transparent">
                ...
                <div class="d-none" id="filter-data">
                    <form method="POST" action="{{url('gudang/item')}}" id="formFilter">
                        {!!csrf_field()!!}
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="penyedia">NAMA BARANG </label>
                                    <input class="form-control barang" id="barang-select2" name="nama_barang" style="width: 100%;" data-placeholder="Pilih Barang" @if(isset($barang)) value="{{$barang->nama}}" @endif />
                                </div>
                                <div class="form-group">
                        ...
                        <!-- <div class="row">
                            ...
                            {{-- <div class="col">
                                <div class="form-group">
                                    <label for="penyedia">WARNING </label><br>
                                    <label class="css-control css-control-lg css-control-primary css-checkbox">
    	                                <input type="checkbox" class="css-control-input" name="warning_stok" id="warning_stok" @if($warning_stok) checked @endif>
    	                                <span class="css-control-indicator"></span> Warning Stock
    	                            </label><br>
    	                            <label class="css-control css-control-lg css-control-primary css-checkbox">
    	                                <input type="checkbox" class="css-control-input" name="warning_kadaluarsa" id="warning_kadaluarsa" @if($warning_kadaluarsa) checked @endif>
    	                                <span class="css-control-indicator"></span> Warning Expired
    	                            </label>
                                </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var table = $('#items').DataTable({
            ...
            ajax: {
                url: "{{ url('/gudang/item/load-data') }}",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type: "POST",
                data: {
                    nama_barang : function() {
                        return $('#barang-select2').val();
                    },
