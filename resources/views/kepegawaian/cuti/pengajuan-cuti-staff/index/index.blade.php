        ...
        <div class="block p-10"  >
            <div class="block-header">
                <h3 class="block-title">
                    Daftar Cuti
                    <a href="{{url('cuti/pengajuan/form/new')}}" class="btn btn-primary pull-right">Buat Pengajuan Baru</a>
                </h3>
            </div>
...
<script type="text/javascript">
    ...
    var table = $('#tableCuti').DataTable({
        ...
        columns: [
            ...
            { data: null, name: 'flag',
                render: function (data, type, row, meta) {
                    content =`<a class="btn btn-secondary " href="{{url('')}}/cuti/pengajuan/form/`+data.id+`">Lihat</a></div>`;
                    return content;
                },
                searchable: false,
                sortable: false
