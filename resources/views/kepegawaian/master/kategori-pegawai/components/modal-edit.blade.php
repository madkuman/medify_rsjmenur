<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fromright modal-dialog-centered modal" role="document">
        <div class="modal-content">
            <form class="" method="POST" action="" id="form-edit-kategori-pegawai">
                {{ csrf_field() }}
                <div class="block rounded block-transparent mb-0">
                    <div class="block-header">
                        <h4 class="font-w400 mb-0">Ubah Data Kategori Pegawai</h4>
                        ...
                        <div class="row d-none" id="edit-content">
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" class="form-control" placeholder="Nama Kategori Pegawai" name="nama" id="edit_nama" required>
                                </div>
                                <div class="form-group">
                                    <label>Pembagian Jaspel</label>
                                    <input type="number" step="any" class="form-control" placeholder="Pembagian Jaspel" name="pembagian_jaspel" id="edit_pembagian_jaspel" required>
                                </div>
                            </div>
                        </div>
                    </div>
