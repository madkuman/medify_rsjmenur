...
<div class="content" style="margin-top:50px;">
	<div class="block p-10">
		<div class="block-header">
			<h3 class="block-title">
				<small><a href="#" data-toggle="modal" data-target="#modal-jenis-jabatan" class="pull-right">
	...
	@include('kepegawaian.master.jenis-jabatan.components.modal-delete')
	@include('kepegawaian.master.jenis-jabatan.components.modal-create')
	@include('kepegawaian.master.jenis-jabatan.components.modal-edit')
	@endsection

	@section('js')
	
	@include('kepegawaian.master.jenis-jabatan.components.js-index')
