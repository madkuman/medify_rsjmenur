...
<div class="content" style="margin-top:50px;">
	<div class="block p-10">
		<div class="block-header">
			<h3 class="block-title">
				<small><a href="#" data-toggle="modal" data-target="#modal-create-pangkat" class="pull-right">
					<i class="fa fa-plus-circle"></i> Tambah Pangkat</a>
				</small>
				Daftar Pangkat
			</h3>
		</div>
	...
	@include('kepegawaian.master.pangkat.components.modal-delete')
	@include('kepegawaian.master.pangkat.components.modal-create')
	@include('kepegawaian.master.pangkat.components.modal-edit')
	@endsection

	@section('js')
	
	@include('kepegawaian.master.pangkat.components.js-index')
