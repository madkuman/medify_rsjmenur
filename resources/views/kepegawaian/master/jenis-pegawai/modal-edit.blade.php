    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Jenis Pegawai</h4>
            </div>
                ...
                <div class="d-none" id="edit-content">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="nama_edit" type="text" placeholder="Masukkan Jenis Pegawai" name="nama">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Indek</label>
                            <input type="number" step="any" class="form-control" id="index_edit" placeholder="Jumlah Indek" name="index" required>
                        </div>
                    </div>
                </div>
