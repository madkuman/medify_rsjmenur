<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fromright modal-dialog-centered modal" role="document">
        <div class="modal-content">
            <form class="" method="POST" action="" id="form-edit-masa-kerja">
                {{ csrf_field() }}
                <div class="block rounded block-transparent mb-0">
                    <div class="block-header">
                        <h4 class="font-w400 mb-0">Ubah Data Masa Kerja</h4>
                        ...
                        <div class="row d-none" id="edit-content">
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" class="form-control" placeholder="Nama Masa Kerja" name="nama" id="edit_nama" required>
                                </div>
                                <div class="form-group">
                                    <label>Lama Kerja(Tahun)</label>
                                    <input type="number" class="form-control" placeholder="Awal" name="awal" id="edit_awal" required>
                                    <input type="number" class="form-control mt-2" placeholder="Akhir" name="akhir" id="edit_akhir" required>
                                </div>
                                <div class="form-group">
                                    <label>Indek</label>
                                    <input type="number" class="form-control" placeholder="Indek" name="indek" id="edit_indek" required>
                                </div>
                            </div>
                        </div>
                    </div>
