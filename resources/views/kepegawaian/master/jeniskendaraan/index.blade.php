...
<div class="content" style="margin-top:50px;">
		...
		<div class="block-header">
			<h3 class="block-title">
				<small>
					...
					<i class="fa fa-plus-circle"></i> Tambah Jenis Kendaraan</a>
				</small> 
			...
			<table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
				...
				<tbody>
					...
					<tr>
						...
						<td class="">
							<a href="#editmodal" data-url="{{url('/kepegawaian/master/jenis-kendaraan/edit/')}}/{{$item->id}}" class="btn btn-sm btn-circle btn-outline-info mr-5 mb-5"
								data-toggle="modal" data-id="{{$item->id}}">
								<i class="fa fa-edit"></i></a>
							<a href="#deletemodal" class="btn btn-sm btn-circle btn-outline-danger mr-5 mb-5"
								data-toggle="modal" data-url="{{url('/kepegawaian/master/jenis-kendaraan/delete/')}}/{{$item->id}}" data-id="{{$item->id}}" data-nama="{{$item->nama}}">
	...
	@include('kepegawaian/master/jeniskendaraan/modal-tambah')
	@include('kepegawaian/master/jeniskendaraan/modal-edit')
	@include('kepegawaian/master/jeniskendaraan/modal-delete')
