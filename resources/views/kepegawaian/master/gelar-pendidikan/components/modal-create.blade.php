<div class="modal fade" id="modal-create-gelar" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fromright modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <form class="" method="POST" action="{{url('kepegawaian/master/gelar-pendidikan/baru')}}" id="form-add">
                <div class="block rounded block-transparent mb-0">
                    <div class="block-header">
                        <h4 class="font-w400 mb-0">Tambah Gelar Pendidikan</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" placeholder="Masukkan nama gelar" class="form-control" 
                                    required autocomplete="off"  id="create-nama-gelar">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label">Strata Pendidikan</label>
                                    <select name="strata_pendidikan" id="strata-pendidikan" class="form-control" required>
