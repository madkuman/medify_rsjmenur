...
<div class="content" style="margin-top:50px;">
		...
		<div class="block-header">
			<h3 class="block-title">
				<small>
					...
					<i class="fa fa-plus-circle"></i> Tambah Faskes Asuransi</a>
				</small> 
				Daftar Faskes Asuransi
			</h3>
		</div>
			...
			<table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="example">
				...
				<tbody>
					...
					<tr>
						...
						<td class="">
							<a href="#editmodal" data-url="{{url('/kepegawaian/master/faskes-asuransi/edit/')}}/{{$item->id}}" class="btn btn-sm btn-circle btn-outline-info mr-5 mb-5"
								data-toggle="modal" data-id="{{$item->id}}">
								<i class="fa fa-edit"></i></a>
							<a href="#deletemodal" class="btn btn-sm btn-circle btn-outline-danger mr-5 mb-5"
								data-toggle="modal" data-url="{{url('/kepegawaian/master/faskes-asuransi/delete/')}}/{{$item->id}}" data-id="{{$item->id}}" data-nama="{{$item->nama}}">
	...
	@include('kepegawaian/master/faskes-asuransi/modal-tambah')
	@include('kepegawaian/master/faskes-asuransi/modal-edit')
	@include('kepegawaian/master/faskes-asuransi/modal-delete')
