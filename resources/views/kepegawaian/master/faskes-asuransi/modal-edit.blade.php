    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Faskes Asuransi</h4>
            </div>
                ...
                <div class="d-none" id="edit-content">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Jenis Faskes Asuransi</label>
                            <input class="form-control" id="nama_edit" type="text" placeholder="Masukkan Faskes Asuransi" name="nama">
                        </div>
                    </div>
                </div>
