{{--  --}}
<div class="modal fade" id="modal-update-pelatihan" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-fromtop modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <form id="form-pelatihan" method="POST" action="{{url()->current()}}/edit" enctype="multipart/form-data">
      <div class="modal-header mt-20">
          ...
          <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama" required id="form-nama" autocomplete="off" placeholder="Masukan nama pelatihan">
                    </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      <label class="col-form-label">Tahun Pelatihan</label>
                      <select class="form-control js-select2 year" style="width: 100%" id="form-tahun" name="period">
                        <option value="" selected >— Pilih Tahun Pelatihan —</option>
                      </select>
                    </div>
              </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="place" required id="form-tempat" autocomplete="off"
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="skor" required id="form-skor" autocomplete="off"
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="durasi" required id="form-durasi" autocomplete="off" placeholder="Masukan durasi pelatihan">
                </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
        ...
        <div class="modal-footer border-top-0">
          ...
          <button class="btn btn-primary btn-hero pull-right btn-click-animate" type="submit" id="buttonSubmitEdit"><i class="fa fa-check"></i> Simpan</button>
      </div>
      </form>
    </div>
  </div>
