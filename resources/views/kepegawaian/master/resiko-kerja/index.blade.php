		...
		<div class="block-header">
			<h3 class="block-title">
				<small><a href="javascript:void(0)" class="pull-right btn-add">
					<i class="fa fa-plus-circle"></i> Tambah Resiko Kerja</a>
				</small>
				Daftar Resiko Kerja
			</h3>
		</div>
...
@include('kepegawaian.master.resiko-kerja.components.modal-delete')
@include('kepegawaian.master.resiko-kerja.components.modal-resiko')
@endsection

@section('js')
@include('kepegawaian.master.resiko-kerja.components.js')
@endsection