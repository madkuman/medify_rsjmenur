<div class="modal fade" id="modal-resiko-kerja" role="dialog" aria-labelledby="modal-fromtop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fromtop modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <form class="" method="POST" action="{{url()->current()}}" id="form-resiko-kerja">
                <div class="block rounded block-transparent mb-0">
                    <div class="block-header">
                        <h4 class="font-w400 mb-0"><span id="modal-option">Tambah</span> Resiko Kerja</h4>
                    ...
                    <div class="block-content">
                        {{ csrf_field() }}
                        <input type="hidden" name="resikoid" id="form-resikoid" value="0">
                        <div class="row">
                            <div class="col-md-6">
