<div class="modal fade" id="modal-edit-institusipendidikan" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
    <div class="modal-dialog modal-dialog-fromright modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <form class="" method="POST" action="{{url('kepegawaian/master/institusi-pendidikan/edit')}}" id="form-edit">
                <div class="block rounded block-transparent mb-0">
                    <div class="block-header">
                        <h4 class="font-w400 mb-0">Edit Institusi Pendidikan</h4>
                    ...
                    <div class="block-content">
                        ...
                        <div class="row d-none" id="edit-content">
                            <div class="col-md-12">
                            <div class="row">
                                <input type="hidden" name="institusiid" id="institusiid">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="col-form-label">Nama Institusi Pendidikan</label>
                                        <input type="text" name="nama" id="namaedit" placeholder="Masukkan nama master Institusi Pendidikan" class="form-control" 
