    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Jenis Surat Peringatan</h4>
            </div>
                ...
                <div class="d-none" id="edit-content">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Jenis Surat peringatan</label>
                            <input class="form-control" id="nama_edit" type="text" placeholder="Masukkan Jenis Surat" name="nama">
                        </div>
                    </div>
                </div>
