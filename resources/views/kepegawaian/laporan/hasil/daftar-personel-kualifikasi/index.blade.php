...
<html lang="en">
	...
	<body>
		<table class="no-border md" style="width: 100%">
			<tr>
				<td class="text-center" width="40%">{{config('app.name')}}</td>
				<td width="60%"></td>
			</tr>
		</table>
		<br>
		...
		<table class="border md" style="width: 100%">
			<tr class="text-center">
				...
				<th style="width: 20%">Kualifikasi SDM / Dikum Terakhir</th>
				<th style="width: 30%">Pendidikan Umum</th>
			</tr>
		...
		@endif
			<tr @if($border_bottom) class="border-bottom" @endif>
				...
				<td>{{$item->kualifikasi}}<br>{{$item->text_pendidikan_umum_akhir}}</td> 
