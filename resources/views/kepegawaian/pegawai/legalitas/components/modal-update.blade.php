  ...
  <div class="modal fade" id="modal-update" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form id="form-update" method="POST" action="{{ route('legalitas-update', ['id' => $pegawai->id]) }}" enctype="multipart/form-data">
          {{csrf_field()}}
          <div class="modal-body mx-20">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control datepicker" id="form-expired" name="expired" placeholder="Masukan tanggal expired" autocomplete="off" required>  
              </div>
            </div>
            <div class="form-group">
