            ...
            <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control js-select2" style="width: 100%" name="master" id="form-master_id" required>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="period" autocomplete="off" readonly id="form-tahun"
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="place" autocomplete="off" readonly id="form-tempat"
                    placeholder="Masukan tempat pelatihan">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="skor" readonly  autocomplete="off" id="form-skor"
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="durasi" readonly  autocomplete="off" id="form-durasi" placeholder="Masukan durasi pelatihan">
                  </div>
                </div>
                {{-- <div class="col-md-6">
                    <div class="form-group">
