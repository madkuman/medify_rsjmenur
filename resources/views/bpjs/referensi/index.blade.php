                                ...
                                <div class="col-6">
                                    <form id="form-search">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control js-select2 required" name="select_referensi"
                                                id="select-referensi">
                                        ...
                                        <div class="dpjp-component" style="display: none;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control datepicker" name="tgl_pelayanan"
                                                    id="tgl-pelayanan-dpjp" value="{{ now()->format('d-m-Y') }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Spesialis</label>
                                                <select class="form-control js-select2 select-spesialis" name="spesialis"
                                                    id="spesialis-dpjp" data-placeholder="Pilih Spesialis"
                                                    style="width: 100%">
                                        ...
                                        <div class="propinsi-div" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control js-select2 select-propinsi" name="propinsi"
                                                    id="propinsi-select" data-placeholder="Pilih Propinsi"
                                                    style="width: 100%">
                                        ...
                                        <div class="kabupaten-div" style="display: none;">
                                            <div class="form-group">
                                                <label>Kabupaten <i class="fa fa-asterisk fa-spin text-info"
                                                        id="loading-spin-kecamatan" style="display: none"></i></label>
                                                <select class="form-control js-select2 select-kabupaten" name="kabupaten"
                                                    id="kabupaten-select" data-placeholder="Pilih kabupaten"
                                                    style="width: 100%">
                                                    <option value=""></option>
                                                </select>
                                            </div>
                    ...
                    success: (response) => {
                        ...
                        if (response.response.metaData.code == 200) {
                            ...
                            if (response.referensi == 'diagnosa') {
                                $.each(response.response.response.diagnosa, function(index,
                                    value) {
                                    html += `<table>
                                    <tr>
                                ...
                                $.each(response.response.response.faskes, function(index,
                                value) {
                                    html += `<table>
                                    <tr>
                                        <td style="width: 175px">Kode</td>
