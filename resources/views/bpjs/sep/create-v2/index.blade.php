        ...
        <form id="formSEP">
            ...
            <div class="block-content">
                <div class="row">
                    ...
                    <div class="col-12 py-10 text-center font-w600 bg-danger text-white mb-20 align-middle"
                    ...
                    <div class="col-12">
                        <div class="pull-right">
                            ...
                            <i class="fa fa-asterisk fa-2x fa-spin text-info px-20 my-5" id="loading"
