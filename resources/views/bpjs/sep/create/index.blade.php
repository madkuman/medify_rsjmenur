...
<main id="main-container">
                            ...
                            <div class="block-content">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <!--INFORMASI PASIEN-->
                                        @include('bpjs.sep.create.components.form-pasien')
                                        @include('bpjs.sep.create.components.form-rujukan')
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        @include('bpjs.sep.create.components.form-bpjs')
                                        <!-- LAKA -->
                                        @include('bpjs.sep.create.components.form-laka')
                                    </div>
    ...
    <script type="text/javascript" src="{{url('js/bpjs/sep/create/index-v4.js')}}"></script>
    @endsection