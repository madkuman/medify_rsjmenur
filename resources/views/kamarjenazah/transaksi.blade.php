            ...
            <div class="block rounded">
                <form id="layananSubmit">
                    <div class="block-content" id="layananBaru">
                        @include('kamarjenazah.form.form-transaksibaru')
                    <div class="col-12" style="height: 75px">
                        <button class="btn btn-success btn-hero pull-right" type="button" id="buttonSubmit"><i class="fa fa-check"></i> Buat Invoice</button>
...
<script type="text/javascript">
    ...
    $('#buttonSubmit').click(function() {
        ...
        idPermintaan = $("#id_permintaan").val();
        total = $('.total').val();
        ...
        formData.append('idPermintaan', idPermintaan);
        ...
        $.ajax({
            type: "POST",
            url: API_URL + "/kamarjenazah/transaksi",
            contentType: false,
            processData: false,
            headers: {
