...
@section('subtitle')
<span class="text-muted font-w400">Tarif Layanan Jenazah / </span> Hapus Layanan
@endsection
              ...
              <form id="layananSubmit">
                  <div class="block rounded" id="layananBaru">
                      <div class="block-content">
                          @include('kamarjenazah.form.form-layanandelete')
                      </div>
                  </div>
                  <div class="col-12" style="height: 75px">
                      <button class="btn btn-danger btn-hero pull-right" type="button" id="buttonSubmit"><i class="fa fa-times"></i> Hapus</button>
