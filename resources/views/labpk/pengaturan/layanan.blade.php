...
<div class="content">
    <div class="block">
        <div class="block-content" >
            <a href="{{url('labpk/pengaturan/form-tarif/'.$tarif->id)}}" class="btn btn-secondary pull-right" >
                <i class="fa fa-pencil"></i> Edit Form Pemeriksaan
            </a>
