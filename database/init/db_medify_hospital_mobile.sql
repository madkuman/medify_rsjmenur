...
MySQL - 10.4.6-MariaDB : Database - medify_hospital_mobile
*********************************************************************
*/
...
/*Database structure for database `medify_hospital_mobile` */

CREATE DATABASE /*!32312 IF NOT EXISTS*/`medify_hospital_mobile` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `medify_hospital_mobile`;
