...
Route::group(['middleware' => ['check-module']], function () {
    Route::group(['prefix' => 'gizi'], function () {
        ...
        Route::get('/produksi/baru/pilih-tanggal', function () {
            return view('gizi.produksi.create-tanggal');
        });
        ...
        Route::group(['prefix' => 'laporan'], function () {
            ...
            Route::get('/laporan-surat-pemesanan-makanan-tambahan', 'Gizi\Laporan\ViewController@laporanSuratPemesananMakananTambahan');
